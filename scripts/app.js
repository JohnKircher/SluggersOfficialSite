...
const characters = [
  { name: "Baby DK", image: "assets/images/baby dk.png", class: "Speed", avg: 0.497, gp: 50, hr: 6, pa: 191, hits: 95, slg: 0.647, obp: 0.503, doubles: 7, triples: 1 },
  ...
  { name: "Birdo", image: "assets/images/birdo.png", class: "Power", avg: 0.545, gp: 50, hr: 27, pa: 198, hits: 108, slg: 1.0, obp: 0.55, doubles: 7, triples: 0 },
  ...
  { name: "Blooper", image: "assets/images/blooper.png", class: "Balanced", avg: 0.575, gp: 38, hr: 0, pa: 146, hits: 84, slg: 0.656, obp: 0.579, doubles: 8, triples: 1 },
  { name: "Blue Dry Bones", image: "assets/images/blue dry bones.png", class: "Balanced", avg: 0.621, gp: 50, hr: 9, pa: 198, hits: 123, slg: 0.847, obp: 0.623, doubles: 10, triples: 2 },
  { name: "Blue Kritter", image: "assets/images/blue kritter.png", class: "Power", avg: 0.536, gp: 50, hr: 18, pa: 194, hits: 104, slg: 0.863, obp: 0.524, doubles: 8, triples: 2 },
  ...
  { name: "Blue Toad", image: "assets/images/blue toad.png", class: "Speed", avg: 0.596, gp: 44, hr: 4, pa: 171, hits: 102, slg: 0.725, obp: 0.596, doubles: 8, triples: 1 },
  ...
  { name: "Boomerang Bro", image: "assets/images/boomerang bro.png", class: "Power", avg: 0.49, gp: 50, hr: 25, pa: 192, hits: 94, slg: 0.912, obp: 0.495, doubles: 3, triples: 1 },
  ...
  { name: "Bowser Jr", image: "assets/images/bowser jr.png", class: "Technique", avg: 0.477, gp: 50, hr: 4, pa: 193, hits: 92, slg: 0.613, obp: 0.477, doubles: 12, triples: 0 },
  { name: "Bowser", image: "assets/images/bowser.png", class: "Power", avg: 0.608, gp: 50, hr: 57, pa: 212, hits: 129, slg: 1.56, obp: 0.609, doubles: 19, triples: 5 },
  { name: "Brown Kritter", image: "assets/images/brown kritter.png", class: "Power", avg: 0.495, gp: 50, hr: 36, pa: 190, hits: 94, slg: 1.153, obp: 0.5, doubles: 9, triples: 1 },
  ...
  { name: "Carby", image: "assets/images/carby.jpg", class: "Balanced", avg: 0.496, gp: 30, hr: 4, pa: 121, hits: 60, slg: 0.698, obp: 0.496, doubles: 7, triples: 2 },
  ...
  { name: "Daisy", image: "assets/images/daisy.png", class: "Power", avg: 0.444, gp: 48, hr: 8, pa: 187, hits: 83, slg: 0.669, obp: 0.444, doubles: 14, triples: 1 },
  { name: "Dark Bones", image: "assets/images/dark bones.png", class: "Balanced", avg: 0.665, gp: 50, hr: 17, pa: 209, hits: 139, slg: 1.0, obp: 0.669, doubles: 15, triples: 1 },
  { name: "Diddy Kong", image: "assets/images/diddy kong.png", class: "Technique", avg: 0.497, gp: 50, hr: 1, pa: 193, hits: 96, slg: 0.567, obp: 0.497, doubles: 10, triples: 0 },
  ...
  { name: "Doc Brown", image: "assets/images/doc brown.jpg", class: "Balanced", avg: 0.545, gp: 8, hr: 0, pa: 33, hits: 18, slg: 0.781, obp: 0.545, doubles: 7, triples: 0 },
  { name: "Donkey Kong", image: "assets/images/donkey kong.png", class: "Power", avg: 0.591, gp: 50, hr: 49, pa: 193, hits: 114, slg: 1.385, obp: 0.591, doubles: 5, triples: 0 },
  { name: "Dry Bones", image: "assets/images/dry bones.png", class: "Balanced", avg: 0.634, gp: 50, hr: 13, pa: 194, hits: 123, slg: 0.958, obp: 0.637, doubles: 15, triples: 3 },
  { name: "Dwayne Wade", image: "assets/images/dwayne wade.jpg", class: "Balanced", avg: 0.474, gp: 50, hr: 3, pa: 175, hits: 83, slg: 0.531, obp: 0.474, doubles: 1, triples: 0 },
  ...
  { name: "Fire Bro", image: "assets/images/fire bro.png", class: "Power", avg: 0.582, gp: 50, hr: 50, pa: 201, hits: 117, slg: 1.381, obp: 0.582, doubles: 6, triples: 1 },
  ...
  { name: "Funky Kong", image: "assets/images/funky kong.png", class: "Power", avg: 0.438, gp: 50, hr: 29, pa: 194, hits: 85, slg: 0.962, obp: 0.448, doubles: 3, triples: 3 },
  ...
  { name: "Green Dry Bones", image: "assets/images/green dry bones.png", class: "Balanced", avg: 0.558, gp: 50, hr: 14, pa: 206, hits: 115, slg: 0.801, obp: 0.558, doubles: 6, triples: 1 },
  { name: "Green Magikoopa", image: "assets/images/green magikoopa.png", class: "Balanced", avg: 0.495, gp: 50, hr: 2, pa: 184, hits: 91, slg: 0.568, obp: 0.497, doubles: 7, triples: 0 },
  ...
  { name: "Green Toad", image: "assets/images/green toad.png", class: "Speed", avg: 0.613, gp: 50, hr: 2, pa: 204, hits: 125, slg: 0.75, obp: 0.619, doubles: 11, triples: 4 },
  { name: "Gus Fring", image: "assets/images/gus fring.jpg", class: "Balanced", avg: 0.244, gp: 10, hr: 0, pa: 41, hits: 10, slg: 0.3, obp: 0.25, doubles: 2, triples: 0 },
  { name: "Hammer Bro", image: "assets/images/hammer bro.png", class: "Power", avg: 0.553, gp: 50, hr: 43, pa: 190, hits: 105, slg: 1.267, obp: 0.545, doubles: 8, triples: 0 },
  ...
  { name: "KevinG", image: "assets/images/keving.jpg", class: "Balanced", avg: 0.371, gp: 30, hr: 3, pa: 116, hits: 43, slg: 0.505, obp: 0.371, doubles: 6, triples: 0 },
  { name: "Kim Jong Un", image: "assets/images/kim jong un.jpg", class: "Balanced", avg: 0.434, gp: 20, hr: 4, pa: 83, hits: 36, slg: 0.614, obp: 0.434, doubles: 3, triples: 0 },
  { name: "King Boo", image: "assets/images/king boo.png", class: "Power", avg: 0.548, gp: 50, hr: 31, pa: 199, hits: 109, slg: 1.047, obp: 0.539, doubles: 5, triples: 0 },
  { name: "King K Rool", image: "assets/images/king k rool.png", class: "Power", avg: 0.607, gp: 50, hr: 61, pa: 206, hits: 125, slg: 1.552, obp: 0.607, doubles: 9, triples: 0 },
  ...
  { name: "Kritter", image: "assets/images/kritter.png", class: "Power", avg: 0.55, gp: 50, hr: 31, pa: 209, hits: 115, slg: 1.114, obp: 0.55, doubles: 17, triples: 3 },
  ...
  { name: "Lebron James", image: "assets/images/lebron james.jpg", class: "Balanced", avg: 0.379, gp: 30, hr: 6, pa: 116, hits: 44, slg: 0.567, obp: 0.381, doubles: 3, triples: 0 },
  ...
  { name: "Luigi", image: "assets/images/luigi.png", class: "Speed", avg: 0.495, gp: 50, hr: 3, pa: 194, hits: 96, slg: 0.576, obp: 0.498, doubles: 4, triples: 1 },
  ...
  { name: "Magikoopa", image: "assets/images/magikoopa.png", class: "Balanced", avg: 0.542, gp: 49, hr: 4, pa: 168, hits: 91, slg: 0.655, obp: 0.542, doubles: 5, triples: 1 },
  { name: "Mario", image: "assets/images/mario.png", class: "Balanced", avg: 0.529, gp: 50, hr: 5, pa: 189, hits: 100, slg: 0.644, obp: 0.53, doubles: 4, triples: 1 },
  ...
  { name: "Miss Hot", image: "assets/images/miss hot.jpg", class: "Balanced", avg: 0.45, gp: 50, hr: 4, pa: 180, hits: 81, slg: 0.579, obp: 0.452, doubles: 8, triples: 1 },
  ...
  { name: "Peach", image: "assets/images/peach.png", class: "Balanced", avg: 0.446, gp: 50, hr: 1, pa: 195, hits: 87, slg: 0.518, obp: 0.436, doubles: 9, triples: 2 },
  { name: "Petey Piranha", image: "assets/images/petey piranha.png", class: "Power", avg: 0.592, gp: 50, hr: 67, pa: 201, hits: 119, slg: 1.622, obp: 0.597, doubles: 4, triples: 0 },
  { name: "Pianta", image: "assets/images/pianta.png", class: "Speed", avg: 0.589, gp: 50, hr: 32, pa: 192, hits: 113, slg: 1.093, obp: 0.578, doubles: 4, triples: 0 },
  ...
  { name: "Purple Toad", image: "assets/images/purple toad.png", class: "Speed", avg: 0.648, gp: 32, hr: 0, pa: 122, hits: 79, slg: 0.726, obp: 0.648, doubles: 7, triples: 1 },
  ...
  { name: "Red Kritter", image: "assets/images/red kritter.png", class: "Power", avg: 0.479, gp: 50, hr: 26, pa: 194, hits: 93, slg: 0.936, obp: 0.479, doubles: 6, triples: 0 },
  { name: "Red Magikoopa", image: "assets/images/red magikoopa.png", class: "Balanced", avg: 0.467, gp: 49, hr: 2, pa: 184, hits: 86, slg: 0.55, obp: 0.472, doubles: 7, triples: 0 },
  ...
  { name: "Red Pianta", image: "assets/images/red pianta.png", class: "Speed", avg: 0.56, gp: 50, hr: 17, pa: 191, hits: 107, slg: 0.878, obp: 0.567, doubles: 7, triples: 0 },
  ...
  { name: "Rizzler", image: "assets/images/rizzler.jpg", class: "Balanced", avg: 0.469, gp: 29, hr: 1, pa: 113, hits: 53, slg: 0.54, obp: 0.469, doubles: 5, triples: 0 },
  { name: "Saddam Hussein", image: "assets/images/saddam hussein.jpg", class: "Balanced", avg: 0.439, gp: 30, hr: 10, pa: 114, hits: 50, slg: 0.781, obp: 0.439, doubles: 7, triples: 1 },
  { name: "Saka", image: "assets/images/saka.jpg", class: "Balanced", avg: 0.429, gp: 10, hr: 0, pa: 35, hits: 15, slg: 0.486, obp: 0.429, doubles: 2, triples: 0 },
  ...
  { name: "Tiny Kong", image: "assets/images/tiny kong.png", class: "Balanced", avg: 0.443, gp: 50, hr: 2, pa: 194, hits: 86, slg: 0.533, obp: 0.448, doubles: 8, triples: 1 },
  { name: "Toad", image: "assets/images/toad.jpg", class: "Balanced", avg: 0.661, gp: 42, hr: 2, pa: 168, hits: 111, slg: 0.773, obp: 0.665, doubles: 5, triples: 3 },
  { name: "Toadette", image: "assets/images/toadette.png", class: "Balanced", avg: 0.497, gp: 48, hr: 1, pa: 179, hits: 89, slg: 0.571, obp: 0.503, doubles: 5, triples: 2 },
  ...
  { name: "Unc", image: "assets/images/unc.jpg", class: "Balanced", avg: 0.497, gp: 50, hr: 13, pa: 187, hits: 93, slg: 0.735, obp: 0.503, doubles: 4, triples: 0 },
  ...
  { name: "Waluigi", image: "assets/images/waluigi.png", class: "Technique", avg: 0.543, gp: 50, hr: 2, pa: 184, hits: 100, slg: 0.712, obp: 0.552, doubles: 23, triples: 0 },
  { name: "Wario", image: "assets/images/wario.png", class: "Technique", avg: 0.592, gp: 50, hr: 19, pa: 196, hits: 116, slg: 0.983, obp: 0.615, doubles: 7, triples: 0 },
  { name: "Wiggler", image: "assets/images/wiggler.png", class: "Speed", avg: 0.627, gp: 50, hr: 7, pa: 201, hits: 126, slg: 0.813, obp: 0.627, doubles: 11, triples: 2 },
  ...
  { name: "Yellow Magikoopa", image: "assets/images/yellow magikoopa.png", class: "Balanced", avg: 0.554, gp: 32, hr: 3, pa: 130, hits: 72, slg: 0.675, obp: 0.554, doubles: 2, triples: 2 },
  { name: "Yellow Pianta", image: "assets/images/yellow pianta.png", class: "Speed", avg: 0.603, gp: 50, hr: 13, pa: 199, hits: 120, slg: 0.835, obp: 0.606, doubles: 6, triples: 0 },
  { name: "Yellow Shy Guy", image: "assets/images/yellow shy guy.png", class: "Technique", avg: 0.373, gp: 35, hr: 2, pa: 118, hits: 44, slg: 0.458, obp: 0.373, doubles: 3, triples: 0 },
  { name: "Yellow Toad", image: "assets/images/yellow toad.png", class: "Speed", avg: 0.614, gp: 48, hr: 4, pa: 189, hits: 116, slg: 0.76, obp: 0.614, doubles: 8, triples: 3 },
  ...
  { name: "Yoshi", image: "assets/images/yoshi.png", class: "Speed", avg: 0.454, gp: 50, hr: 2, pa: 194, hits: 88, slg: 0.522, obp: 0.456, doubles: 6, triples: 0 },
...
if (characterGrid) {
  ...
  "Daisy": { ip: 144, era: 7.41, baa: 0.463, so: 2 },
  "Dark Bones": { ip: 39, era: 5.2, baa: 0.391, so: 0 },
  "Diddy Kong": { ip: 77, era: 9.37, baa: 0.516, so: 9 },
  "Diminutive": { ip: 4, era: 6.0, baa: 0.353, so: 0 },
  "Dixie Kong": { ip: 6, era: 7.0, baa: 0.424, so: 1 },
  "Donkey Kong": { ip: 169, era: 8.23, baa: 0.502, so: 4 },
  ...
  "Green Magikoopa": { ip: 24, era: 10.31, baa: 0.574, so: 0 },
  ...
  "King Boo": { ip: 50, era: 11.29, baa: 0.55, so: 0 },
  ...
  "Luigi": { ip: 165, era: 7.26, baa: 0.486, so: 15 },
  "MLK Jr": { ip: 5, era: 2.47, baa: 0.435, so: 0 },
  "Magikoopa": { ip: 51, era: 8.92, baa: 0.52, so: 1 },
  "Mario": { ip: 134, era: 7.09, baa: 0.489, so: 9 },
  ...
  "Peach": { ip: 135, era: 7.6, baa: 0.489, so: 5 },
  "Pianta": { ip: 57, era: 9.79, baa: 0.536, so: 3 },
  ...
  "Red Pianta": { ip: 35, era: 7.87, baa: 0.527, so: 2 },
  ...
  "Waluigi": { ip: 69, era: 7.45, baa: 0.455, so: 4 },
  "Wario": { ip: 107, era: 8.94, baa: 0.495, so: 6 },
...
function renderSeason3Stats() {
  ...
  const teamRosters = {
        ...
        "Julian": ["King K Rool", "Blue Kritter", "Red Kritter", "Toad", "Purple Toad", "Peach", "Baby Peach", "Toadsworth", "Saddam Hussein", "Ghandi", "Idi Amin", "Kim Jong Un", "MLK Jr"],
        ...
        "BenR": ["Hammer Bro", "Boomerang Bro", "Bowser Jr", "Blue Shy Guy", "Green Magikoopa", "Unc", "Gus Fring", "Lebron James", "Paragoomba", "Shy Guy", "Goomba", "Red Koopa Troopa", "Ice Cube"],
