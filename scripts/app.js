...
const miiMeta = {
    ...
    "Miss Hot": { gender: "F", color: "purple" },
    ...
    "Saddam Hussein": { gender: "F", color: "brown" },
    ...
    "Queen Elizabeth": { gender: "F", color: "yellow" },
    ...
    "Ghandi": { gender: "M", color: "brown" },
    "Count Dooku": { gender: "M", color: "blue" },
    "MLK Jr": { gender: "F", color: "yellow" },
...
const characters = [
  { name: "Baby DK", image: "assets/images/baby dk.png", class: "Speed", avg: 0.5, gp: 40, hr: 5, pa: 156, hits: 78, slg: 0.651, obp: 0.506, doubles: 5, triples: 1 },
  { name: "Baby Daisy", image: "assets/images/baby daisy.png", class: "Power", avg: 0.384, gp: 32, hr: 2, pa: 112, hits: 43, slg: 0.541, obp: 0.381, doubles: 7, triples: 2 },
  ...
  { name: "Birdo", image: "assets/images/birdo.png", class: "Power", avg: 0.567, gp: 40, hr: 18, pa: 157, hits: 89, slg: 0.955, obp: 0.573, doubles: 6, triples: 0 },
  ...
  { name: "Blooper", image: "assets/images/blooper.png", class: "Balanced", avg: 0.556, gp: 28, hr: 0, pa: 99, hits: 55, slg: 0.637, obp: 0.56, doubles: 5, triples: 1 },
  { name: "Blue Dry Bones", image: "assets/images/blue dry bones.png", class: "Balanced", avg: 0.622, gp: 40, hr: 8, pa: 156, hits: 97, slg: 0.883, obp: 0.624, doubles: 9, triples: 2 },
  { name: "Blue Kritter", image: "assets/images/blue kritter.png", class: "Power", avg: 0.519, gp: 40, hr: 13, pa: 158, hits: 82, slg: 0.781, obp: 0.504, doubles: 5, triples: 0 },
  { name: "Blue Shy Guy", image: "assets/images/blue shy guy.png", class: "Technique", avg: 0.321, gp: 24, hr: 0, pa: 78, hits: 25, slg: 0.337, obp: 0.321, doubles: 1, triples: 0 },
  { name: "Blue Toad", image: "assets/images/blue toad.png", class: "Speed", avg: 0.585, gp: 34, hr: 4, pa: 130, hits: 76, slg: 0.731, obp: 0.585, doubles: 7, triples: 0 },
  ...
  { name: "Boomerang Bro", image: "assets/images/boomerang bro.png", class: "Power", avg: 0.5, gp: 40, hr: 22, pa: 150, hits: 75, slg: 0.98, obp: 0.507, doubles: 3, triples: 1 },
  ...
  { name: "Bowser Jr", image: "assets/images/bowser jr.png", class: "Technique", avg: 0.462, gp: 40, hr: 3, pa: 156, hits: 72, slg: 0.582, obp: 0.461, doubles: 9, triples: 0 },
  { name: "Bowser", image: "assets/images/bowser.png", class: "Power", avg: 0.586, gp: 40, hr: 41, pa: 169, hits: 99, slg: 1.436, obp: 0.586, doubles: 13, triples: 3 },
  { name: "Brown Kritter", image: "assets/images/brown kritter.png", class: "Power", avg: 0.486, gp: 40, hr: 22, pa: 148, hits: 72, slg: 1.037, obp: 0.493, doubles: 9, triples: 1 },
  ...
  { name: "Carby", image: "assets/images/carby.jpg", class: "Balanced", avg: 0.519, gp: 20, hr: 3, pa: 81, hits: 42, slg: 0.714, obp: 0.519, doubles: 4, triples: 1 },
  ...
  { name: "Daisy", image: "assets/images/daisy.png", class: "Power", avg: 0.466, gp: 38, hr: 7, pa: 148, hits: 69, slg: 0.704, obp: 0.466, doubles: 10, triples: 1 },
  { name: "Dark Bones", image: "assets/images/dark bones.png", class: "Balanced", avg: 0.675, gp: 40, hr: 14, pa: 163, hits: 110, slg: 1.019, obp: 0.68, doubles: 14, triples: 0 },
  { name: "Diddy Kong", image: "assets/images/diddy kong.png", class: "Technique", avg: 0.471, gp: 40, hr: 1, pa: 153, hits: 72, slg: 0.539, obp: 0.471, doubles: 7, triples: 0 },
  { name: "Diminutive", image: "assets/images/diminutive.jpg", class: "Balanced", avg: 0.351, gp: 10, hr: 1, pa: 37, hits: 13, slg: 0.432, obp: 0.351, doubles: 0, triples: 0 },
  ...
  { name: "Donkey Kong", image: "assets/images/donkey kong.png", class: "Power", avg: 0.592, gp: 40, hr: 41, pa: 157, hits: 93, slg: 1.416, obp: 0.592, doubles: 5, triples: 0 },
  { name: "Dry Bones", image: "assets/images/dry bones.png", class: "Balanced", avg: 0.638, gp: 40, hr: 13, pa: 152, hits: 97, slg: 1.041, obp: 0.638, doubles: 14, triples: 3 },
  { name: "Dwayne Wade", image: "assets/images/dwayne wade.jpg", class: "Balanced", avg: 0.464, gp: 40, hr: 2, pa: 140, hits: 65, slg: 0.507, obp: 0.464, doubles: 0, triples: 0 },
  ...
  { name: "Fire Bro", image: "assets/images/fire bro.png", class: "Power", avg: 0.585, gp: 40, hr: 42, pa: 164, hits: 96, slg: 1.412, obp: 0.585, doubles: 5, triples: 1 },
  ...
  { name: "Funky Kong", image: "assets/images/funky kong.png", class: "Power", avg: 0.432, gp: 40, hr: 21, pa: 155, hits: 67, slg: 0.906, obp: 0.444, doubles: 2, triples: 2 },
  ...
  { name: "Ghandi", image: "assets/images/ghandi.jpg", class: "Balanced", avg: 0.257, gp: 10, hr: 0, pa: 35, hits: 9, slg: 0.257, obp: 0.257, doubles: 0, triples: 0 },
  { name: "Green Dry Bones", image: "assets/images/green dry bones.png", class: "Balanced", avg: 0.515, gp: 40, hr: 13, pa: 163, hits: 84, slg: 0.792, obp: 0.516, doubles: 4, triples: 1 },
  { name: "Green Magikoopa", image: "assets/images/green magikoopa.png", class: "Balanced", avg: 0.5, gp: 40, hr: 2, pa: 144, hits: 72, slg: 0.583, obp: 0.5, doubles: 6, triples: 0 },
  ...
  { name: "Green Toad", image: "assets/images/green toad.png", class: "Speed", avg: 0.645, gp: 40, hr: 2, pa: 155, hits: 100, slg: 0.823, obp: 0.65, doubles: 11, triples: 4 },
  { name: "Hammer Bro", image: "assets/images/hammer bro.png", class: "Power", avg: 0.536, gp: 40, hr: 35, pa: 153, hits: 82, slg: 1.246, obp: 0.526, doubles: 5, triples: 0 },
  ...
  { name: "Kim Jong Un", image: "assets/images/kim jong un.jpg", class: "Balanced", avg: 0.558, gp: 10, hr: 4, pa: 43, hits: 24, slg: 0.837, obp: 0.558, doubles: 0, triples: 0 },
  { name: "King Boo", image: "assets/images/king boo.png", class: "Power", avg: 0.542, gp: 40, hr: 27, pa: 155, hits: 84, slg: 1.086, obp: 0.531, doubles: 2, triples: 0 },
  { name: "King K Rool", image: "assets/images/king k rool.png", class: "Power", avg: 0.636, gp: 40, hr: 49, pa: 165, hits: 105, slg: 1.58, obp: 0.636, doubles: 6, triples: 0 },
  ...
  { name: "Kritter", image: "assets/images/kritter.png", class: "Power", avg: 0.569, gp: 40, hr: 27, pa: 167, hits: 95, slg: 1.168, obp: 0.569, doubles: 15, triples: 2 },
  ...
  { name: "Lebron James", image: "assets/images/lebron james.jpg", class: "Balanced", avg: 0.385, gp: 20, hr: 6, pa: 78, hits: 30, slg: 0.659, obp: 0.388, doubles: 3, triples: 0 },
  ...
  { name: "Luigi", image: "assets/images/luigi.png", class: "Speed", avg: 0.49, gp: 40, hr: 1, pa: 153, hits: 75, slg: 0.536, obp: 0.49, doubles: 2, triples: 1 },
  ...
  { name: "MLK Jr", image: "assets/images/mlk jr.jpg", class: "Balanced", avg: 0.286, gp: 10, hr: 0, pa: 42, hits: 12, slg: 0.31, obp: 0.286, doubles: 1, triples: 0 },
  { name: "Magikoopa", image: "assets/images/magikoopa.png", class: "Balanced", avg: 0.529, gp: 40, hr: 4, pa: 136, hits: 72, slg: 0.662, obp: 0.529, doubles: 4, triples: 1 },
  { name: "Mario", image: "assets/images/mario.png", class: "Balanced", avg: 0.5, gp: 40, hr: 3, pa: 152, hits: 76, slg: 0.597, obp: 0.501, doubles: 3, triples: 1 },
  ...
  { name: "Miss Hot", image: "assets/images/miss hot.jpg", class: "Balanced", avg: 0.476, gp: 40, hr: 3, pa: 145, hits: 69, slg: 0.591, obp: 0.476, doubles: 7, triples: 0 },
  ...
  { name: "Paragoomba", image: "assets/images/paragoomba.png", class: "Balanced", avg: 0.333, gp: 23, hr: 0, pa: 81, hits: 27, slg: 0.349, obp: 0.336, doubles: 1, triples: 0 },
  { name: "Peach", image: "assets/images/peach.png", class: "Balanced", avg: 0.419, gp: 40, hr: 0, pa: 155, hits: 65, slg: 0.452, obp: 0.406, doubles: 5, triples: 1 },
  { name: "Petey Piranha", image: "assets/images/petey piranha.png", class: "Power", avg: 0.586, gp: 40, hr: 47, pa: 157, hits: 92, slg: 1.503, obp: 0.586, doubles: 3, triples: 0 },
  { name: "Pianta", image: "assets/images/pianta.png", class: "Speed", avg: 0.623, gp: 40, hr: 22, pa: 151, hits: 94, slg: 1.052, obp: 0.609, doubles: 2, triples: 0 },
  ...
  { name: "Purple Toad", image: "assets/images/purple toad.png", class: "Speed", avg: 0.658, gp: 22, hr: 0, pa: 79, hits: 52, slg: 0.755, obp: 0.658, doubles: 5, triples: 1 },
  ...
  { name: "Red Kritter", image: "assets/images/red kritter.png", class: "Power", avg: 0.49, gp: 40, hr: 18, pa: 155, hits: 76, slg: 0.901, obp: 0.489, doubles: 6, triples: 0 },
  { name: "Red Magikoopa", image: "assets/images/red magikoopa.png", class: "Balanced", avg: 0.448, gp: 39, hr: 2, pa: 145, hits: 65, slg: 0.54, obp: 0.454, doubles: 5, triples: 0 },
  ...
  { name: "Red Pianta", image: "assets/images/red pianta.png", class: "Speed", avg: 0.569, gp: 40, hr: 12, pa: 153, hits: 87, slg: 0.848, obp: 0.577, doubles: 5, triples: 0 },
  ...
  { name: "Saddam Hussein", image: "assets/images/saddam hussein.jpg", class: "Balanced", avg: 0.395, gp: 20, hr: 4, pa: 81, hits: 32, slg: 0.654, obp: 0.395, doubles: 7, triples: 1 },
  ...
  { name: "Tiny Kong", image: "assets/images/tiny kong.png", class: "Balanced", avg: 0.439, gp: 40, hr: 1, pa: 157, hits: 69, slg: 0.497, obp: 0.44, doubles: 4, triples: 1 },
  { name: "Toad", image: "assets/images/toad.jpg", class: "Balanced", avg: 0.63, gp: 32, hr: 2, pa: 127, hits: 80, slg: 0.716, obp: 0.636, doubles: 3, triples: 0 },
  { name: "Toadette", image: "assets/images/toadette.png", class: "Balanced", avg: 0.441, gp: 38, hr: 1, pa: 136, hits: 60, slg: 0.502, obp: 0.45, doubles: 2, triples: 1 },
  ...
  { name: "Unc", image: "assets/images/unc.jpg", class: "Balanced", avg: 0.51, gp: 40, hr: 9, pa: 151, hits: 77, slg: 0.724, obp: 0.517, doubles: 4, triples: 0 },
  { name: "Waluigi", image: "assets/images/waluigi.png", class: "Technique", avg: 0.568, gp: 40, hr: 0, pa: 146, hits: 83, slg: 0.715, obp: 0.577, doubles: 20, triples: 0 },
  { name: "Wario", image: "assets/images/wario.png", class: "Technique", avg: 0.591, gp: 40, hr: 17, pa: 159, hits: 94, slg: 1.023, obp: 0.619, doubles: 5, triples: 0 },
  { name: "Wiggler", image: "assets/images/wiggler.png", class: "Speed", avg: 0.643, gp: 40, hr: 3, pa: 168, hits: 108, slg: 0.777, obp: 0.643, doubles: 10, triples: 1 },
  ...
  { name: "Yellow Magikoopa", image: "assets/images/yellow magikoopa.png", class: "Balanced", avg: 0.545, gp: 22, hr: 2, pa: 88, hits: 48, slg: 0.667, obp: 0.546, doubles: 2, triples: 1 },
  { name: "Yellow Pianta", image: "assets/images/yellow pianta.png", class: "Speed", avg: 0.581, gp: 40, hr: 12, pa: 160, hits: 93, slg: 0.833, obp: 0.585, doubles: 3, triples: 0 },
  { name: "Yellow Shy Guy", image: "assets/images/yellow shy guy.png", class: "Technique", avg: 0.393, gp: 25, hr: 1, pa: 84, hits: 33, slg: 0.472, obp: 0.393, doubles: 3, triples: 0 },
  { name: "Yellow Toad", image: "assets/images/yellow toad.png", class: "Speed", avg: 0.621, gp: 38, hr: 4, pa: 153, hits: 95, slg: 0.775, obp: 0.621, doubles: 8, triples: 1 },
  ...
  { name: "Yoshi", image: "assets/images/yoshi.png", class: "Speed", avg: 0.447, gp: 40, hr: 2, pa: 152, hits: 68, slg: 0.528, obp: 0.451, doubles: 5, triples: 0 },
  ...
  { name: "Vicar", image: "assets/images/vicar.jpg", class: "Balanced", avg: 0.0, gp: 0, hr: 0, pa: 0, hits: 0, slg: 0.0, obp: 0.0, doubles: 0, triples: 0 },
  ...
  { name: "Saka", image: "assets/images/saka.jpg", class: "Balanced", avg: 0.0, gp: 0, hr: 0, pa: 0, hits: 0, slg: 0.0, obp: 0.0, doubles: 0, triples: 0 },
  ...
  { name: "Bowler", image: "assets/images/bowler.jpg", class: "Balanced", avg: 0.0, gp: 0, hr: 0, pa: 0, hits: 0, slg: 0.0, obp: 0.0, doubles: 0, triples: 0 },
  { name: "Idi Amin", image: "assets/images/idi amin.jpg", class: "Balanced", avg: 0.0, gp: 0, hr: 0, pa: 0, hits: 0, slg: 0.0, obp: 0.0, doubles: 0, triples: 0 }
];
...
if (characterGrid) {
  ...
  "Bowser": { ip: 117, era: 6.24, baa: 0.473, so: 25 },
  "Bowser Jr": { ip: 69, era: 8.26, baa: 0.51, so: 5 },
  ...
  "Daisy": { ip: 114, era: 6.66, baa: 0.458, so: 2 },
  "Dark Bones": { ip: 39, era: 5.2, baa: 0.391, so: 0 },
  "Diddy Kong": { ip: 62, era: 8.33, baa: 0.502, so: 3 },
  "Diminutive": { ip: 4, era: 6.0, baa: 0.353, so: 0 },
  "Dixie Kong": { ip: 6, era: 7.0, baa: 0.424, so: 1 },
  "Donkey Kong": { ip: 131, era: 8.43, baa: 0.509, so: 4 },
  ...
  "King Boo": { ip: 41, era: 10.74, baa: 0.565, so: 0 },
  ...
  "Mario": { ip: 123, era: 6.92, baa: 0.485, so: 9 },
  ...
  "Pianta": { ip: 32, era: 7.16, baa: 0.492, so: 1 },
  ...
  "Red Pianta": { ip: 5, era: 12.6, baa: 0.614, so: 0 },
  ...
  "Toad": { ip: 5, era: 8.68, baa: 0.397, so: 0 },
  ...
  "Waluigi": { ip: 52, era: 6.12, baa: 0.444, so: 2 },
  "Wario": { ip: 65, era: 9.77, baa: 0.519, so: 3 },
