...
const miiMeta = {
    ...
    "Borat": { gender: "F", color: "brown" },
    "Captain Jack Sparrow": { gender: "M", color: "white" },
    "Chicken": { gender: "M", color: "pink" },
    "Dwayne Wade": { gender: "M", color: "purple" },
    ...
    "Mrs.Claus": { gender: "M", color: "green" },
...
const characters = [
  ...
  { name: "Baby Daisy", image: "assets/images/baby daisy.png", class: "Power", avg: 0.412, gp: 22, hr: 0, pa: 80, hits: 33, slg: 0.5, obp: 0.408, doubles: 5, triples: 1 },
  ...
  { name: "Birdo", image: "assets/images/birdo.png", class: "Power", avg: 0.6, gp: 30, hr: 15, pa: 115, hits: 69, slg: 1.034, obp: 0.609, doubles: 4, triples: 0 },
  ...
  { name: "Blue Kritter", image: "assets/images/blue kritter.png", class: "Power", avg: 0.473, gp: 30, hr: 9, pa: 110, hits: 52, slg: 0.704, obp: 0.451, doubles: 2, triples: 0 },
  ...
  { name: "Blue Toad", image: "assets/images/blue toad.png", class: "Speed", avg: 0.571, gp: 24, hr: 3, pa: 91, hits: 52, slg: 0.736, obp: 0.571, doubles: 6, triples: 0 },
  ...
  { name: "Boo", image: "assets/images/boo.png", class: "Speed", avg: 0.556, gp: 29, hr: 0, pa: 99, hits: 55, slg: 0.596, obp: 0.555, doubles: 4, triples: 0 },
  ...
  { name: "Borat", image: "assets/images/borat.jpg", class: "Balanced", avg: 0.38, gp: 30, hr: 0, pa: 121, hits: 46, slg: 0.415, obp: 0.38, doubles: 4, triples: 0 },
  { name: "Bowser Jr", image: "assets/images/bowser jr.png", class: "Technique", avg: 0.466, gp: 30, hr: 3, pa: 116, hits: 54, slg: 0.584, obp: 0.465, doubles: 4, triples: 0 },
  ...
  { name: "Carby", image: "assets/images/carby.jpg", class: "Balanced", avg: 0.548, gp: 10, hr: 1, pa: 42, hits: 23, slg: 0.619, obp: 0.548, doubles: 0, triples: 0 },
  ...
  { name: "Daisy", image: "assets/images/daisy.png", class: "Power", avg: 0.468, gp: 28, hr: 5, pa: 109, hits: 51, slg: 0.692, obp: 0.468, doubles: 8, triples: 0 },
  { name: "Dark Bones", image: "assets/images/dark bones.png", class: "Balanced", avg: 0.678, gp: 30, hr: 10, pa: 121, hits: 82, slg: 1.001, obp: 0.685, doubles: 9, triples: 0 },
  ...
  { name: "Donkey Kong", image: "assets/images/donkey kong.png", class: "Power", avg: 0.61, gp: 30, hr: 28, pa: 118, hits: 72, slg: 1.367, obp: 0.61, doubles: 4, triples: 0 },
  { name: "Dry Bones", image: "assets/images/dry bones.png", class: "Balanced", avg: 0.626, gp: 30, hr: 13, pa: 115, hits: 72, slg: 1.08, obp: 0.626, doubles: 9, triples: 1 },
  { name: "Dwayne Wade", image: "assets/images/dwayne wade.jpg", class: "Balanced", avg: 0.461, gp: 30, hr: 2, pa: 102, hits: 47, slg: 0.519, obp: 0.461, doubles: 0, triples: 0 },
  ...
  { name: "Fire Bro", image: "assets/images/fire bro.png", class: "Power", avg: 0.6, gp: 30, hr: 33, pa: 120, hits: 72, slg: 1.449, obp: 0.6, doubles: 3, triples: 0 },
  { name: "Frozone", image: "assets/images/frozone.jpg", class: "Balanced", avg: 0.261, gp: 6, hr: 1, pa: 23, hits: 6, slg: 0.391, obp: 0.261, doubles: 0, triples: 0 },
  { name: "Funky Kong", image: "assets/images/funky kong.png", class: "Power", avg: 0.482, gp: 30, hr: 16, pa: 112, hits: 54, slg: 1.004, obp: 0.499, doubles: 2, triples: 2 },
  ...
  { name: "Green Dry Bones", image: "assets/images/green dry bones.png", class: "Balanced", avg: 0.552, gp: 30, hr: 12, pa: 116, hits: 64, slg: 0.897, obp: 0.552, doubles: 2, triples: 1 },
  { name: "Green Magikoopa", image: "assets/images/green magikoopa.png", class: "Balanced", avg: 0.534, gp: 30, hr: 2, pa: 103, hits: 55, slg: 0.621, obp: 0.534, doubles: 3, triples: 0 },
  ...
  { name: "Green Shy Guy", image: "assets/images/green shy guy.png", class: "Technique", avg: 0.34, gp: 28, hr: 0, pa: 94, hits: 32, slg: 0.364, obp: 0.328, doubles: 2, triples: 1 },
  { name: "Green Toad", image: "assets/images/green toad.png", class: "Speed", avg: 0.625, gp: 30, hr: 2, pa: 112, hits: 70, slg: 0.826, obp: 0.631, doubles: 10, triples: 2 },
  { name: "Hammer Bro", image: "assets/images/hammer bro.png", class: "Power", avg: 0.54, gp: 30, hr: 26, pa: 113, hits: 61, slg: 1.227, obp: 0.527, doubles: 1, triples: 0 },
  ...
  { name: "KevinG", image: "assets/images/keving.jpg", class: "Balanced", avg: 0.286, gp: 11, hr: 3, pa: 42, hits: 12, slg: 0.513, obp: 0.286, doubles: 0, triples: 0 },
  { name: "King Boo", image: "assets/images/king boo.png", class: "Power", avg: 0.532, gp: 30, hr: 19, pa: 111, hits: 59, slg: 1.074, obp: 0.517, doubles: 2, triples: 0 },
  { name: "King K Rool", image: "assets/images/king k rool.png", class: "Power", avg: 0.608, gp: 30, hr: 32, pa: 120, hits: 73, slg: 1.464, obp: 0.608, doubles: 4, triples: 0 },
  ...
  { name: "Luigi", image: "assets/images/luigi.png", class: "Speed", avg: 0.487, gp: 30, hr: 1, pa: 115, hits: 56, slg: 0.539, obp: 0.487, doubles: 1, triples: 1 },
  ...
  { name: "Mario", image: "assets/images/mario.png", class: "Balanced", avg: 0.573, gp: 30, hr: 3, pa: 110, hits: 63, slg: 0.697, obp: 0.574, doubles: 2, triples: 1 },
  ...
  { name: "Miss Hot", image: "assets/images/miss hot.jpg", class: "Balanced", avg: 0.528, gp: 30, hr: 3, pa: 108, hits: 57, slg: 0.683, obp: 0.528, doubles: 7, triples: 0 },
  ...
  { name: "Peach", image: "assets/images/peach.png", class: "Balanced", avg: 0.366, gp: 30, hr: 0, pa: 112, hits: 41, slg: 0.412, obp: 0.348, doubles: 5, triples: 1 },
  { name: "Petey Piranha", image: "assets/images/petey piranha.png", class: "Power", avg: 0.538, gp: 30, hr: 33, pa: 117, hits: 63, slg: 1.393, obp: 0.538, doubles: 1, triples: 0 },
  { name: "Pianta", image: "assets/images/pianta.png", class: "Speed", avg: 0.607, gp: 30, hr: 9, pa: 112, hits: 68, slg: 0.82, obp: 0.589, doubles: 0, triples: 0 },
  ...
  { name: "Purple Toad", image: "assets/images/purple toad.png", class: "Speed", avg: 0.575, gp: 12, hr: 0, pa: 40, hits: 23, slg: 0.666, obp: 0.575, doubles: 3, triples: 0 },
  ...
  { name: "Red Kritter", image: "assets/images/red kritter.png", class: "Power", avg: 0.462, gp: 30, hr: 10, pa: 119, hits: 55, slg: 0.784, obp: 0.461, doubles: 6, triples: 0 },
  { name: "Red Magikoopa", image: "assets/images/red magikoopa.png", class: "Balanced", avg: 0.462, gp: 29, hr: 1, pa: 106, hits: 49, slg: 0.524, obp: 0.466, doubles: 3, triples: 0 },
  ...
  { name: "Red Pianta", image: "assets/images/red pianta.png", class: "Speed", avg: 0.544, gp: 30, hr: 8, pa: 114, hits: 62, slg: 0.805, obp: 0.555, doubles: 4, triples: 0 },
  { name: "Red Yoshi", image: "assets/images/red yoshi.png", class: "Speed", avg: 0.369, gp: 23, hr: 1, pa: 84, hits: 31, slg: 0.417, obp: 0.369, doubles: 1, triples: 0 },
  ...
  { name: "Tiny Kong", image: "assets/images/tiny kong.png", class: "Balanced", avg: 0.449, gp: 30, hr: 1, pa: 118, hits: 53, slg: 0.517, obp: 0.449, doubles: 3, triples: 1 },
  { name: "Toad", image: "assets/images/toad.jpg", class: "Balanced", avg: 0.588, gp: 22, hr: 0, pa: 85, hits: 50, slg: 0.6, obp: 0.588, doubles: 1, triples: 0 },
  { name: "Toadette", image: "assets/images/toadette.png", class: "Balanced", avg: 0.442, gp: 28, hr: 1, pa: 95, hits: 42, slg: 0.525, obp: 0.449, doubles: 2, triples: 1 },
  ...
  { name: "Waluigi", image: "assets/images/waluigi.png", class: "Technique", avg: 0.551, gp: 30, hr: 0, pa: 107, hits: 59, slg: 0.669, obp: 0.556, doubles: 12, triples: 0 },
  { name: "Wario", image: "assets/images/wario.png", class: "Technique", avg: 0.608, gp: 30, hr: 9, pa: 120, hits: 73, slg: 0.981, obp: 0.646, doubles: 5, triples: 0 },
  { name: "Wiggler", image: "assets/images/wiggler.png", class: "Speed", avg: 0.667, gp: 30, hr: 3, pa: 126, hits: 84, slg: 0.832, obp: 0.667, doubles: 9, triples: 1 },
  ...
  { name: "Yellow Pianta", image: "assets/images/yellow pianta.png", class: "Speed", avg: 0.593, gp: 30, hr: 3, pa: 118, hits: 70, slg: 0.697, obp: 0.599, doubles: 2, triples: 0 },
  { name: "Yellow Shy Guy", image: "assets/images/yellow shy guy.png", class: "Technique", avg: 0.441, gp: 16, hr: 1, pa: 59, hits: 26, slg: 0.52, obp: 0.441, doubles: 1, triples: 0 },
  { name: "Yellow Toad", image: "assets/images/yellow toad.png", class: "Speed", avg: 0.604, gp: 28, hr: 3, pa: 111, hits: 67, slg: 0.755, obp: 0.604, doubles: 5, triples: 1 },
...
if (characterGrid) {
  ...
  "Birdo": { ip: 75, era: 5.22, baa: 0.435, so: 14 },
  ...
  "Donkey Kong": { ip: 99, era: 7.24, baa: 0.494, so: 3 },
  ...
  "King Boo": { ip: 27, era: 8.02, baa: 0.532, so: 0 },
  ...
  "Luigi": { ip: 108, era: 6.84, baa: 0.48, so: 7 },
  "Magikoopa": { ip: 40, era: 8.99, baa: 0.528, so: 1 },
  "Mario": { ip: 97, era: 6.71, baa: 0.475, so: 5 },
  ...
  "Peach": { ip: 98, era: 6.48, baa: 0.467, so: 1 },
  "Pianta": { ip: 1, era: 35.0, baa: 0.778, so: 0 },
  ...
  "Wario": { ip: 43, era: 8.6, baa: 0.5, so: 2 },
...
function renderSeason3Stats() {
  ...
  const teamRosters = {
        ...
        Kircher: ["Donkey Kong", "Wario", "Dry Bones", "Black Shy Guy", "Boo", "Frozone", "Miss Hot", "Dixie Kong", "Yellow Shy Guy", "Monty Mole", "John K", "Evie", "Light Blue Yoshi"],
        Tom: ["Petey Piranha", "Dark Bones", "Mario", "Blue Toad", "Toadette", "Diminutive", "Red Magikoopa", "Tung Tung Tung Sahur", "Carby", "Red Yoshi", "Tobey Maguire", "Harry Potter", "Tsitsipas"],
        ...
        Jmo: ["Hammer Bro", "Red Kritter", "Luigi", "Daisy", "Yellow Toad", "Green Magikoopa", "Baby Daisy", "Waluigi", "Syndrome", "Beyonce", "Pink Yoshi", "Lilo", "Taylor Swift"],
