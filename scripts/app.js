...
const characters = [
  { name: "Baby DK", image: "assets/images/baby dk.png", class: "Speed", avg: 0.502, gp: 68, hr: 10, pa: 269, hits: 135, slg: 0.665, obp: 0.507, doubles: 8, triples: 2 },
  { name: "Baby Daisy", image: "assets/images/baby daisy.png", class: "Speed", avg: 0.395, gp: 34, hr: 2, pa: 119, hits: 47, slg: 0.56, obp: 0.392, doubles: 9, triples: 2 },
  { name: "Baby Luigi", image: "assets/images/baby luigi.png", class: "Speed", avg: 0.482, gp: 24, hr: 0, pa: 83, hits: 40, slg: 0.566, obp: 0.482, doubles: 1, triples: 3 },
  { name: "Baby Mario", image: "assets/images/baby mario.png", class: "Speed", avg: 0.409, gp: 11, hr: 0, pa: 44, hits: 18, slg: 0.409, obp: 0.409, doubles: 0, triples: 0 },
  { name: "Baby Peach", image: "assets/images/baby peach.png", class: "Balanced", avg: 0.293, gp: 35, hr: 0, pa: 123, hits: 36, slg: 0.358, obp: 0.293, doubles: 6, triples: 1 },
  { name: "Birdo", image: "assets/images/birdo.png", class: "Power", avg: 0.559, gp: 68, hr: 36, pa: 270, hits: 151, slg: 1.011, obp: 0.563, doubles: 9, triples: 1 },
  { name: "Black Shy Guy", image: "assets/images/black shy guy.png", class: "Technique", avg: 0.383, gp: 36, hr: 0, pa: 120, hits: 46, slg: 0.398, obp: 0.382, doubles: 2, triples: 0 },
  ...
  { name: "Blooper", image: "assets/images/blooper.png", class: "Balanced", avg: 0.583, gp: 56, hr: 3, pa: 223, hits: 130, slg: 0.697, obp: 0.588, doubles: 11, triples: 1 },
  { name: "Blue Dry Bones", image: "assets/images/blue dry bones.png", class: "Balanced", avg: 0.625, gp: 68, hr: 14, pa: 275, hits: 172, slg: 0.85, obp: 0.627, doubles: 12, triples: 2 },
  { name: "Blue Kritter", image: "assets/images/blue kritter.png", class: "Power", avg: 0.527, gp: 68, hr: 26, pa: 273, hits: 144, slg: 0.88, obp: 0.519, doubles: 13, triples: 3 },
  ...
  { name: "Blue Toad", image: "assets/images/blue toad.png", class: "Speed", avg: 0.618, gp: 62, hr: 6, pa: 251, hits: 155, slg: 0.745, obp: 0.618, doubles: 12, triples: 1 },
  { name: "Blue Yoshi", image: "assets/images/blue yoshi.png", class: "Speed", avg: 0.696, gp: 19, hr: 1, pa: 79, hits: 55, slg: 0.855, obp: 0.705, doubles: 3, triples: 2 },
  { name: "Boo", image: "assets/images/boo.png", class: "Speed", avg: 0.477, gp: 57, hr: 2, pa: 193, hits: 92, slg: 0.539, obp: 0.477, doubles: 6, triples: 0 },
  { name: "Boomerang Bro", image: "assets/images/boomerang bro.png", class: "Power", avg: 0.482, gp: 68, hr: 35, pa: 257, hits: 124, slg: 0.926, obp: 0.486, doubles: 4, triples: 1 },
  ...
  { name: "Bowser Jr", image: "assets/images/bowser jr.png", class: "Technique", avg: 0.476, gp: 68, hr: 6, pa: 254, hits: 121, slg: 0.619, obp: 0.476, doubles: 16, triples: 0 },
  { name: "Bowser", image: "assets/images/bowser.png", class: "Power", avg: 0.634, gp: 68, hr: 82, pa: 287, hits: 182, slg: 1.605, obp: 0.634, doubles: 21, triples: 5 },
  { name: "Brown Kritter", image: "assets/images/brown kritter.png", class: "Power", avg: 0.475, gp: 67, hr: 46, pa: 263, hits: 125, slg: 1.078, obp: 0.483, doubles: 10, triples: 1 },
  ...
  { name: "Charlie Kirk", image: "assets/images/charlie kirk.jpg", class: "Balanced", avg: 0.387, gp: 8, hr: 0, pa: 31, hits: 12, slg: 0.419, obp: 0.387, doubles: 1, triples: 0 },
  ...
  { name: "Daisy", image: "assets/images/daisy.png", class: "Technique", avg: 0.477, gp: 66, hr: 8, pa: 256, hits: 122, slg: 0.668, obp: 0.477, doubles: 19, triples: 2 },
  { name: "Dark Bones", image: "assets/images/dark bones.png", class: "Balanced", avg: 0.64, gp: 68, hr: 21, pa: 286, hits: 183, slg: 0.954, obp: 0.643, doubles: 21, triples: 2 },
  ...
  { name: "Doc Brown", image: "assets/images/doc brown.jpg", class: "Balanced", avg: 0.416, gp: 26, hr: 3, pa: 101, hits: 42, slg: 0.612, obp: 0.415, doubles: 9, triples: 0 },
  { name: "Donkey Kong", image: "assets/images/donkey kong.png", class: "Power", avg: 0.576, gp: 68, hr: 71, pa: 271, hits: 156, slg: 1.396, obp: 0.576, doubles: 7, triples: 0 },
  ...
  { name: "Dry Bones", image: "assets/images/dry bones.png", class: "Balanced", avg: 0.596, gp: 68, hr: 15, pa: 265, hits: 158, slg: 0.871, obp: 0.599, doubles: 17, triples: 4 },
  { name: "Dwayne Wade", image: "assets/images/dwayne wade.jpg", class: "Balanced", avg: 0.471, gp: 67, hr: 4, pa: 238, hits: 112, slg: 0.542, obp: 0.47, doubles: 3, triples: 1 },
  ...
  { name: "Fire Bro", image: "assets/images/fire bro.png", class: "Power", avg: 0.594, gp: 68, hr: 68, pa: 278, hits: 165, slg: 1.373, obp: 0.593, doubles: 7, triples: 1 },
  { name: "Frozone", image: "assets/images/frozone.jpg", class: "Balanced", avg: 0.402, gp: 24, hr: 6, pa: 102, hits: 41, slg: 0.585, obp: 0.402, doubles: 0, triples: 0 },
  { name: "Funky Kong", image: "assets/images/funky kong.png", class: "Power", avg: 0.47, gp: 68, hr: 42, pa: 264, hits: 124, slg: 1.019, obp: 0.477, doubles: 5, triples: 3 },
  ...
  { name: "Genghis Khan", image: "assets/images/genghis khan.jpg", class: "Balanced", avg: 0.5, gp: 8, hr: 0, pa: 28, hits: 14, slg: 0.536, obp: 0.5, doubles: 1, triples: 0 },
  ...
  { name: "Goomba", image: "assets/images/goomba.png", class: "Speed", avg: 0.415, gp: 9, hr: 2, pa: 41, hits: 17, slg: 0.561, obp: 0.414, doubles: 0, triples: 0 },
  { name: "Green Dry Bones", image: "assets/images/green dry bones.png", class: "Balanced", avg: 0.562, gp: 68, hr: 16, pa: 276, hits: 155, slg: 0.792, obp: 0.564, doubles: 12, triples: 1 },
  { name: "Green Magikoopa", image: "assets/images/green magikoopa.png", class: "Balanced", avg: 0.476, gp: 68, hr: 5, pa: 248, hits: 118, slg: 0.575, obp: 0.478, doubles: 9, triples: 0 },
  ...
  { name: "Green Shy Guy", image: "assets/images/green shy guy.png", class: "Technique", avg: 0.451, gp: 56, hr: 4, pa: 195, hits: 88, slg: 0.58, obp: 0.445, doubles: 12, triples: 1 },
  { name: "Green Toad", image: "assets/images/green toad.png", class: "Speed", avg: 0.578, gp: 68, hr: 3, pa: 275, hits: 159, slg: 0.703, obp: 0.583, doubles: 13, triples: 4 },
  ...
  { name: "Hammer Bro", image: "assets/images/hammer bro.png", class: "Power", avg: 0.562, gp: 68, hr: 61, pa: 256, hits: 144, slg: 1.307, obp: 0.557, doubles: 9, triples: 0 },
  ...
  { name: "KevinG", image: "assets/images/keving.jpg", class: "Balanced", avg: 0.381, gp: 48, hr: 4, pa: 181, hits: 69, slg: 0.495, obp: 0.381, doubles: 8, triples: 0 },
  ...
  { name: "King Boo", image: "assets/images/king boo.png", class: "Power", avg: 0.564, gp: 68, hr: 41, pa: 275, hits: 155, slg: 1.045, obp: 0.558, doubles: 8, triples: 0 },
  { name: "King K Rool", image: "assets/images/king k rool.png", class: "Power", avg: 0.589, gp: 68, hr: 80, pa: 280, hits: 165, slg: 1.508, obp: 0.589, doubles: 13, triples: 0 },
  ...
  { name: "Kritter", image: "assets/images/kritter.png", class: "Power", avg: 0.56, gp: 68, hr: 47, pa: 277, hits: 155, slg: 1.173, obp: 0.56, doubles: 18, triples: 3 },
  ...
  { name: "Light Blue Yoshi", image: "assets/images/light blue yoshi.png", class: "Speed", avg: 0.5, gp: 11, hr: 0, pa: 44, hits: 22, slg: 0.568, obp: 0.5, doubles: 3, triples: 0 },
  ...
  { name: "Luigi", image: "assets/images/luigi.png", class: "Technique", avg: 0.54, gp: 68, hr: 4, pa: 265, hits: 143, slg: 0.621, obp: 0.542, doubles: 6, triples: 1 },
  ...
  { name: "Magikoopa", image: "assets/images/magikoopa.png", class: "Balanced", avg: 0.508, gp: 67, hr: 5, pa: 240, hits: 122, slg: 0.603, obp: 0.508, doubles: 5, triples: 1 },
  { name: "Mario", image: "assets/images/mario.png", class: "Technique", avg: 0.521, gp: 68, hr: 5, pa: 261, hits: 136, slg: 0.623, obp: 0.522, doubles: 9, triples: 1 },
  ...
  { name: "Miss Hot", image: "assets/images/miss hot.jpg", class: "Balanced", avg: 0.422, gp: 68, hr: 5, pa: 249, hits: 105, slg: 0.549, obp: 0.423, doubles: 13, triples: 1 },
  ...
  { name: "Mr. Incredible", image: "assets/images/mr incredible.jpg", class: "Balanced", avg: 0.444, gp: 38, hr: 1, pa: 142, hits: 63, slg: 0.493, obp: 0.45, doubles: 3, triples: 0 },
  ...
  { name: "Noki", image: "assets/images/noki.png", class: "Balanced", avg: 0.576, gp: 8, hr: 0, pa: 33, hits: 19, slg: 0.697, obp: 0.576, doubles: 2, triples: 1 },
  { name: "Paragoomba", image: "assets/images/paragoomba.png", class: "Balanced", avg: 0.333, gp: 42, hr: 1, pa: 150, hits: 50, slg: 0.368, obp: 0.335, doubles: 2, triples: 0 },
  { name: "Peach", image: "assets/images/peach.png", class: "Technique", avg: 0.42, gp: 68, hr: 3, pa: 257, hits: 108, slg: 0.502, obp: 0.412, doubles: 10, triples: 2 },
  { name: "Petey Piranha", image: "assets/images/petey piranha.png", class: "Power", avg: 0.586, gp: 68, hr: 92, pa: 278, hits: 163, slg: 1.62, obp: 0.59, doubles: 6, triples: 0 },
  { name: "Pianta", image: "assets/images/pianta.png", class: "Power", avg: 0.588, gp: 68, hr: 51, pa: 260, hits: 153, slg: 1.192, obp: 0.581, doubles: 5, triples: 1 },
  { name: "Pink Yoshi", image: "assets/images/pink yoshi.png", class: "Speed", avg: 0.507, gp: 38, hr: 0, pa: 136, hits: 69, slg: 0.586, obp: 0.533, doubles: 7, triples: 0 },
  ...
  { name: "Purple Toad", image: "assets/images/purple toad.png", class: "Speed", avg: 0.645, gp: 50, hr: 0, pa: 183, hits: 118, slg: 0.714, obp: 0.645, doubles: 8, triples: 2 },
  ...
  { name: "Red Koopa Paratroopa", image: "assets/images/red koopa paratroopa.jpg", class: "Balanced", avg: 0.361, gp: 18, hr: 0, pa: 61, hits: 22, slg: 0.406, obp: 0.366, doubles: 2, triples: 0 },
  { name: "Red Koopa Troopa", image: "assets/images/red koopa troopa.png", class: "Speed", avg: 0.449, gp: 24, hr: 1, pa: 89, hits: 40, slg: 0.539, obp: 0.449, doubles: 5, triples: 0 },
  { name: "Red Kritter", image: "assets/images/red kritter.png", class: "Power", avg: 0.49, gp: 68, hr: 38, pa: 263, hits: 129, slg: 0.991, obp: 0.49, doubles: 11, triples: 1 },
  { name: "Red Magikoopa", image: "assets/images/red magikoopa.png", class: "Balanced", avg: 0.453, gp: 67, hr: 2, pa: 254, hits: 115, slg: 0.518, obp: 0.456, doubles: 8, triples: 0 },
  { name: "Red Noki", image: "assets/images/red noki.png", class: "Balanced", avg: 0.385, gp: 11, hr: 0, pa: 39, hits: 15, slg: 0.429, obp: 0.385, doubles: 2, triples: 0 },
  { name: "Red Pianta", image: "assets/images/red pianta.png", class: "Power", avg: 0.563, gp: 68, hr: 27, pa: 263, hits: 148, slg: 0.923, obp: 0.568, doubles: 9, triples: 1 },
  ...
  { name: "Rizzler", image: "assets/images/rizzler.jpg", class: "Balanced", avg: 0.444, gp: 47, hr: 5, pa: 178, hits: 79, slg: 0.565, obp: 0.446, doubles: 6, triples: 0 },
  ...
  { name: "Toad", image: "assets/images/toad.jpg", class: "Balanced", avg: 0.657, gp: 60, hr: 2, pa: 233, hits: 153, slg: 0.755, obp: 0.66, doubles: 7, triples: 4 },
  { name: "Toadette", image: "assets/images/toadette.png", class: "Balanced", avg: 0.518, gp: 66, hr: 2, pa: 247, hits: 128, slg: 0.588, obp: 0.523, doubles: 6, triples: 2 },
  { name: "Toadsworth", image: "assets/images/toadsworth.png", class: "Balanced", avg: 0.395, gp: 21, hr: 0, pa: 81, hits: 32, slg: 0.446, obp: 0.408, doubles: 3, triples: 0 },
  { name: "Tobey Maguire", image: "assets/images/tobey maguire.jpg", class: "Balanced", avg: 0.467, gp: 8, hr: 1, pa: 30, hits: 14, slg: 0.6, obp: 0.467, doubles: 1, triples: 0 },
  ...
  { name: "Tung Tung Tung Sahur", image: "assets/images/tung tung tung sahur.jpg", class: "Balanced", avg: 0.425, gp: 28, hr: 3, pa: 106, hits: 45, slg: 0.566, obp: 0.425, doubles: 6, triples: 0 },
  { name: "Unc", image: "assets/images/unc.jpg", class: "Balanced", avg: 0.492, gp: 68, hr: 20, pa: 254, hits: 125, slg: 0.75, obp: 0.496, doubles: 4, triples: 0 },
  ...
  { name: "Waluigi", image: "assets/images/waluigi.png", class: "Technique", avg: 0.568, gp: 68, hr: 3, pa: 257, hits: 146, slg: 0.728, obp: 0.574, doubles: 30, triples: 0 },
  { name: "Wario", image: "assets/images/wario.png", class: "Power", avg: 0.566, gp: 68, hr: 22, pa: 267, hits: 151, slg: 0.887, obp: 0.582, doubles: 7, triples: 0 },
  { name: "Wiggler", image: "assets/images/wiggler.png", class: "Speed", avg: 0.616, gp: 68, hr: 11, pa: 281, hits: 173, slg: 0.802, obp: 0.616, doubles: 14, triples: 2 },
  ...
  { name: "Yellow Magikoopa", image: "assets/images/yellow magikoopa.png", class: "Balanced", avg: 0.508, gp: 50, hr: 4, pa: 197, hits: 100, slg: 0.618, obp: 0.508, doubles: 5, triples: 2 },
  { name: "Yellow Pianta", image: "assets/images/yellow pianta.png", class: "Power", avg: 0.586, gp: 68, hr: 26, pa: 278, hits: 163, slg: 0.917, obp: 0.589, doubles: 8, triples: 0 },
  { name: "Yellow Shy Guy", image: "assets/images/yellow shy guy.png", class: "Technique", avg: 0.441, gp: 53, hr: 4, pa: 186, hits: 82, slg: 0.538, obp: 0.441, doubles: 5, triples: 0 },
  { name: "Yellow Toad", image: "assets/images/yellow toad.png", class: "Speed", avg: 0.616, gp: 66, hr: 6, pa: 268, hits: 165, slg: 0.755, obp: 0.616, doubles: 11, triples: 3 },
  { name: "Yellow Yoshi", image: "assets/images/yellow yoshi.png", class: "Speed", avg: 0.533, gp: 28, hr: 0, pa: 107, hits: 57, slg: 0.636, obp: 0.533, doubles: 9, triples: 1 },
  ...
  { name: "Yoshi", image: "assets/images/yoshi.png", class: "Technique", avg: 0.448, gp: 68, hr: 3, pa: 268, hits: 120, slg: 0.523, obp: 0.45, doubles: 8, triples: 1 },
...
if (characterGrid) {
  ...
  "Birdo": { ip: 129, era: 7.02, baa: 0.466, so: 26 },
  "Black Shy Guy": { ip: 2, era: 7.88, baa: 0.657, so: 0 },
  "Black Widow": { ip: 2, era: 10.5, baa: 0.6, so: 0 },
  "Blooper": { ip: 51, era: 8.74, baa: 0.527, so: 2 },
  "Blue Dry Bones": { ip: 61, era: 8.03, baa: 0.511, so: 1 },
  ...
  "Blue Yoshi": { ip: 1, era: 8.4, baa: 0.5, so: 1 },
  "Boo": { ip: 164, era: 7.75, baa: 0.506, so: 5 },
  "Boomerang Bro": { ip: 4, era: 1.5, baa: 0.375, so: 0 },
  "Borat": { ip: 9, era: 21.0, baa: 0.643, so: 0 },
  "Bowser": { ip: 168, era: 7.08, baa: 0.478, so: 38 },
  "Bowser Jr": { ip: 141, era: 8.4, baa: 0.517, so: 10 },
  ...
  "Daisy": { ip: 188, era: 6.2, baa: 0.44, so: 3 },
  ...
  "KevinG": { ip: 70, era: 6.81, baa: 0.47, so: 3 },
  "Kim Jong Un": { ip: 4, era: 12.25, baa: 0.565, so: 1 },
  "King Boo": { ip: 79, era: 11.95, baa: 0.556, so: 0 },
  ...
  "Magikoopa": { ip: 55, era: 9.14, baa: 0.523, so: 1 },
  "Mario": { ip: 198, era: 8.39, baa: 0.497, so: 14 },
  ...
  "Paragoomba": { ip: 88, era: 9.61, baa: 0.51, so: 1 },
  "Peach": { ip: 186, era: 7.87, baa: 0.5, so: 7 },
  ...
  "Red Koopa Troopa": { ip: 4, era: 8.75, baa: 0.565, so: 0 },
  "Red Kritter": { ip: 8, era: 13.34, baa: 0.568, so: 0 },
  "Red Magikoopa": { ip: 48, era: 8.51, baa: 0.502, so: 0 },
  "Red Pianta": { ip: 62, era: 7.08, baa: 0.496, so: 3 },
  "Red Yoshi": { ip: 1, era: 21.0, baa: 0.6, so: 0 },
  "Rizzler": { ip: 16, era: 12.36, baa: 0.571, so: 0 },
  ...
  "Unc": { ip: 17, era: 8.06, baa: 0.559, so: 0 },
  "Waluigi": { ip: 120, era: 8.1, baa: 0.464, so: 5 },
  "Wario": { ip: 135, era: 9.16, baa: 0.499, so: 6 },
  "Wiggler": { ip: 13, era: 5.79, baa: 0.469, so: 0 },
  "Yellow Magikoopa": { ip: 38, era: 9.05, baa: 0.431, so: 1 },
  "Yellow Pianta": { ip: 48, era: 10.0, baa: 0.532, so: 3 },
  ...
  "Yoshi": { ip: 114, era: 7.52, baa: 0.478, so: 3 },
};
