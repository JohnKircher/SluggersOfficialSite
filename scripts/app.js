...
const characters = [
  { name: "Baby DK", image: "assets/images/baby dk.png", class: "Speed", avg: 0.49, gp: 26, hr: 4, pa: 102, hits: 50, slg: 0.681, obp: 0.5, doubles: 4, triples: 1 },
  { name: "Baby Daisy", image: "assets/images/baby daisy.png", class: "Power", avg: 0.397, gp: 18, hr: 0, pa: 63, hits: 25, slg: 0.46, obp: 0.391, doubles: 2, triples: 1 },
  ...
  { name: "Birdo", image: "assets/images/birdo.png", class: "Power", avg: 0.567, gp: 26, hr: 10, pa: 97, hits: 55, slg: 0.916, obp: 0.577, doubles: 3, triples: 0 },
  ...
  { name: "Blue Dry Bones", image: "assets/images/blue dry bones.png", class: "Balanced", avg: 0.64, gp: 26, hr: 5, pa: 100, hits: 64, slg: 0.898, obp: 0.637, doubles: 7, triples: 1 },
  { name: "Blue Kritter", image: "assets/images/blue kritter.png", class: "Power", avg: 0.474, gp: 26, hr: 9, pa: 95, hits: 45, slg: 0.731, obp: 0.449, doubles: 1, triples: 0 },
  { name: "Blue Shy Guy", image: "assets/images/blue shy guy.png", class: "Technique", avg: 0.226, gp: 10, hr: 0, pa: 31, hits: 7, slg: 0.226, obp: 0.226, doubles: 0, triples: 0 },
  { name: "Blue Toad", image: "assets/images/blue toad.png", class: "Speed", avg: 0.589, gp: 20, hr: 2, pa: 73, hits: 43, slg: 0.754, obp: 0.589, doubles: 6, triples: 0 },
  ...
  { name: "Boo", image: "assets/images/boo.png", class: "Speed", avg: 0.57, gp: 25, hr: 0, pa: 86, hits: 49, slg: 0.616, obp: 0.57, doubles: 4, triples: 0 },
  { name: "Boomerang Bro", image: "assets/images/boomerang bro.png", class: "Power", avg: 0.516, gp: 26, hr: 14, pa: 95, hits: 49, slg: 0.979, obp: 0.516, doubles: 2, triples: 0 },
  { name: "Borat", image: "assets/images/borat.jpg", class: "Balanced", avg: 0.4, gp: 26, hr: 0, pa: 105, hits: 42, slg: 0.438, obp: 0.4, doubles: 4, triples: 0 },
  { name: "Bowser Jr", image: "assets/images/bowser jr.png", class: "Technique", avg: 0.465, gp: 26, hr: 3, pa: 99, hits: 46, slg: 0.573, obp: 0.465, doubles: 1, triples: 0 },
  { name: "Bowser", image: "assets/images/bowser.png", class: "Power", avg: 0.562, gp: 26, hr: 26, pa: 112, hits: 63, slg: 1.355, obp: 0.562, doubles: 5, triples: 2 },
  { name: "Brown Kritter", image: "assets/images/brown kritter.png", class: "Power", avg: 0.473, gp: 26, hr: 13, pa: 93, hits: 44, slg: 0.975, obp: 0.484, doubles: 4, triples: 1 },
  ...
  { name: "Carby", image: "assets/images/carby.jpg", class: "Balanced", avg: 0.464, gp: 6, hr: 1, pa: 28, hits: 13, slg: 0.571, obp: 0.464, doubles: 0, triples: 0 },
  { name: "Chicken", image: "assets/images/chicken.jpg", class: "Balanced", avg: 0.42, gp: 22, hr: 0, pa: 81, hits: 34, slg: 0.432, obp: 0.42, doubles: 1, triples: 0 },
  ...
  { name: "Daisy", image: "assets/images/daisy.png", class: "Power", avg: 0.457, gp: 24, hr: 4, pa: 92, hits: 42, slg: 0.67, obp: 0.456, doubles: 7, triples: 0 },
  { name: "Dark Bones", image: "assets/images/dark bones.png", class: "Balanced", avg: 0.66, gp: 26, hr: 9, pa: 106, hits: 70, slg: 0.992, obp: 0.668, doubles: 8, triples: 0 },
  { name: "Diddy Kong", image: "assets/images/diddy kong.png", class: "Technique", avg: 0.495, gp: 26, hr: 1, pa: 103, hits: 51, slg: 0.597, obp: 0.495, doubles: 7, triples: 0 },
  { name: "Dixie Kong", image: "assets/images/dixie kong.png", class: "Balanced", avg: 0.538, gp: 14, hr: 1, pa: 52, hits: 28, slg: 0.635, obp: 0.538, doubles: 2, triples: 0 },
  { name: "Donkey Kong", image: "assets/images/donkey kong.png", class: "Power", avg: 0.637, gp: 26, hr: 23, pa: 102, hits: 65, slg: 1.365, obp: 0.637, doubles: 4, triples: 0 },
  { name: "Dry Bones", image: "assets/images/dry bones.png", class: "Balanced", avg: 0.646, gp: 26, hr: 13, pa: 99, hits: 64, slg: 1.151, obp: 0.647, doubles: 8, triples: 1 },
  { name: "Dwayne Wade", image: "assets/images/dwayne wade.jpg", class: "Balanced", avg: 0.464, gp: 26, hr: 1, pa: 84, hits: 39, slg: 0.5, obp: 0.464, doubles: 0, triples: 0 },
  ...
  { name: "Fire Bro", image: "assets/images/fire bro.png", class: "Power", avg: 0.598, gp: 26, hr: 30, pa: 102, hits: 61, slg: 1.497, obp: 0.597, doubles: 3, triples: 0 },
  ...
  { name: "Funky Kong", image: "assets/images/funky kong.png", class: "Power", avg: 0.474, gp: 26, hr: 15, pa: 97, hits: 46, slg: 1.026, obp: 0.493, doubles: 0, triples: 2 },
  ...
  { name: "Green Dry Bones", image: "assets/images/green dry bones.png", class: "Balanced", avg: 0.525, gp: 26, hr: 10, pa: 99, hits: 52, slg: 0.859, obp: 0.525, doubles: 1, triples: 1 },
  { name: "Green Magikoopa", image: "assets/images/green magikoopa.png", class: "Balanced", avg: 0.557, gp: 26, hr: 2, pa: 88, hits: 49, slg: 0.659, obp: 0.557, doubles: 3, triples: 0 },
  ...
  { name: "Green Shy Guy", image: "assets/images/green shy guy.png", class: "Technique", avg: 0.338, gp: 24, hr: 0, pa: 80, hits: 27, slg: 0.366, obp: 0.322, doubles: 2, triples: 1 },
  { name: "Green Toad", image: "assets/images/green toad.png", class: "Speed", avg: 0.653, gp: 26, hr: 2, pa: 95, hits: 62, slg: 0.869, obp: 0.66, doubles: 8, triples: 2 },
  { name: "Hammer Bro", image: "assets/images/hammer bro.png", class: "Power", avg: 0.521, gp: 26, hr: 21, pa: 96, hits: 50, slg: 1.162, obp: 0.505, doubles: 1, triples: 0 },
  ...
  { name: "KevinG", image: "assets/images/keving.jpg", class: "Balanced", avg: 0.16, gp: 7, hr: 2, pa: 25, hits: 4, slg: 0.419, obp: 0.16, doubles: 0, triples: 0 },
  { name: "King Boo", image: "assets/images/king boo.png", class: "Power", avg: 0.505, gp: 26, hr: 16, pa: 93, hits: 47, slg: 1.056, obp: 0.488, doubles: 2, triples: 0 },
  { name: "King K Rool", image: "assets/images/king k rool.png", class: "Power", avg: 0.6, gp: 26, hr: 26, pa: 105, hits: 63, slg: 1.407, obp: 0.6, doubles: 4, triples: 0 },
  { name: "Koopa Paratroopa", image: "assets/images/koopa paratroopa.png", class: "Balanced", avg: 0.337, gp: 22, hr: 1, pa: 83, hits: 28, slg: 0.397, obp: 0.337, doubles: 2, triples: 0 },
  ...
  { name: "Kritter", image: "assets/images/kritter.png", class: "Power", avg: 0.574, gp: 26, hr: 18, pa: 108, hits: 62, slg: 1.194, obp: 0.574, doubles: 11, triples: 1 },
  { name: "Lara Croft", image: "assets/images/lara croft.jpg", class: "Balanced", avg: 0.37, gp: 16, hr: 0, pa: 54, hits: 20, slg: 0.37, obp: 0.37, doubles: 0, triples: 0 },
  { name: "Lebron James", image: "assets/images/lebron james.jpg", class: "Balanced", avg: 0.24, gp: 6, hr: 1, pa: 25, hits: 6, slg: 0.417, obp: 0.25, doubles: 1, triples: 0 },
  ...
  { name: "Lilo", image: "assets/images/lilo.jpg", class: "Balanced", avg: 0.434, gp: 16, hr: 1, pa: 53, hits: 23, slg: 0.585, obp: 0.434, doubles: 3, triples: 1 },
  { name: "Livvy Dunne", image: "assets/images/livvy dunne.jpg", class: "Balanced", avg: 0.478, gp: 6, hr: 0, pa: 23, hits: 11, slg: 0.478, obp: 0.478, doubles: 0, triples: 0 },
  ...
  { name: "Luigi", image: "assets/images/luigi.png", class: "Speed", avg: 0.49, gp: 26, hr: 0, pa: 98, hits: 48, slg: 0.521, obp: 0.49, doubles: 1, triples: 1 },
  ...
  { name: "Magikoopa", image: "assets/images/magikoopa.png", class: "Balanced", avg: 0.517, gp: 26, hr: 2, pa: 87, hits: 45, slg: 0.609, obp: 0.517, doubles: 2, triples: 0 },
  { name: "Mario", image: "assets/images/mario.png", class: "Balanced", avg: 0.579, gp: 26, hr: 3, pa: 95, hits: 55, slg: 0.723, obp: 0.58, doubles: 2, triples: 1 },
  ...
  { name: "Mikasa", image: "assets/images/mikasa.jpg", class: "Balanced", avg: 0.355, gp: 16, hr: 0, pa: 62, hits: 22, slg: 0.385, obp: 0.359, doubles: 2, triples: 0 },
  { name: "Minion", image: "assets/images/minion.jpg", class: "Balanced", avg: 0.393, gp: 24, hr: 0, pa: 84, hits: 33, slg: 0.417, obp: 0.393, doubles: 2, triples: 0 },
  ...
  { name: "Miss Hot", image: "assets/images/miss hot.jpg", class: "Balanced", avg: 0.511, gp: 26, hr: 2, pa: 90, hits: 46, slg: 0.653, obp: 0.511, doubles: 6, triples: 0 },
  { name: "Monty Mole", image: "assets/images/monty mole.png", class: "Speed", avg: 0.429, gp: 6, hr: 1, pa: 21, hits: 9, slg: 0.571, obp: 0.429, doubles: 0, triples: 0 },
  { name: "Mr. Incredible", image: "assets/images/mr incredible.jpg", class: "Balanced", avg: 0.402, gp: 26, hr: 0, pa: 92, hits: 37, slg: 0.446, obp: 0.412, doubles: 3, triples: 0 },
  ...
  { name: "Peach", image: "assets/images/peach.png", class: "Balanced", avg: 0.372, gp: 26, hr: 0, pa: 94, hits: 35, slg: 0.427, obp: 0.351, doubles: 5, triples: 1 },
  { name: "Petey Piranha", image: "assets/images/petey piranha.png", class: "Power", avg: 0.505, gp: 26, hr: 25, pa: 101, hits: 51, slg: 1.258, obp: 0.505, doubles: 1, triples: 0 },
  { name: "Pianta", image: "assets/images/pianta.png", class: "Speed", avg: 0.632, gp: 26, hr: 6, pa: 95, hits: 60, slg: 0.788, obp: 0.61, doubles: 0, triples: 0 },
  { name: "Pink Yoshi", image: "assets/images/pink yoshi.png", class: "Speed", avg: 0.544, gp: 17, hr: 0, pa: 57, hits: 31, slg: 0.643, obp: 0.597, doubles: 3, triples: 0 },
  { name: "Purple Toad", image: "assets/images/purple toad.png", class: "Speed", avg: 0.654, gp: 8, hr: 0, pa: 26, hits: 17, slg: 0.799, obp: 0.654, doubles: 3, triples: 0 },
  ...
  { name: "Red Koopa Troopa", image: "assets/images/red koopa troopa.png", class: "Speed", avg: 0.413, gp: 12, hr: 1, pa: 46, hits: 19, slg: 0.522, obp: 0.413, doubles: 2, triples: 0 },
  { name: "Red Kritter", image: "assets/images/red kritter.png", class: "Power", avg: 0.455, gp: 26, hr: 9, pa: 101, hits: 46, slg: 0.795, obp: 0.454, doubles: 5, triples: 0 },
  { name: "Red Magikoopa", image: "assets/images/red magikoopa.png", class: "Balanced", avg: 0.467, gp: 25, hr: 1, pa: 92, hits: 43, slg: 0.527, obp: 0.472, doubles: 2, triples: 0 },
  ...
  { name: "Red Pianta", image: "assets/images/red pianta.png", class: "Speed", avg: 0.577, gp: 26, hr: 6, pa: 97, hits: 56, slg: 0.822, obp: 0.59, doubles: 4, triples: 0 },
  { name: "Red Yoshi", image: "assets/images/red yoshi.png", class: "Speed", avg: 0.357, gp: 19, hr: 1, pa: 70, hits: 25, slg: 0.4, obp: 0.357, doubles: 0, triples: 0 },
  { name: "Rizzler", image: "assets/images/rizzler.jpg", class: "Balanced", avg: 0.478, gp: 6, hr: 1, pa: 23, hits: 11, slg: 0.609, obp: 0.478, doubles: 0, triples: 0 },
  { name: "Saddam Hussein", image: "assets/images/saddam hussein.jpg", class: "Balanced", avg: 0.48, gp: 6, hr: 2, pa: 25, hits: 12, slg: 0.8, obp: 0.48, doubles: 2, triples: 0 },
  ...
  { name: "Tiny Kong", image: "assets/images/tiny kong.png", class: "Balanced", avg: 0.461, gp: 26, hr: 1, pa: 102, hits: 47, slg: 0.529, obp: 0.461, doubles: 2, triples: 1 },
  { name: "Toad", image: "assets/images/toad.jpg", class: "Balanced", avg: 0.627, gp: 18, hr: 0, pa: 67, hits: 42, slg: 0.642, obp: 0.627, doubles: 1, triples: 0 },
  { name: "Toadette", image: "assets/images/toadette.png", class: "Balanced", avg: 0.37, gp: 24, hr: 1, pa: 81, hits: 30, slg: 0.457, obp: 0.37, doubles: 2, triples: 1 },
  ...
  { name: "Trinity", image: "assets/images/trinity.jpg", class: "Balanced", avg: 0.386, gp: 16, hr: 1, pa: 57, hits: 22, slg: 0.456, obp: 0.386, doubles: 1, triples: 0 },
  { name: "Tsitsipas", image: "assets/images/tsitsipas.jpg", class: "Balanced", avg: 0.429, gp: 2, hr: 0, pa: 7, hits: 3, slg: 0.571, obp: 0.429, doubles: 1, triples: 0 },
  { name: "Unc", image: "assets/images/unc.jpg", class: "Balanced", avg: 0.51, gp: 26, hr: 5, pa: 98, hits: 50, slg: 0.698, obp: 0.521, doubles: 2, triples: 0 },
  { name: "Waluigi", image: "assets/images/waluigi.png", class: "Technique", avg: 0.559, gp: 26, hr: 0, pa: 93, hits: 52, slg: 0.683, obp: 0.565, doubles: 11, triples: 0 },
  { name: "Wario", image: "assets/images/wario.png", class: "Technique", avg: 0.59, gp: 26, hr: 7, pa: 105, hits: 62, slg: 0.93, obp: 0.633, doubles: 2, triples: 0 },
  { name: "Wiggler", image: "assets/images/wiggler.png", class: "Speed", avg: 0.676, gp: 26, hr: 2, pa: 108, hits: 73, slg: 0.822, obp: 0.676, doubles: 7, triples: 1 },
  ...
  { name: "Yellow Pianta", image: "assets/images/yellow pianta.png", class: "Speed", avg: 0.583, gp: 26, hr: 2, pa: 103, hits: 60, slg: 0.672, obp: 0.588, doubles: 2, triples: 0 },
  { name: "Yellow Shy Guy", image: "assets/images/yellow shy guy.png", class: "Technique", avg: 0.378, gp: 12, hr: 1, pa: 45, hits: 17, slg: 0.459, obp: 0.378, doubles: 0, triples: 0 },
  { name: "Yellow Toad", image: "assets/images/yellow toad.png", class: "Speed", avg: 0.611, gp: 24, hr: 2, pa: 95, hits: 58, slg: 0.745, obp: 0.611, doubles: 4, triples: 1 },
  { name: "Yellow Yoshi", image: "assets/images/yellow yoshi.png", class: "Speed", avg: 0.348, gp: 6, hr: 0, pa: 23, hits: 8, slg: 0.391, obp: 0.348, doubles: 1, triples: 0 },
  ...
  { name: "Yoshi", image: "assets/images/yoshi.png", class: "Speed", avg: 0.366, gp: 26, hr: 2, pa: 101, hits: 37, slg: 0.452, obp: 0.371, doubles: 2, triples: 0 },
...
if (characterGrid) {
  ...
  "Birdo": { ip: 68, era: 4.41, baa: 0.416, so: 12 },
  ...
  "Boo": { ip: 85, era: 6.92, baa: 0.506, so: 3 },
  ...
  "Daisy": { ip: 74, era: 7.85, baa: 0.475, so: 0 },
  "Dark Bones": { ip: 21, era: 4.91, baa: 0.377, so: 0 },
  "Diddy Kong": { ip: 53, era: 7.82, baa: 0.499, so: 2 },
  "Dixie Kong": { ip: 3, era: 0.0, baa: 0.286, so: 1 },
  "Donkey Kong": { ip: 87, era: 6.85, baa: 0.485, so: 3 },
  ...
  "Green Magikoopa": { ip: 13, era: 12.0, baa: 0.549, so: 0 },
  ...
  "Luigi": { ip: 100, era: 6.62, baa: 0.477, so: 7 },
  "Magikoopa": { ip: 32, era: 8.7, baa: 0.503, so: 0 },
  ...
  "Monty Mole": { ip: 20, era: 5.42, baa: 0.479, so: 0 },
  "Mr. Incredible": { ip: 35, era: 4.56, baa: 0.466, so: 0 },
  "Mrs.Claus": { ip: 4, era: 3.23, baa: 0.313, so: 0 },
  "Paragoomba": { ip: 27, era: 5.84, baa: 0.422, so: 0 },
  "Peach": { ip: 87, era: 6.38, baa: 0.468, so: 1 },
  "Pink Yoshi": { ip: 1, era: 21.0, baa: 0.778, so: 0 },
  "Red Kritter": { ip: 6, era: 9.62, baa: 0.543, so: 0 },
  "Red Magikoopa": { ip: 38, era: 8.79, baa: 0.503, so: 0 },
  ...
  "Trinity": { ip: 67, era: 4.5, baa: 0.455, so: 2 },
  ...
  "Yoshi": { ip: 54, era: 6.75, baa: 0.475, so: 1 },
};
