...
const characters = [
  { name: "Baby DK", image: "assets/images/baby dk.png", class: "Speed", avg: 0.483, gp: 66, hr: 9, pa: 259, hits: 125, slg: 0.633, obp: 0.488, doubles: 8, triples: 1 },
  ...
  { name: "Baby Luigi", image: "assets/images/baby luigi.png", class: "Speed", avg: 0.5, gp: 22, hr: 0, pa: 78, hits: 39, slg: 0.59, obp: 0.5, doubles: 1, triples: 3 },
  { name: "Baby Mario", image: "assets/images/baby mario.png", class: "Speed", avg: 0.405, gp: 9, hr: 0, pa: 37, hits: 15, slg: 0.405, obp: 0.405, doubles: 0, triples: 0 },
  { name: "Baby Peach", image: "assets/images/baby peach.png", class: "Balanced", avg: 0.296, gp: 33, hr: 0, pa: 115, hits: 34, slg: 0.365, obp: 0.296, doubles: 6, triples: 1 },
  { name: "Birdo", image: "assets/images/birdo.png", class: "Power", avg: 0.555, gp: 66, hr: 36, pa: 263, hits: 146, slg: 1.011, obp: 0.559, doubles: 9, triples: 0 },
  ...
  { name: "Blooper", image: "assets/images/blooper.png", class: "Balanced", avg: 0.577, gp: 54, hr: 2, pa: 213, hits: 123, slg: 0.677, obp: 0.582, doubles: 10, triples: 1 },
  { name: "Blue Dry Bones", image: "assets/images/blue dry bones.png", class: "Balanced", avg: 0.629, gp: 66, hr: 14, pa: 267, hits: 168, slg: 0.86, obp: 0.631, doubles: 12, triples: 2 },
  { name: "Blue Kritter", image: "assets/images/blue kritter.png", class: "Power", avg: 0.528, gp: 66, hr: 25, pa: 265, hits: 140, slg: 0.872, obp: 0.519, doubles: 11, triples: 3 },
  ...
  { name: "Blue Toad", image: "assets/images/blue toad.png", class: "Speed", avg: 0.614, gp: 60, hr: 6, pa: 241, hits: 148, slg: 0.747, obp: 0.614, doubles: 12, triples: 1 },
  { name: "Blue Yoshi", image: "assets/images/blue yoshi.png", class: "Speed", avg: 0.681, gp: 17, hr: 0, pa: 72, hits: 49, slg: 0.812, obp: 0.69, doubles: 3, triples: 2 },
  { name: "Boo", image: "assets/images/boo.png", class: "Speed", avg: 0.465, gp: 55, hr: 2, pa: 185, hits: 86, slg: 0.53, obp: 0.465, doubles: 6, triples: 0 },
  { name: "Boomerang Bro", image: "assets/images/boomerang bro.png", class: "Power", avg: 0.482, gp: 66, hr: 33, pa: 249, hits: 120, slg: 0.916, obp: 0.486, doubles: 4, triples: 1 },
  ...
  { name: "Bowser Jr", image: "assets/images/bowser jr.png", class: "Technique", avg: 0.48, gp: 66, hr: 6, pa: 246, hits: 118, slg: 0.623, obp: 0.48, doubles: 15, triples: 0 },
  { name: "Bowser", image: "assets/images/bowser.png", class: "Power", avg: 0.624, gp: 66, hr: 79, pa: 279, hits: 174, slg: 1.587, obp: 0.624, doubles: 20, triples: 5 },
  { name: "Brown Kritter", image: "assets/images/brown kritter.png", class: "Power", avg: 0.47, gp: 65, hr: 45, pa: 253, hits: 119, slg: 1.08, obp: 0.478, doubles: 10, triples: 1 },
  ...
  { name: "Charlie Kirk", image: "assets/images/charlie kirk.jpg", class: "Balanced", avg: 0.375, gp: 6, hr: 0, pa: 24, hits: 9, slg: 0.417, obp: 0.375, doubles: 1, triples: 0 },
  ...
  { name: "Daisy", image: "assets/images/daisy.png", class: "Power", avg: 0.474, gp: 64, hr: 8, pa: 249, hits: 118, slg: 0.671, obp: 0.474, doubles: 19, triples: 2 },
  { name: "Dark Bones", image: "assets/images/dark bones.png", class: "Balanced", avg: 0.634, gp: 66, hr: 20, pa: 276, hits: 175, slg: 0.949, obp: 0.637, doubles: 21, triples: 2 },
  ...
  { name: "Doc Brown", image: "assets/images/doc brown.jpg", class: "Balanced", avg: 0.436, gp: 24, hr: 3, pa: 94, hits: 41, slg: 0.649, obp: 0.436, doubles: 9, triples: 0 },
  { name: "Donkey Kong", image: "assets/images/donkey kong.png", class: "Power", avg: 0.579, gp: 66, hr: 69, pa: 261, hits: 151, slg: 1.408, obp: 0.578, doubles: 7, triples: 0 },
  ...
  { name: "Dry Bones", image: "assets/images/dry bones.png", class: "Balanced", avg: 0.591, gp: 66, hr: 15, pa: 257, hits: 152, slg: 0.864, obp: 0.594, doubles: 16, triples: 3 },
  { name: "Dwayne Wade", image: "assets/images/dwayne wade.jpg", class: "Balanced", avg: 0.478, gp: 65, hr: 4, pa: 230, hits: 110, slg: 0.552, obp: 0.478, doubles: 3, triples: 1 },
  ...
  { name: "Fire Bro", image: "assets/images/fire bro.png", class: "Power", avg: 0.6, gp: 66, hr: 67, pa: 270, hits: 162, slg: 1.387, obp: 0.6, doubles: 7, triples: 1 },
  { name: "Frozone", image: "assets/images/frozone.jpg", class: "Balanced", avg: 0.398, gp: 22, hr: 5, pa: 93, hits: 37, slg: 0.567, obp: 0.398, doubles: 0, triples: 0 },
  { name: "Funky Kong", image: "assets/images/funky kong.png", class: "Power", avg: 0.453, gp: 66, hr: 38, pa: 254, hits: 115, slg: 0.975, obp: 0.46, doubles: 5, triples: 3 },
  ...
  { name: "Genghis Khan", image: "assets/images/genghis khan.jpg", class: "Balanced", avg: 0.524, gp: 6, hr: 0, pa: 21, hits: 11, slg: 0.571, obp: 0.524, doubles: 1, triples: 0 },
  ...
  { name: "Goomba", image: "assets/images/goomba.png", class: "Speed", avg: 0.424, gp: 7, hr: 2, pa: 33, hits: 14, slg: 0.606, obp: 0.424, doubles: 0, triples: 0 },
  { name: "Green Dry Bones", image: "assets/images/green dry bones.png", class: "Balanced", avg: 0.566, gp: 66, hr: 15, pa: 267, hits: 151, slg: 0.79, obp: 0.566, doubles: 12, triples: 1 },
  { name: "Green Magikoopa", image: "assets/images/green magikoopa.png", class: "Balanced", avg: 0.469, gp: 66, hr: 4, pa: 241, hits: 113, slg: 0.558, obp: 0.471, doubles: 9, triples: 0 },
  ...
  { name: "Green Shy Guy", image: "assets/images/green shy guy.png", class: "Technique", avg: 0.452, gp: 54, hr: 3, pa: 188, hits: 85, slg: 0.559, obp: 0.446, doubles: 10, triples: 1 },
  { name: "Green Toad", image: "assets/images/green toad.png", class: "Speed", avg: 0.578, gp: 66, hr: 3, pa: 268, hits: 155, slg: 0.706, obp: 0.583, doubles: 13, triples: 4 },
  ...
  { name: "Hammer Bro", image: "assets/images/hammer bro.png", class: "Power", avg: 0.566, gp: 66, hr: 61, pa: 249, hits: 141, slg: 1.328, obp: 0.56, doubles: 8, triples: 0 },
  ...
  { name: "KevinG", image: "assets/images/keving.jpg", class: "Balanced", avg: 0.377, gp: 46, hr: 4, pa: 175, hits: 66, slg: 0.489, obp: 0.377, doubles: 7, triples: 0 },
  ...
  { name: "King Boo", image: "assets/images/king boo.png", class: "Power", avg: 0.563, gp: 66, hr: 41, pa: 268, hits: 151, slg: 1.053, obp: 0.557, doubles: 7, triples: 0 },
  { name: "King K Rool", image: "assets/images/king k rool.png", class: "Power", avg: 0.597, gp: 66, hr: 79, pa: 273, hits: 163, slg: 1.528, obp: 0.597, doubles: 13, triples: 0 },
  ...
  { name: "Kritter", image: "assets/images/kritter.png", class: "Power", avg: 0.563, gp: 66, hr: 46, pa: 270, hits: 152, slg: 1.181, obp: 0.563, doubles: 18, triples: 3 },
  ...
  { name: "Light Blue Yoshi", image: "assets/images/light blue yoshi.png", class: "Speed", avg: 0.588, gp: 9, hr: 0, pa: 34, hits: 20, slg: 0.676, obp: 0.588, doubles: 3, triples: 0 },
  ...
  { name: "Luigi", image: "assets/images/luigi.png", class: "Speed", avg: 0.547, gp: 66, hr: 4, pa: 258, hits: 141, slg: 0.63, obp: 0.549, doubles: 6, triples: 1 },
  ...
  { name: "Magikoopa", image: "assets/images/magikoopa.png", class: "Balanced", avg: 0.504, gp: 65, hr: 4, pa: 232, hits: 117, slg: 0.589, obp: 0.504, doubles: 5, triples: 1 },
  { name: "Mario", image: "assets/images/mario.png", class: "Balanced", avg: 0.516, gp: 66, hr: 5, pa: 254, hits: 131, slg: 0.609, obp: 0.516, doubles: 6, triples: 1 },
  ...
  { name: "Miss Hot", image: "assets/images/miss hot.jpg", class: "Balanced", avg: 0.432, gp: 66, hr: 5, pa: 241, hits: 104, slg: 0.564, obp: 0.433, doubles: 13, triples: 1 },
  ...
  { name: "Mr. Incredible", image: "assets/images/mr incredible.jpg", class: "Balanced", avg: 0.437, gp: 36, hr: 1, pa: 135, hits: 59, slg: 0.489, obp: 0.444, doubles: 3, triples: 0 },
  ...
  { name: "Noki", image: "assets/images/noki.png", class: "Balanced", avg: 0.654, gp: 6, hr: 0, pa: 26, hits: 17, slg: 0.769, obp: 0.654, doubles: 1, triples: 1 },
  { name: "Paragoomba", image: "assets/images/paragoomba.png", class: "Balanced", avg: 0.348, gp: 40, hr: 1, pa: 141, hits: 49, slg: 0.385, obp: 0.349, doubles: 2, triples: 0 },
  { name: "Peach", image: "assets/images/peach.png", class: "Balanced", avg: 0.421, gp: 66, hr: 3, pa: 252, hits: 106, slg: 0.504, obp: 0.413, doubles: 10, triples: 2 },
  { name: "Petey Piranha", image: "assets/images/petey piranha.png", class: "Power", avg: 0.593, gp: 66, hr: 88, pa: 268, hits: 159, slg: 1.62, obp: 0.597, doubles: 6, triples: 0 },
  { name: "Pianta", image: "assets/images/pianta.png", class: "Speed", avg: 0.598, gp: 66, hr: 51, pa: 254, hits: 152, slg: 1.212, obp: 0.59, doubles: 4, triples: 1 },
  { name: "Pink Yoshi", image: "assets/images/pink yoshi.png", class: "Speed", avg: 0.523, gp: 36, hr: 0, pa: 128, hits: 67, slg: 0.599, obp: 0.55, doubles: 6, triples: 0 },
  ...
  { name: "Purple Toad", image: "assets/images/purple toad.png", class: "Speed", avg: 0.64, gp: 48, hr: 0, pa: 178, hits: 114, slg: 0.7, obp: 0.64, doubles: 8, triples: 1 },
  ...
  { name: "Red Koopa Paratroopa", image: "assets/images/red koopa paratroopa.jpg", class: "Balanced", avg: 0.37, gp: 16, hr: 0, pa: 54, hits: 20, slg: 0.415, obp: 0.37, doubles: 2, triples: 0 },
  { name: "Red Koopa Troopa", image: "assets/images/red koopa troopa.png", class: "Speed", avg: 0.439, gp: 22, hr: 1, pa: 82, hits: 36, slg: 0.536, obp: 0.439, doubles: 5, triples: 0 },
  { name: "Red Kritter", image: "assets/images/red kritter.png", class: "Power", avg: 0.49, gp: 66, hr: 37, pa: 255, hits: 125, slg: 0.991, obp: 0.49, doubles: 10, triples: 1 },
  { name: "Red Magikoopa", image: "assets/images/red magikoopa.png", class: "Balanced", avg: 0.445, gp: 65, hr: 2, pa: 247, hits: 110, slg: 0.513, obp: 0.449, doubles: 8, triples: 0 },
  ...
  { name: "Red Pianta", image: "assets/images/red pianta.png", class: "Speed", avg: 0.565, gp: 66, hr: 27, pa: 255, hits: 144, slg: 0.936, obp: 0.57, doubles: 9, triples: 1 },
  { name: "Red Yoshi", image: "assets/images/red yoshi.png", class: "Speed", avg: 0.434, gp: 49, hr: 2, pa: 175, hits: 76, slg: 0.497, obp: 0.441, doubles: 3, triples: 0 },
  { name: "Rizzler", image: "assets/images/rizzler.jpg", class: "Balanced", avg: 0.445, gp: 45, hr: 5, pa: 173, hits: 77, slg: 0.57, obp: 0.447, doubles: 6, triples: 0 },
  ...
  { name: "Shy Guy", image: "assets/images/shy guy.png", class: "Technique", avg: 0.448, gp: 44, hr: 0, pa: 163, hits: 73, slg: 0.492, obp: 0.454, doubles: 6, triples: 0 },
  ...
  { name: "Toad", image: "assets/images/toad.jpg", class: "Balanced", avg: 0.653, gp: 58, hr: 2, pa: 225, hits: 147, slg: 0.755, obp: 0.656, doubles: 7, triples: 4 },
  { name: "Toadette", image: "assets/images/toadette.png", class: "Balanced", avg: 0.517, gp: 64, hr: 2, pa: 240, hits: 124, slg: 0.589, obp: 0.521, doubles: 6, triples: 2 },
  { name: "Toadsworth", image: "assets/images/toadsworth.png", class: "Balanced", avg: 0.397, gp: 19, hr: 0, pa: 73, hits: 29, slg: 0.444, obp: 0.402, doubles: 3, triples: 0 },
  { name: "Tobey Maguire", image: "assets/images/tobey maguire.jpg", class: "Balanced", avg: 0.455, gp: 6, hr: 0, pa: 22, hits: 10, slg: 0.5, obp: 0.455, doubles: 1, triples: 0 },
  ...
  { name: "Tung Tung Tung Sahur", image: "assets/images/tung tung tung sahur.jpg", class: "Balanced", avg: 0.424, gp: 26, hr: 3, pa: 99, hits: 42, slg: 0.576, obp: 0.424, doubles: 6, triples: 0 },
  { name: "Unc", image: "assets/images/unc.jpg", class: "Balanced", avg: 0.502, gp: 66, hr: 20, pa: 247, hits: 124, slg: 0.767, obp: 0.506, doubles: 4, triples: 0 },
  ...
  { name: "Waluigi", image: "assets/images/waluigi.png", class: "Technique", avg: 0.563, gp: 66, hr: 3, pa: 247, hits: 139, slg: 0.725, obp: 0.569, doubles: 29, triples: 0 },
  { name: "Wario", image: "assets/images/wario.png", class: "Technique", avg: 0.568, gp: 66, hr: 21, pa: 257, hits: 146, slg: 0.89, obp: 0.585, doubles: 7, triples: 0 },
  { name: "Wiggler", image: "assets/images/wiggler.png", class: "Speed", avg: 0.624, gp: 66, hr: 10, pa: 271, hits: 169, slg: 0.806, obp: 0.624, doubles: 14, triples: 2 },
  ...
  { name: "Yellow Magikoopa", image: "assets/images/yellow magikoopa.png", class: "Balanced", avg: 0.497, gp: 48, hr: 3, pa: 189, hits: 94, slg: 0.591, obp: 0.497, doubles: 4, triples: 2 },
  { name: "Yellow Pianta", image: "assets/images/yellow pianta.png", class: "Speed", avg: 0.586, gp: 66, hr: 23, pa: 268, hits: 157, slg: 0.885, obp: 0.588, doubles: 7, triples: 0 },
  { name: "Yellow Shy Guy", image: "assets/images/yellow shy guy.png", class: "Technique", avg: 0.438, gp: 51, hr: 4, pa: 176, hits: 77, slg: 0.54, obp: 0.438, doubles: 5, triples: 0 },
  { name: "Yellow Toad", image: "assets/images/yellow toad.png", class: "Speed", avg: 0.62, gp: 64, hr: 6, pa: 258, hits: 160, slg: 0.762, obp: 0.62, doubles: 11, triples: 3 },
  { name: "Yellow Yoshi", image: "assets/images/yellow yoshi.png", class: "Speed", avg: 0.525, gp: 26, hr: 0, pa: 99, hits: 52, slg: 0.626, obp: 0.525, doubles: 8, triples: 1 },
  ...
  { name: "Yoshi", image: "assets/images/yoshi.png", class: "Speed", avg: 0.452, gp: 66, hr: 3, pa: 261, hits: 118, slg: 0.53, obp: 0.454, doubles: 8, triples: 1 },
...
if (characterGrid) {
  ...
  "Blooper": { ip: 49, era: 9.13, baa: 0.534, so: 2 },
  "Blue Dry Bones": { ip: 58, era: 7.34, baa: 0.506, so: 1 },
  ...
  "Boo": { ip: 152, era: 8.15, baa: 0.515, so: 5 },
  "Boomerang Bro": { ip: 4, era: 1.5, baa: 0.375, so: 0 },
  "Borat": { ip: 9, era: 21.0, baa: 0.643, so: 0 },
  "Bowser": { ip: 163, era: 6.93, baa: 0.477, so: 35 },
  "Bowser Jr": { ip: 138, era: 8.22, baa: 0.512, so: 10 },
  "Brown Kritter": { ip: 15, era: 13.76, baa: 0.564, so: 0 },
  ...
  "Daisy": { ip: 180, era: 6.45, baa: 0.442, so: 2 },
  ...
  "KevinG": { ip: 60, era: 7.07, baa: 0.471, so: 2 },
  "Kim Jong Un": { ip: 4, era: 12.25, baa: 0.565, so: 1 },
  "King Boo": { ip: 77, era: 11.53, baa: 0.553, so: 0 },
  ...
  "Mario": { ip: 195, era: 8.27, baa: 0.495, so: 12 },
  ...
  "Paragoomba": { ip: 83, era: 9.42, baa: 0.503, so: 1 },
  "Peach": { ip: 183, era: 7.81, baa: 0.499, so: 6 },
  ...
  "Unc": { ip: 17, era: 5.85, baa: 0.535, so: 0 },
  "Waluigi": { ip: 113, era: 8.04, baa: 0.46, so: 5 },
  "Wario": { ip: 135, era: 9.16, baa: 0.499, so: 6 },
  "Wiggler": { ip: 8, era: 4.52, baa: 0.46, so: 0 },
  "Yellow Magikoopa": { ip: 38, era: 9.05, baa: 0.431, so: 1 },
  "Yellow Pianta": { ip: 43, era: 9.94, baa: 0.517, so: 3 },
  ...
  "Yoshi": { ip: 113, era: 7.34, baa: 0.473, so: 3 },
};
