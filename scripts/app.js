...
const characters = [
  { name: "Baby DK", image: "assets/images/baby dk.png", class: "Speed", avg: 0.5, gp: 42, hr: 5, pa: 164, hits: 82, slg: 0.649, obp: 0.506, doubles: 6, triples: 1 },
  ...
  { name: "Baby Luigi", image: "assets/images/baby luigi.png", class: "Speed", avg: 0.432, gp: 12, hr: 0, pa: 44, hits: 19, slg: 0.546, obp: 0.432, doubles: 1, triples: 2 },
  ...
  { name: "Baby Peach", image: "assets/images/baby peach.png", class: "Balanced", avg: 0.304, gp: 20, hr: 0, pa: 69, hits: 21, slg: 0.348, obp: 0.304, doubles: 3, triples: 0 },
  { name: "Birdo", image: "assets/images/birdo.png", class: "Power", avg: 0.572, gp: 42, hr: 22, pa: 166, hits: 95, slg: 1.011, obp: 0.578, doubles: 6, triples: 0 },
  ...
  { name: "Blooper", image: "assets/images/blooper.png", class: "Balanced", avg: 0.559, gp: 30, hr: 0, pa: 111, hits: 62, slg: 0.641, obp: 0.563, doubles: 6, triples: 1 },
  { name: "Blue Dry Bones", image: "assets/images/blue dry bones.png", class: "Balanced", avg: 0.606, gp: 42, hr: 8, pa: 165, hits: 100, slg: 0.853, obp: 0.608, doubles: 9, triples: 2 },
  { name: "Blue Kritter", image: "assets/images/blue kritter.png", class: "Power", avg: 0.524, gp: 42, hr: 15, pa: 166, hits: 87, slg: 0.815, obp: 0.51, doubles: 6, triples: 0 },
  { name: "Blue Shy Guy", image: "assets/images/blue shy guy.png", class: "Technique", avg: 0.349, gp: 26, hr: 0, pa: 86, hits: 30, slg: 0.376, obp: 0.349, doubles: 2, triples: 0 },
  { name: "Blue Toad", image: "assets/images/blue toad.png", class: "Speed", avg: 0.579, gp: 36, hr: 4, pa: 140, hits: 81, slg: 0.714, obp: 0.578, doubles: 7, triples: 0 },
  { name: "Blue Yoshi", image: "assets/images/blue yoshi.png", class: "Speed", avg: 0.667, gp: 3, hr: 0, pa: 12, hits: 8, slg: 0.667, obp: 0.667, doubles: 0, triples: 0 },
  ...
  { name: "Boomerang Bro", image: "assets/images/boomerang bro.png", class: "Power", avg: 0.503, gp: 42, hr: 23, pa: 159, hits: 80, slg: 0.975, obp: 0.51, doubles: 3, triples: 1 },
  ...
  { name: "Bowler", image: "assets/images/bowler.jpg", class: "Balanced", avg: 0.625, gp: 2, hr: 1, pa: 8, hits: 5, slg: 1.0, obp: 0.625, doubles: 0, triples: 0 },
  { name: "Bowser Jr", image: "assets/images/bowser jr.png", class: "Technique", avg: 0.47, gp: 42, hr: 3, pa: 164, hits: 77, slg: 0.59, obp: 0.469, doubles: 10, triples: 0 },
  { name: "Bowser", image: "assets/images/bowser.png", class: "Power", avg: 0.59, gp: 42, hr: 45, pa: 178, hits: 105, slg: 1.465, obp: 0.59, doubles: 13, triples: 3 },
  { name: "Brown Kritter", image: "assets/images/brown kritter.png", class: "Power", avg: 0.49, gp: 42, hr: 25, pa: 157, hits: 77, slg: 1.066, obp: 0.497, doubles: 9, triples: 1 },
  ...
  { name: "Carby", image: "assets/images/carby.jpg", class: "Balanced", avg: 0.511, gp: 22, hr: 4, pa: 90, hits: 46, slg: 0.72, obp: 0.511, doubles: 4, triples: 1 },
  ...
  { name: "Count Dooku", image: "assets/images/count dooku.jpg", class: "Balanced", avg: 0.222, gp: 2, hr: 0, pa: 9, hits: 2, slg: 0.556, obp: 0.222, doubles: 1, triples: 1 },
  { name: "Daisy", image: "assets/images/daisy.png", class: "Power", avg: 0.468, gp: 40, hr: 7, pa: 158, hits: 74, slg: 0.703, obp: 0.468, doubles: 12, triples: 1 },
  { name: "Dark Bones", image: "assets/images/dark bones.png", class: "Balanced", avg: 0.671, gp: 42, hr: 14, pa: 173, hits: 116, slg: 0.995, obp: 0.675, doubles: 14, triples: 0 },
  { name: "Diddy Kong", image: "assets/images/diddy kong.png", class: "Technique", avg: 0.488, gp: 42, hr: 1, pa: 162, hits: 79, slg: 0.565, obp: 0.488, doubles: 9, triples: 0 },
  { name: "Diminutive", image: "assets/images/diminutive.jpg", class: "Balanced", avg: 0.417, gp: 12, hr: 1, pa: 48, hits: 20, slg: 0.583, obp: 0.416, doubles: 3, triples: 1 },
  ...
  { name: "Doc Brown", image: "assets/images/doc brown.jpg", class: "Balanced", avg: 0.6, gp: 1, hr: 0, pa: 5, hits: 3, slg: 0.6, obp: 0.6, doubles: 0, triples: 0 },
  { name: "Donkey Kong", image: "assets/images/donkey kong.png", class: "Power", avg: 0.598, gp: 42, hr: 42, pa: 164, hits: 98, slg: 1.404, obp: 0.598, doubles: 5, triples: 0 },
  { name: "Dry Bones", image: "assets/images/dry bones.png", class: "Balanced", avg: 0.646, gp: 42, hr: 13, pa: 161, hits: 104, slg: 1.026, obp: 0.646, doubles: 14, triples: 3 },
  { name: "Dwayne Wade", image: "assets/images/dwayne wade.jpg", class: "Balanced", avg: 0.459, gp: 42, hr: 2, pa: 148, hits: 68, slg: 0.5, obp: 0.459, doubles: 0, triples: 0 },
  ...
  { name: "Fire Bro", image: "assets/images/fire bro.png", class: "Power", avg: 0.578, gp: 42, hr: 44, pa: 173, hits: 100, slg: 1.396, obp: 0.578, doubles: 5, triples: 1 },
  ...
  { name: "Funky Kong", image: "assets/images/funky kong.png", class: "Power", avg: 0.433, gp: 42, hr: 24, pa: 164, hits: 71, slg: 0.936, obp: 0.444, doubles: 2, triples: 2 },
  { name: "Gandalf", image: "assets/images/gandalf.jpg", class: "Balanced", avg: 0.357, gp: 12, hr: 1, pa: 42, hits: 15, slg: 0.476, obp: 0.358, doubles: 0, triples: 1 },
  { name: "Ghandi", image: "assets/images/ghandi.jpg", class: "Balanced", avg: 0.279, gp: 12, hr: 0, pa: 43, hits: 12, slg: 0.302, obp: 0.279, doubles: 1, triples: 0 },
  { name: "Goomba", image: "assets/images/goomba.png", class: "Speed", avg: 0.5, gp: 1, hr: 2, pa: 4, hits: 2, slg: 2.0, obp: 0.5, doubles: 0, triples: 0 },
  { name: "Green Dry Bones", image: "assets/images/green dry bones.png", class: "Balanced", avg: 0.526, gp: 42, hr: 14, pa: 175, hits: 92, slg: 0.8, obp: 0.526, doubles: 4, triples: 1 },
  { name: "Green Magikoopa", image: "assets/images/green magikoopa.png", class: "Balanced", avg: 0.513, gp: 42, hr: 2, pa: 154, hits: 79, slg: 0.591, obp: 0.513, doubles: 6, triples: 0 },
  ...
  { name: "Green Toad", image: "assets/images/green toad.png", class: "Speed", avg: 0.629, gp: 42, hr: 2, pa: 167, hits: 105, slg: 0.794, obp: 0.633, doubles: 11, triples: 4 },
  { name: "Gus Fring", image: "assets/images/gus fring.jpg", class: "Balanced", avg: 0.222, gp: 2, hr: 0, pa: 9, hits: 2, slg: 0.333, obp: 0.222, doubles: 1, triples: 0 },
  { name: "Hammer Bro", image: "assets/images/hammer bro.png", class: "Power", avg: 0.537, gp: 42, hr: 38, pa: 162, hits: 87, slg: 1.263, obp: 0.528, doubles: 5, triples: 0 },
  ...
  { name: "Idi Amin", image: "assets/images/idi amin.jpg", class: "Balanced", avg: 0.0, gp: 2, hr: 0, pa: 7, hits: 0, slg: 0.0, obp: 0.0, doubles: 0, triples: 0 },
  ...
  { name: "KevinG", image: "assets/images/keving.jpg", class: "Balanced", avg: 0.382, gp: 22, hr: 3, pa: 89, hits: 34, slg: 0.546, obp: 0.382, doubles: 5, triples: 0 },
  { name: "Kim Jong Un", image: "assets/images/kim jong un.jpg", class: "Balanced", avg: 0.51, gp: 12, hr: 4, pa: 51, hits: 26, slg: 0.745, obp: 0.51, doubles: 0, triples: 0 },
  { name: "King Boo", image: "assets/images/king boo.png", class: "Power", avg: 0.563, gp: 42, hr: 29, pa: 167, hits: 94, slg: 1.115, obp: 0.553, doubles: 4, triples: 0 },
  { name: "King K Rool", image: "assets/images/king k rool.png", class: "Power", avg: 0.615, gp: 42, hr: 50, pa: 174, hits: 107, slg: 1.527, obp: 0.615, doubles: 6, triples: 0 },
  { name: "Koopa Paratroopa", image: "assets/images/koopa paratroopa.png", class: "Balanced", avg: 0.33, gp: 28, hr: 1, pa: 106, hits: 35, slg: 0.381, obp: 0.334, doubles: 2, triples: 0 },
  ...
  { name: "Kritter", image: "assets/images/kritter.png", class: "Power", avg: 0.579, gp: 42, hr: 28, pa: 178, hits: 103, slg: 1.174, obp: 0.579, doubles: 16, triples: 3 },
  ...
  { name: "Lebron James", image: "assets/images/lebron james.jpg", class: "Balanced", avg: 0.384, gp: 22, hr: 6, pa: 86, hits: 33, slg: 0.633, obp: 0.387, doubles: 3, triples: 0 },
  ...
  { name: "Luigi", image: "assets/images/luigi.png", class: "Speed", avg: 0.497, gp: 42, hr: 1, pa: 163, hits: 81, slg: 0.558, obp: 0.501, doubles: 4, triples: 1 },
  ...
  { name: "MLK Jr", image: "assets/images/mlk jr.jpg", class: "Balanced", avg: 0.32, gp: 12, hr: 1, pa: 50, hits: 16, slg: 0.42, obp: 0.32, doubles: 2, triples: 0 },
  ...
  { name: "Mario", image: "assets/images/mario.png", class: "Balanced", avg: 0.5, gp: 42, hr: 5, pa: 160, hits: 80, slg: 0.629, obp: 0.501, doubles: 3, triples: 1 },
  ...
  { name: "Minion", image: "assets/images/minion.jpg", class: "Balanced", avg: 0.406, gp: 30, hr: 0, pa: 106, hits: 43, slg: 0.444, obp: 0.405, doubles: 2, triples: 1 },
  ...
  { name: "Miss Hot", image: "assets/images/miss hot.jpg", class: "Balanced", avg: 0.477, gp: 42, hr: 3, pa: 153, hits: 73, slg: 0.593, obp: 0.477, doubles: 8, triples: 0 },
  ...
  { name: "Peach", image: "assets/images/peach.png", class: "Balanced", avg: 0.436, gp: 42, hr: 0, pa: 165, hits: 72, slg: 0.467, obp: 0.424, doubles: 5, triples: 1 },
  { name: "Petey Piranha", image: "assets/images/petey piranha.png", class: "Power", avg: 0.58, gp: 42, hr: 51, pa: 169, hits: 98, slg: 1.503, obp: 0.58, doubles: 3, triples: 0 },
  { name: "Pianta", image: "assets/images/pianta.png", class: "Speed", avg: 0.61, gp: 42, hr: 23, pa: 159, hits: 97, slg: 1.037, obp: 0.597, doubles: 2, triples: 0 },
  ...
  { name: "Purple Toad", image: "assets/images/purple toad.png", class: "Speed", avg: 0.674, gp: 24, hr: 0, pa: 89, hits: 60, slg: 0.771, obp: 0.674, doubles: 6, triples: 1 },
  { name: "Queen Elizabeth", image: "assets/images/queen elizabeth.jpg", class: "Balanced", avg: 0.348, gp: 12, hr: 1, pa: 46, hits: 16, slg: 0.435, obp: 0.348, doubles: 1, triples: 0 },
  ...
  { name: "Red Kritter", image: "assets/images/red kritter.png", class: "Power", avg: 0.5, gp: 42, hr: 22, pa: 164, hits: 82, slg: 0.975, obp: 0.499, doubles: 6, triples: 0 },
  { name: "Red Magikoopa", image: "assets/images/red magikoopa.png", class: "Balanced", avg: 0.464, gp: 41, hr: 2, pa: 153, hits: 71, slg: 0.551, obp: 0.469, doubles: 5, triples: 0 },
  ...
  { name: "Red Pianta", image: "assets/images/red pianta.png", class: "Speed", avg: 0.559, gp: 42, hr: 13, pa: 161, hits: 90, slg: 0.848, obp: 0.567, doubles: 5, triples: 0 },
  ...
  { name: "Rizzler", image: "assets/images/rizzler.jpg", class: "Balanced", avg: 0.457, gp: 21, hr: 1, pa: 81, hits: 37, slg: 0.531, obp: 0.457, doubles: 3, triples: 0 },
  { name: "Saddam Hussein", image: "assets/images/saddam hussein.jpg", class: "Balanced", avg: 0.398, gp: 22, hr: 4, pa: 88, hits: 35, slg: 0.637, obp: 0.398, doubles: 7, triples: 1 },
  { name: "Saka", image: "assets/images/saka.jpg", class: "Balanced", avg: 0.5, gp: 2, hr: 0, pa: 8, hits: 4, slg: 0.5, obp: 0.5, doubles: 0, triples: 0 },
  ...
  { name: "Tiny Kong", image: "assets/images/tiny kong.png", class: "Balanced", avg: 0.442, gp: 42, hr: 1, pa: 165, hits: 73, slg: 0.509, obp: 0.443, doubles: 6, triples: 1 },
  { name: "Toad", image: "assets/images/toad.jpg", class: "Balanced", avg: 0.632, gp: 34, hr: 2, pa: 136, hits: 86, slg: 0.712, obp: 0.638, doubles: 3, triples: 0 },
  { name: "Toadette", image: "assets/images/toadette.png", class: "Balanced", avg: 0.466, gp: 40, hr: 1, pa: 146, hits: 68, slg: 0.536, obp: 0.474, doubles: 4, triples: 1 },
  ...
  { name: "Unc", image: "assets/images/unc.jpg", class: "Balanced", avg: 0.5, gp: 42, hr: 9, pa: 158, hits: 79, slg: 0.705, obp: 0.507, doubles: 4, triples: 0 },
  { name: "Vicar", image: "assets/images/vicar.jpg", class: "Balanced", avg: 0.556, gp: 2, hr: 0, pa: 9, hits: 5, slg: 0.667, obp: 0.556, doubles: 1, triples: 0 },
  { name: "Waluigi", image: "assets/images/waluigi.png", class: "Technique", avg: 0.561, gp: 42, hr: 0, pa: 155, hits: 87, slg: 0.699, obp: 0.569, doubles: 20, triples: 0 },
  { name: "Wario", image: "assets/images/wario.png", class: "Technique", avg: 0.595, gp: 42, hr: 17, pa: 168, hits: 100, slg: 1.004, obp: 0.622, doubles: 5, triples: 0 },
  { name: "Wiggler", image: "assets/images/wiggler.png", class: "Speed", avg: 0.646, gp: 42, hr: 3, pa: 175, hits: 113, slg: 0.774, obp: 0.646, doubles: 10, triples: 1 },
  ...
  { name: "Yellow Magikoopa", image: "assets/images/yellow magikoopa.png", class: "Balanced", avg: 0.536, gp: 24, hr: 2, pa: 97, hits: 52, slg: 0.646, obp: 0.536, doubles: 2, triples: 1 },
  { name: "Yellow Pianta", image: "assets/images/yellow pianta.png", class: "Speed", avg: 0.577, gp: 42, hr: 12, pa: 168, hits: 97, slg: 0.817, obp: 0.581, doubles: 3, triples: 0 },
  { name: "Yellow Shy Guy", image: "assets/images/yellow shy guy.png", class: "Technique", avg: 0.385, gp: 27, hr: 2, pa: 91, hits: 35, slg: 0.5, obp: 0.385, doubles: 3, triples: 0 },
  { name: "Yellow Toad", image: "assets/images/yellow toad.png", class: "Speed", avg: 0.615, gp: 40, hr: 4, pa: 161, hits: 99, slg: 0.762, obp: 0.615, doubles: 8, triples: 1 },
  ...
  { name: "Yoshi", image: "assets/images/yoshi.png", class: "Speed", avg: 0.46, gp: 42, hr: 2, pa: 161, hits: 74, slg: 0.542, obp: 0.463, doubles: 6, triples: 0 },
...
if (characterGrid) {
  ...
  "Baby Peach": { ip: 15, era: 10.79, baa: 0.55, so: 0 },
  "Birdo": { ip: 101, era: 6.79, baa: 0.465, so: 17 },
  "Black Shy Guy": { ip: 1, era: 0.0, baa: 0.6, so: 0 },
  "Black Widow": { ip: 2, era: 10.5, baa: 0.6, so: 0 },
  "Blooper": { ip: 11, era: 9.04, baa: 0.478, so: 0 },
  ...
  "Bowser": { ip: 121, era: 6.03, baa: 0.464, so: 27 },
  "Bowser Jr": { ip: 72, era: 8.71, baa: 0.513, so: 5 },
  ...
  "Count Dooku": { ip: 8, era: 10.5, baa: 0.571, so: 1 },
  "Daisy": { ip: 120, era: 7.22, baa: 0.465, so: 2 },
  "Dark Bones": { ip: 39, era: 5.2, baa: 0.391, so: 0 },
  "Diddy Kong": { ip: 63, era: 9.11, baa: 0.506, so: 4 },
  "Diminutive": { ip: 4, era: 6.0, baa: 0.353, so: 0 },
  "Dixie Kong": { ip: 6, era: 7.0, baa: 0.424, so: 1 },
  "Donkey Kong": { ip: 135, era: 8.62, baa: 0.513, so: 4 },
  ...
  "Idi Amin": { ip: 6, era: 6.63, baa: 0.462, so: 0 },
  "John K": { ip: 5, era: 9.8, baa: 0.542, so: 0 },
  "KevinG": { ip: 52, era: 6.79, baa: 0.467, so: 2 },
  "King Boo": { ip: 44, era: 10.27, baa: 0.548, so: 0 },
  ...
  "Luigi": { ip: 142, era: 7.02, baa: 0.476, so: 12 },
  "MLK Jr": { ip: 4, era: 3.5, baa: 0.5, so: 0 },
  "Magikoopa": { ip: 51, era: 8.92, baa: 0.52, so: 1 },
  "Mario": { ip: 128, era: 7.2, baa: 0.487, so: 9 },
  ...
  "Peach": { ip: 121, era: 7.12, baa: 0.471, so: 4 },
  "Pianta": { ip: 34, era: 8.28, baa: 0.507, so: 1 },
  ...
  "Red Pianta": { ip: 9, era: 11.67, baa: 0.583, so: 0 },
  ...
  "Tiny Kong": { ip: 11, era: 5.3, baa: 0.423, so: 0 },
  ...
  "Waluigi": { ip: 56, era: 6.44, baa: 0.445, so: 3 },
  "Wario": { ip: 73, era: 9.75, baa: 0.514, so: 3 },
  "Wiggler": { ip: 3, era: 1.75, baa: 0.333, so: 0 },
  "Yellow Magikoopa": { ip: 33, era: 8.94, baa: 0.428, so: 1 },
  "Yellow Pianta": { ip: 14, era: 10.64, baa: 0.56, so: 0 },
  ...
  "Yoshi": { ip: 97, era: 6.88, baa: 0.472, so: 1 },
};
