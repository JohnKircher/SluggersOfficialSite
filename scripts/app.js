...
const characters = [
  { name: "Baby DK", image: "assets/images/baby dk.png", class: "Speed", avg: 0.495, gp: 24, hr: 3, pa: 93, hits: 46, slg: 0.661, obp: 0.505, doubles: 3, triples: 1 },
  { name: "Baby Daisy", image: "assets/images/baby daisy.png", class: "Power", avg: 0.421, gp: 16, hr: 0, pa: 57, hits: 24, slg: 0.491, obp: 0.414, doubles: 2, triples: 1 },
  ...
  { name: "Birdo", image: "assets/images/birdo.png", class: "Power", avg: 0.567, gp: 24, hr: 10, pa: 90, hits: 51, slg: 0.943, obp: 0.578, doubles: 3, triples: 0 },
  ...
  { name: "Blue Dry Bones", image: "assets/images/blue dry bones.png", class: "Balanced", avg: 0.626, gp: 24, hr: 5, pa: 91, hits: 57, slg: 0.889, obp: 0.623, doubles: 5, triples: 1 },
  { name: "Blue Kritter", image: "assets/images/blue kritter.png", class: "Power", avg: 0.46, gp: 24, hr: 7, pa: 87, hits: 40, slg: 0.672, obp: 0.432, doubles: 1, triples: 0 },
  { name: "Blue Shy Guy", image: "assets/images/blue shy guy.png", class: "Technique", avg: 0.167, gp: 8, hr: 0, pa: 24, hits: 4, slg: 0.167, obp: 0.167, doubles: 0, triples: 0 },
  { name: "Blue Toad", image: "assets/images/blue toad.png", class: "Speed", avg: 0.569, gp: 18, hr: 2, pa: 65, hits: 37, slg: 0.754, obp: 0.569, doubles: 6, triples: 0 },
  ...
  { name: "Boo", image: "assets/images/boo.png", class: "Speed", avg: 0.595, gp: 23, hr: 0, pa: 79, hits: 47, slg: 0.646, obp: 0.595, doubles: 4, triples: 0 },
  { name: "Boomerang Bro", image: "assets/images/boomerang bro.png", class: "Power", avg: 0.517, gp: 24, hr: 14, pa: 87, hits: 45, slg: 1.023, obp: 0.518, doubles: 2, triples: 0 },
  { name: "Borat", image: "assets/images/borat.jpg", class: "Balanced", avg: 0.421, gp: 24, hr: 0, pa: 95, hits: 40, slg: 0.463, obp: 0.421, doubles: 4, triples: 0 },
  { name: "Bowser Jr", image: "assets/images/bowser jr.png", class: "Technique", avg: 0.462, gp: 24, hr: 3, pa: 91, hits: 42, slg: 0.58, obp: 0.461, doubles: 1, triples: 0 },
  { name: "Bowser", image: "assets/images/bowser.png", class: "Power", avg: 0.545, gp: 24, hr: 25, pa: 101, hits: 55, slg: 1.364, obp: 0.545, doubles: 4, triples: 1 },
  { name: "Brown Kritter", image: "assets/images/brown kritter.png", class: "Power", avg: 0.459, gp: 24, hr: 11, pa: 85, hits: 39, slg: 0.933, obp: 0.471, doubles: 4, triples: 1 },
  ...
  { name: "Carby", image: "assets/images/carby.jpg", class: "Balanced", avg: 0.556, gp: 4, hr: 1, pa: 18, hits: 10, slg: 0.722, obp: 0.556, doubles: 0, triples: 0 },
  { name: "Chicken", image: "assets/images/chicken.jpg", class: "Balanced", avg: 0.431, gp: 20, hr: 0, pa: 72, hits: 31, slg: 0.444, obp: 0.43, doubles: 1, triples: 0 },
  ...
  { name: "Daisy", image: "assets/images/daisy.png", class: "Power", avg: 0.459, gp: 22, hr: 4, pa: 85, hits: 39, slg: 0.678, obp: 0.459, doubles: 6, triples: 0 },
  { name: "Dark Bones", image: "assets/images/dark bones.png", class: "Balanced", avg: 0.677, gp: 24, hr: 8, pa: 96, hits: 65, slg: 1.001, obp: 0.686, doubles: 7, triples: 0 },
  { name: "Diddy Kong", image: "assets/images/diddy kong.png", class: "Technique", avg: 0.489, gp: 24, hr: 1, pa: 94, hits: 46, slg: 0.601, obp: 0.489, doubles: 7, triples: 0 },
  { name: "Dixie Kong", image: "assets/images/dixie kong.png", class: "Balanced", avg: 0.568, gp: 12, hr: 1, pa: 44, hits: 25, slg: 0.682, obp: 0.568, doubles: 2, triples: 0 },
  { name: "Donkey Kong", image: "assets/images/donkey kong.png", class: "Power", avg: 0.634, gp: 24, hr: 21, pa: 93, hits: 59, slg: 1.356, obp: 0.635, doubles: 3, triples: 0 },
  { name: "Dry Bones", image: "assets/images/dry bones.png", class: "Balanced", avg: 0.629, gp: 24, hr: 10, pa: 89, hits: 56, slg: 1.055, obp: 0.629, doubles: 7, triples: 0 },
  { name: "Dwayne Wade", image: "assets/images/dwayne wade.jpg", class: "Balanced", avg: 0.468, gp: 24, hr: 1, pa: 77, hits: 36, slg: 0.506, obp: 0.467, doubles: 0, triples: 0 },
  ...
  { name: "Fire Bro", image: "assets/images/fire bro.png", class: "Power", avg: 0.574, gp: 24, hr: 27, pa: 94, hits: 54, slg: 1.452, obp: 0.574, doubles: 3, triples: 0 },
  { name: "Frozone", image: "assets/images/frozone.jpg", class: "Balanced", avg: 0.333, gp: 4, hr: 0, pa: 15, hits: 5, slg: 0.333, obp: 0.333, doubles: 0, triples: 0 },
  { name: "Funky Kong", image: "assets/images/funky kong.png", class: "Power", avg: 0.472, gp: 24, hr: 14, pa: 89, hits: 42, slg: 1.039, obp: 0.493, doubles: 0, triples: 2 },
  ...
  { name: "Green Dry Bones", image: "assets/images/green dry bones.png", class: "Balanced", avg: 0.522, gp: 24, hr: 9, pa: 90, hits: 47, slg: 0.856, obp: 0.522, doubles: 1, triples: 1 },
  { name: "Green Magikoopa", image: "assets/images/green magikoopa.png", class: "Balanced", avg: 0.575, gp: 24, hr: 2, pa: 80, hits: 46, slg: 0.675, obp: 0.575, doubles: 2, triples: 0 },
  ...
  { name: "Green Shy Guy", image: "assets/images/green shy guy.png", class: "Technique", avg: 0.342, gp: 22, hr: 0, pa: 73, hits: 25, slg: 0.359, obp: 0.326, doubles: 1, triples: 1 },
  { name: "Green Toad", image: "assets/images/green toad.png", class: "Speed", avg: 0.644, gp: 24, hr: 2, pa: 87, hits: 56, slg: 0.88, obp: 0.652, doubles: 8, triples: 2 },
  { name: "Hammer Bro", image: "assets/images/hammer bro.png", class: "Power", avg: 0.529, gp: 24, hr: 19, pa: 87, hits: 46, slg: 1.167, obp: 0.512, doubles: 1, triples: 0 },
  ...
  { name: "KevinG", image: "assets/images/keving.jpg", class: "Balanced", avg: 0.111, gp: 5, hr: 2, pa: 18, hits: 2, slg: 0.476, obp: 0.111, doubles: 0, triples: 0 },
  { name: "King Boo", image: "assets/images/king boo.png", class: "Power", avg: 0.5, gp: 24, hr: 15, pa: 86, hits: 43, slg: 1.061, obp: 0.481, doubles: 2, triples: 0 },
  { name: "King K Rool", image: "assets/images/king k rool.png", class: "Power", avg: 0.577, gp: 24, hr: 23, pa: 97, hits: 56, slg: 1.358, obp: 0.577, doubles: 4, triples: 0 },
  { name: "Koopa Paratroopa", image: "assets/images/koopa paratroopa.png", class: "Balanced", avg: 0.347, gp: 20, hr: 1, pa: 75, hits: 26, slg: 0.413, obp: 0.347, doubles: 2, triples: 0 },
  ...
  { name: "Kritter", image: "assets/images/kritter.png", class: "Power", avg: 0.586, gp: 24, hr: 17, pa: 99, hits: 58, slg: 1.232, obp: 0.586, doubles: 11, triples: 1 },
  { name: "Lara Croft", image: "assets/images/lara croft.jpg", class: "Balanced", avg: 0.383, gp: 14, hr: 0, pa: 47, hits: 18, slg: 0.383, obp: 0.383, doubles: 0, triples: 0 },
  { name: "Lebron James", image: "assets/images/lebron james.jpg", class: "Balanced", avg: 0.133, gp: 4, hr: 0, pa: 15, hits: 2, slg: 0.143, obp: 0.143, doubles: 0, triples: 0 },
  ...
  { name: "Lilo", image: "assets/images/lilo.jpg", class: "Balanced", avg: 0.435, gp: 14, hr: 1, pa: 46, hits: 20, slg: 0.565, obp: 0.435, doubles: 1, triples: 1 },
  { name: "Livvy Dunne", image: "assets/images/livvy dunne.jpg", class: "Balanced", avg: 0.438, gp: 4, hr: 0, pa: 16, hits: 7, slg: 0.438, obp: 0.438, doubles: 0, triples: 0 },
  ...
  { name: "Luigi", image: "assets/images/luigi.png", class: "Speed", avg: 0.483, gp: 24, hr: 0, pa: 89, hits: 43, slg: 0.517, obp: 0.484, doubles: 1, triples: 1 },
  ...
  { name: "Magikoopa", image: "assets/images/magikoopa.png", class: "Balanced", avg: 0.5, gp: 24, hr: 2, pa: 80, hits: 40, slg: 0.6, obp: 0.5, doubles: 2, triples: 0 },
  { name: "Mario", image: "assets/images/mario.png", class: "Balanced", avg: 0.575, gp: 24, hr: 3, pa: 87, hits: 50, slg: 0.732, obp: 0.576, doubles: 2, triples: 1 },
  ...
  { name: "Mikasa", image: "assets/images/mikasa.jpg", class: "Balanced", avg: 0.345, gp: 14, hr: 0, pa: 55, hits: 19, slg: 0.362, obp: 0.351, doubles: 1, triples: 0 },
  { name: "Minion", image: "assets/images/minion.jpg", class: "Balanced", avg: 0.403, gp: 22, hr: 0, pa: 77, hits: 31, slg: 0.429, obp: 0.403, doubles: 2, triples: 0 },
  ...
  { name: "Miss Hot", image: "assets/images/miss hot.jpg", class: "Balanced", avg: 0.494, gp: 24, hr: 2, pa: 83, hits: 41, slg: 0.636, obp: 0.494, doubles: 5, triples: 0 },
  { name: "Monty Mole", image: "assets/images/monty mole.png", class: "Speed", avg: 0.571, gp: 4, hr: 1, pa: 14, hits: 8, slg: 0.786, obp: 0.571, doubles: 0, triples: 0 },
  { name: "Mr. Incredible", image: "assets/images/mr incredible.jpg", class: "Balanced", avg: 0.417, gp: 24, hr: 0, pa: 84, hits: 35, slg: 0.467, obp: 0.429, doubles: 3, triples: 0 },
  ...
  { name: "Peach", image: "assets/images/peach.png", class: "Balanced", avg: 0.388, gp: 24, hr: 0, pa: 85, hits: 33, slg: 0.425, obp: 0.365, doubles: 5, triples: 0 },
  { name: "Petey Piranha", image: "assets/images/petey piranha.png", class: "Power", avg: 0.467, gp: 24, hr: 21, pa: 92, hits: 43, slg: 1.163, obp: 0.467, doubles: 1, triples: 0 },
  { name: "Pianta", image: "assets/images/pianta.png", class: "Speed", avg: 0.644, gp: 24, hr: 5, pa: 87, hits: 56, slg: 0.78, obp: 0.62, doubles: 0, triples: 0 },
  { name: "Pink Yoshi", image: "assets/images/pink yoshi.png", class: "Speed", avg: 0.549, gp: 15, hr: 0, pa: 51, hits: 28, slg: 0.66, obp: 0.608, doubles: 3, triples: 0 },
  { name: "Purple Toad", image: "assets/images/purple toad.png", class: "Speed", avg: 0.684, gp: 6, hr: 0, pa: 19, hits: 13, slg: 0.89, obp: 0.684, doubles: 3, triples: 0 },
  ...
  { name: "Red Koopa Troopa", image: "assets/images/red koopa troopa.png", class: "Speed", avg: 0.389, gp: 10, hr: 1, pa: 36, hits: 14, slg: 0.5, obp: 0.389, doubles: 1, triples: 0 },
  { name: "Red Kritter", image: "assets/images/red kritter.png", class: "Power", avg: 0.462, gp: 24, hr: 9, pa: 91, hits: 42, slg: 0.817, obp: 0.46, doubles: 3, triples: 0 },
  { name: "Red Magikoopa", image: "assets/images/red magikoopa.png", class: "Balanced", avg: 0.446, gp: 23, hr: 1, pa: 83, hits: 37, slg: 0.5, obp: 0.451, doubles: 1, triples: 0 },
  ...
  { name: "Red Pianta", image: "assets/images/red pianta.png", class: "Speed", avg: 0.573, gp: 24, hr: 4, pa: 89, hits: 51, slg: 0.773, obp: 0.587, doubles: 4, triples: 0 },
  { name: "Red Yoshi", image: "assets/images/red yoshi.png", class: "Speed", avg: 0.361, gp: 17, hr: 1, pa: 61, hits: 22, slg: 0.41, obp: 0.361, doubles: 0, triples: 0 },
  { name: "Rizzler", image: "assets/images/rizzler.jpg", class: "Balanced", avg: 0.467, gp: 4, hr: 1, pa: 15, hits: 7, slg: 0.667, obp: 0.467, doubles: 0, triples: 0 },
  { name: "Saddam Hussein", image: "assets/images/saddam hussein.jpg", class: "Balanced", avg: 0.471, gp: 4, hr: 1, pa: 17, hits: 8, slg: 0.706, obp: 0.471, doubles: 1, triples: 0 },
  ...
  { name: "Tiny Kong", image: "assets/images/tiny kong.png", class: "Balanced", avg: 0.447, gp: 24, hr: 1, pa: 94, hits: 42, slg: 0.521, obp: 0.447, doubles: 2, triples: 1 },
  { name: "Toad", image: "assets/images/toad.jpg", class: "Balanced", avg: 0.661, gp: 16, hr: 0, pa: 59, hits: 39, slg: 0.678, obp: 0.661, doubles: 1, triples: 0 },
  { name: "Toadette", image: "assets/images/toadette.png", class: "Balanced", avg: 0.365, gp: 22, hr: 0, pa: 74, hits: 27, slg: 0.419, obp: 0.365, doubles: 2, triples: 1 },
  ...
  { name: "Trinity", image: "assets/images/trinity.jpg", class: "Balanced", avg: 0.383, gp: 14, hr: 1, pa: 47, hits: 18, slg: 0.468, obp: 0.383, doubles: 1, triples: 0 },
  ...
  { name: "Unc", image: "assets/images/unc.jpg", class: "Balanced", avg: 0.511, gp: 24, hr: 4, pa: 90, hits: 46, slg: 0.671, obp: 0.523, doubles: 1, triples: 0 },
  { name: "Waluigi", image: "assets/images/waluigi.png", class: "Technique", avg: 0.553, gp: 24, hr: 0, pa: 85, hits: 47, slg: 0.677, obp: 0.559, doubles: 10, triples: 0 },
  { name: "Wario", image: "assets/images/wario.png", class: "Technique", avg: 0.594, gp: 24, hr: 6, pa: 96, hits: 57, slg: 0.925, obp: 0.64, doubles: 1, triples: 0 },
  { name: "Wiggler", image: "assets/images/wiggler.png", class: "Speed", avg: 0.684, gp: 24, hr: 1, pa: 98, hits: 67, slg: 0.815, obp: 0.684, doubles: 7, triples: 1 },
  ...
  { name: "Yellow Pianta", image: "assets/images/yellow pianta.png", class: "Speed", avg: 0.585, gp: 24, hr: 1, pa: 94, hits: 55, slg: 0.651, obp: 0.592, doubles: 2, triples: 0 },
  { name: "Yellow Shy Guy", image: "assets/images/yellow shy guy.png", class: "Technique", avg: 0.314, gp: 10, hr: 0, pa: 35, hits: 11, slg: 0.314, obp: 0.314, doubles: 0, triples: 0 },
  { name: "Yellow Toad", image: "assets/images/yellow toad.png", class: "Speed", avg: 0.591, gp: 22, hr: 2, pa: 88, hits: 52, slg: 0.736, obp: 0.591, doubles: 4, triples: 1 },
  { name: "Yellow Yoshi", image: "assets/images/yellow yoshi.png", class: "Speed", avg: 0.438, gp: 4, hr: 0, pa: 16, hits: 7, slg: 0.438, obp: 0.438, doubles: 0, triples: 0 },
  ...
  { name: "Yoshi", image: "assets/images/yoshi.png", class: "Speed", avg: 0.366, gp: 24, hr: 2, pa: 93, hits: 34, slg: 0.458, obp: 0.371, doubles: 2, triples: 0 },
...
if (characterGrid) {
  ...
  const pitchingStats = {
    ...
    "Birdo": { ip: 60, era: 3.96, baa: 0.423, so: 10 },
    ...
    "Boo": { ip: 81, era: 5.93, baa: 0.489, so: 3 },
    "Boomerang Bro": { ip: 2, era: 3.0, baa: 0.583, so: 0 },
    "Bowser": { ip: 63, era: 5.33, baa: 0.472, so: 17 },
    "Bowser Jr": { ip: 49, era: 8.33, baa: 0.5, so: 4 },
    ...
    "Daisy": { ip: 70, era: 7.27, baa: 0.465, so: 0 },
    "Dark Bones": { ip: 16, era: 3.85, baa: 0.355, so: 0 },
    "Diddy Kong": { ip: 52, era: 7.35, baa: 0.493, so: 2 },
    "Dixie Kong": { ip: 3, era: 0.0, baa: 0.286, so: 1 },
    "Donkey Kong": { ip: 80, era: 6.77, baa: 0.486, so: 3 },
    ...
    "Green Magikoopa": { ip: 12, era: 11.73, baa: 0.545, so: 0 },
    "Hammer Bro": { ip: 2, era: 17.5, baa: 0.639, so: 0 },
    "John K": { ip: 5, era: 9.8, baa: 0.542, so: 0 },
    "King Boo": { ip: 22, era: 6.44, baa: 0.52, so: 0 },
    ...
    "Luigi": { ip: 94, era: 6.88, baa: 0.48, so: 6 },
    "Magikoopa": { ip: 27, era: 9.21, baa: 0.511, so: 0 },
    "Mario": { ip: 88, era: 6.13, baa: 0.468, so: 5 },
    ...
    "Monty Mole": { ip: 14, era: 4.3, baa: 0.46, so: 0 },
    "Mr. Incredible": { ip: 24, era: 4.26, baa: 0.465, so: 0 },
    "Mrs.Claus": { ip: 4, era: 3.23, baa: 0.313, so: 0 },
    "Paragoomba": { ip: 27, era: 5.84, baa: 0.422, so: 0 },
    "Peach": { ip: 79, era: 6.43, baa: 0.458, so: 1 },
    ...
    "Trinity": { ip: 53, era: 4.47, baa: 0.453, so: 2 },
    "Unc": { ip: 6, era: 5.25, baa: 0.568, so: 0 },
    "Waluigi": { ip: 44, era: 4.57, baa: 0.441, so: 2 },
    "Wario": { ip: 36, era: 8.44, baa: 0.5, so: 1 },
    ...
    "Yellow Yoshi": { ip: 4, era: 12.25, baa: 0.591, so: 0 },
    "Yoshi": { ip: 50, era: 6.53, baa: 0.463, so: 1 },
  };
