...
const characters = [
  { name: "Baby DK", image: "assets/images/baby dk.png", class: "Speed", avg: 0.494, gp: 41, hr: 5, pa: 160, hits: 79, slg: 0.641, obp: 0.5, doubles: 5, triples: 1 },
  ...
  { name: "Baby Luigi", image: "assets/images/baby luigi.png", class: "Speed", avg: 0.4, gp: 11, hr: 0, pa: 40, hits: 16, slg: 0.5, obp: 0.4, doubles: 0, triples: 2 },
  ...
  { name: "Baby Peach", image: "assets/images/baby peach.png", class: "Balanced", avg: 0.308, gp: 19, hr: 0, pa: 65, hits: 20, slg: 0.354, obp: 0.308, doubles: 3, triples: 0 },
  { name: "Birdo", image: "assets/images/birdo.png", class: "Power", avg: 0.565, gp: 41, hr: 20, pa: 161, hits: 91, slg: 0.981, obp: 0.571, doubles: 6, triples: 0 },
  ...
  { name: "Blooper", image: "assets/images/blooper.png", class: "Balanced", avg: 0.561, gp: 29, hr: 0, pa: 107, hits: 60, slg: 0.636, obp: 0.565, doubles: 5, triples: 1 },
  { name: "Blue Dry Bones", image: "assets/images/blue dry bones.png", class: "Balanced", avg: 0.613, gp: 41, hr: 8, pa: 160, hits: 98, slg: 0.867, obp: 0.615, doubles: 9, triples: 2 },
  { name: "Blue Kritter", image: "assets/images/blue kritter.png", class: "Power", avg: 0.531, gp: 41, hr: 15, pa: 162, hits: 86, slg: 0.829, obp: 0.516, doubles: 6, triples: 0 },
  { name: "Blue Shy Guy", image: "assets/images/blue shy guy.png", class: "Technique", avg: 0.341, gp: 25, hr: 0, pa: 82, hits: 28, slg: 0.37, obp: 0.342, doubles: 2, triples: 0 },
  { name: "Blue Toad", image: "assets/images/blue toad.png", class: "Speed", avg: 0.578, gp: 35, hr: 4, pa: 135, hits: 78, slg: 0.719, obp: 0.578, doubles: 7, triples: 0 },
  { name: "Blue Yoshi", image: "assets/images/blue yoshi.png", class: "Speed", avg: 0.625, gp: 2, hr: 0, pa: 8, hits: 5, slg: 0.625, obp: 0.625, doubles: 0, triples: 0 },
  ...
  { name: "Boomerang Bro", image: "assets/images/boomerang bro.png", class: "Power", avg: 0.494, gp: 41, hr: 22, pa: 154, hits: 76, slg: 0.961, obp: 0.5, doubles: 3, triples: 1 },
  ...
  { name: "Bowler", image: "assets/images/bowler.jpg", class: "Balanced", avg: 0.75, gp: 1, hr: 1, pa: 4, hits: 3, slg: 1.5, obp: 0.75, doubles: 0, triples: 0 },
  { name: "Bowser Jr", image: "assets/images/bowser jr.png", class: "Technique", avg: 0.463, gp: 41, hr: 3, pa: 160, hits: 74, slg: 0.586, obp: 0.462, doubles: 10, triples: 0 },
  { name: "Bowser", image: "assets/images/bowser.png", class: "Power", avg: 0.584, gp: 41, hr: 43, pa: 173, hits: 101, slg: 1.449, obp: 0.584, doubles: 13, triples: 3 },
  { name: "Brown Kritter", image: "assets/images/brown kritter.png", class: "Power", avg: 0.49, gp: 41, hr: 25, pa: 153, hits: 75, slg: 1.081, obp: 0.497, doubles: 9, triples: 1 },
  ...
  { name: "Carby", image: "assets/images/carby.jpg", class: "Balanced", avg: 0.518, gp: 21, hr: 3, pa: 85, hits: 44, slg: 0.704, obp: 0.518, doubles: 4, triples: 1 },
  ...
  { name: "Count Dooku", image: "assets/images/count dooku.jpg", class: "Balanced", avg: 0.2, gp: 1, hr: 0, pa: 5, hits: 1, slg: 0.6, obp: 0.2, doubles: 0, triples: 1 },
  { name: "Daisy", image: "assets/images/daisy.png", class: "Power", avg: 0.477, gp: 39, hr: 7, pa: 153, hits: 73, slg: 0.713, obp: 0.477, doubles: 11, triples: 1 },
  { name: "Dark Bones", image: "assets/images/dark bones.png", class: "Balanced", avg: 0.677, gp: 41, hr: 14, pa: 167, hits: 113, slg: 1.013, obp: 0.682, doubles: 14, triples: 0 },
  { name: "Diddy Kong", image: "assets/images/diddy kong.png", class: "Technique", avg: 0.481, gp: 41, hr: 1, pa: 158, hits: 76, slg: 0.554, obp: 0.481, doubles: 8, triples: 0 },
  { name: "Diminutive", image: "assets/images/diminutive.jpg", class: "Balanced", avg: 0.432, gp: 11, hr: 1, pa: 44, hits: 19, slg: 0.613, obp: 0.431, doubles: 3, triples: 1 },
  ...
  { name: "Donkey Kong", image: "assets/images/donkey kong.png", class: "Power", avg: 0.594, gp: 41, hr: 41, pa: 160, hits: 95, slg: 1.402, obp: 0.594, doubles: 5, triples: 0 },
  { name: "Dry Bones", image: "assets/images/dry bones.png", class: "Balanced", avg: 0.647, gp: 41, hr: 13, pa: 156, hits: 101, slg: 1.04, obp: 0.648, doubles: 14, triples: 3 },
  { name: "Dwayne Wade", image: "assets/images/dwayne wade.jpg", class: "Balanced", avg: 0.458, gp: 41, hr: 2, pa: 144, hits: 66, slg: 0.5, obp: 0.458, doubles: 0, triples: 0 },
  ...
  { name: "Fire Bro", image: "assets/images/fire bro.png", class: "Power", avg: 0.58, gp: 41, hr: 43, pa: 169, hits: 98, slg: 1.4, obp: 0.579, doubles: 5, triples: 1 },
  ...
  { name: "Funky Kong", image: "assets/images/funky kong.png", class: "Power", avg: 0.431, gp: 41, hr: 23, pa: 160, hits: 69, slg: 0.928, obp: 0.443, doubles: 2, triples: 2 },
  { name: "Gandalf", image: "assets/images/gandalf.jpg", class: "Balanced", avg: 0.316, gp: 11, hr: 1, pa: 38, hits: 12, slg: 0.395, obp: 0.316, doubles: 0, triples: 0 },
  { name: "Ghandi", image: "assets/images/ghandi.jpg", class: "Balanced", avg: 0.282, gp: 11, hr: 0, pa: 39, hits: 11, slg: 0.308, obp: 0.282, doubles: 1, triples: 0 },
  { name: "Green Dry Bones", image: "assets/images/green dry bones.png", class: "Balanced", avg: 0.52, gp: 41, hr: 14, pa: 171, hits: 89, slg: 0.801, obp: 0.521, doubles: 4, triples: 1 },
  { name: "Green Magikoopa", image: "assets/images/green magikoopa.png", class: "Balanced", avg: 0.517, gp: 41, hr: 2, pa: 151, hits: 78, slg: 0.596, obp: 0.517, doubles: 6, triples: 0 },
  ...
  { name: "Green Toad", image: "assets/images/green toad.png", class: "Speed", avg: 0.638, gp: 41, hr: 2, pa: 163, hits: 104, slg: 0.807, obp: 0.643, doubles: 11, triples: 4 },
  { name: "Gus Fring", image: "assets/images/gus fring.jpg", class: "Balanced", avg: 0.5, gp: 1, hr: 0, pa: 4, hits: 2, slg: 0.75, obp: 0.5, doubles: 1, triples: 0 },
  { name: "Hammer Bro", image: "assets/images/hammer bro.png", class: "Power", avg: 0.538, gp: 41, hr: 36, pa: 158, hits: 85, slg: 1.245, obp: 0.529, doubles: 5, triples: 0 },
  ...
  { name: "Idi Amin", image: "assets/images/idi amin.jpg", class: "Balanced", avg: 0.0, gp: 1, hr: 0, pa: 3, hits: 0, slg: 0.0, obp: 0.0, doubles: 0, triples: 0 },
  ...
  { name: "KevinG", image: "assets/images/keving.jpg", class: "Balanced", avg: 0.376, gp: 21, hr: 3, pa: 85, hits: 32, slg: 0.536, obp: 0.377, doubles: 4, triples: 0 },
  { name: "Kim Jong Un", image: "assets/images/kim jong un.jpg", class: "Balanced", avg: 0.532, gp: 11, hr: 4, pa: 47, hits: 25, slg: 0.787, obp: 0.532, doubles: 0, triples: 0 },
  { name: "King Boo", image: "assets/images/king boo.png", class: "Power", avg: 0.564, gp: 41, hr: 28, pa: 163, hits: 92, slg: 1.106, obp: 0.554, doubles: 3, triples: 0 },
  { name: "King K Rool", image: "assets/images/king k rool.png", class: "Power", avg: 0.624, gp: 41, hr: 50, pa: 170, hits: 106, slg: 1.557, obp: 0.623, doubles: 6, triples: 0 },
  { name: "Koopa Paratroopa", image: "assets/images/koopa paratroopa.png", class: "Balanced", avg: 0.324, gp: 27, hr: 1, pa: 102, hits: 33, slg: 0.376, obp: 0.327, doubles: 2, triples: 0 },
  ...
  { name: "Kritter", image: "assets/images/kritter.png", class: "Power", avg: 0.575, gp: 41, hr: 28, pa: 174, hits: 100, slg: 1.167, obp: 0.575, doubles: 15, triples: 2 },
  ...
  { name: "Lebron James", image: "assets/images/lebron james.jpg", class: "Balanced", avg: 0.402, gp: 21, hr: 6, pa: 82, hits: 33, slg: 0.663, obp: 0.406, doubles: 3, triples: 0 },
  ...
  { name: "Luigi", image: "assets/images/luigi.png", class: "Speed", avg: 0.487, gp: 41, hr: 1, pa: 158, hits: 77, slg: 0.535, obp: 0.491, doubles: 2, triples: 1 },
  ...
  { name: "MLK Jr", image: "assets/images/mlk jr.jpg", class: "Balanced", avg: 0.283, gp: 11, hr: 1, pa: 46, hits: 13, slg: 0.37, obp: 0.283, doubles: 1, triples: 0 },
  { name: "Magikoopa", image: "assets/images/magikoopa.png", class: "Balanced", avg: 0.529, gp: 41, hr: 4, pa: 140, hits: 74, slg: 0.657, obp: 0.528, doubles: 4, triples: 1 },
  { name: "Mario", image: "assets/images/mario.png", class: "Balanced", avg: 0.5, gp: 41, hr: 4, pa: 156, hits: 78, slg: 0.613, obp: 0.501, doubles: 3, triples: 1 },
  ...
  { name: "Minion", image: "assets/images/minion.jpg", class: "Balanced", avg: 0.412, gp: 29, hr: 0, pa: 102, hits: 42, slg: 0.451, obp: 0.412, doubles: 2, triples: 1 },
  ...
  { name: "Miss Hot", image: "assets/images/miss hot.jpg", class: "Balanced", avg: 0.47, gp: 41, hr: 3, pa: 149, hits: 70, slg: 0.582, obp: 0.47, doubles: 7, triples: 0 },
  ...
  { name: "Mrs.Claus", image: "assets/images/mrs claus.jpg", class: "Balanced", avg: 0.413, gp: 20, hr: 2, pa: 75, hits: 31, slg: 0.533, obp: 0.413, doubles: 3, triples: 0 },
  ...
  { name: "Peach", image: "assets/images/peach.png", class: "Balanced", avg: 0.432, gp: 41, hr: 0, pa: 162, hits: 70, slg: 0.464, obp: 0.42, doubles: 5, triples: 1 },
  { name: "Petey Piranha", image: "assets/images/petey piranha.png", class: "Power", avg: 0.588, gp: 41, hr: 50, pa: 165, hits: 97, slg: 1.515, obp: 0.588, doubles: 3, triples: 0 },
  { name: "Pianta", image: "assets/images/pianta.png", class: "Speed", avg: 0.613, gp: 41, hr: 23, pa: 155, hits: 95, slg: 1.051, obp: 0.6, doubles: 2, triples: 0 },
  ...
  { name: "Purple Toad", image: "assets/images/purple toad.png", class: "Speed", avg: 0.667, gp: 23, hr: 0, pa: 84, hits: 56, slg: 0.769, obp: 0.667, doubles: 6, triples: 1 },
  { name: "Queen Elizabeth", image: "assets/images/queen elizabeth.jpg", class: "Balanced", avg: 0.333, gp: 11, hr: 0, pa: 42, hits: 14, slg: 0.357, obp: 0.334, doubles: 1, triples: 0 },
  ...
  { name: "Red Kritter", image: "assets/images/red kritter.png", class: "Power", avg: 0.5, gp: 41, hr: 21, pa: 160, hits: 80, slg: 0.954, obp: 0.499, doubles: 6, triples: 0 },
  { name: "Red Magikoopa", image: "assets/images/red magikoopa.png", class: "Balanced", avg: 0.463, gp: 40, hr: 2, pa: 149, hits: 69, slg: 0.552, obp: 0.469, doubles: 5, triples: 0 },
  ...
  { name: "Red Pianta", image: "assets/images/red pianta.png", class: "Speed", avg: 0.567, gp: 41, hr: 12, pa: 157, hits: 89, slg: 0.839, obp: 0.575, doubles: 5, triples: 0 },
  ...
  { name: "Rizzler", image: "assets/images/rizzler.jpg", class: "Balanced", avg: 0.434, gp: 20, hr: 1, pa: 76, hits: 33, slg: 0.5, obp: 0.434, doubles: 2, triples: 0 },
  { name: "Saddam Hussein", image: "assets/images/saddam hussein.jpg", class: "Balanced", avg: 0.381, gp: 21, hr: 4, pa: 84, hits: 32, slg: 0.631, obp: 0.381, doubles: 7, triples: 1 },
  { name: "Saka", image: "assets/images/saka.jpg", class: "Balanced", avg: 0.25, gp: 1, hr: 0, pa: 4, hits: 1, slg: 0.25, obp: 0.25, doubles: 0, triples: 0 },
  ...
  { name: "Tiny Kong", image: "assets/images/tiny kong.png", class: "Balanced", avg: 0.441, gp: 41, hr: 1, pa: 161, hits: 71, slg: 0.497, obp: 0.441, doubles: 4, triples: 1 },
  { name: "Toad", image: "assets/images/toad.jpg", class: "Balanced", avg: 0.618, gp: 33, hr: 2, pa: 131, hits: 81, slg: 0.701, obp: 0.624, doubles: 3, triples: 0 },
  { name: "Toadette", image: "assets/images/toadette.png", class: "Balanced", avg: 0.454, gp: 39, hr: 1, pa: 141, hits: 64, slg: 0.52, obp: 0.462, doubles: 3, triples: 1 },
  ...
  { name: "Unc", image: "assets/images/unc.jpg", class: "Balanced", avg: 0.5, gp: 41, hr: 9, pa: 154, hits: 77, slg: 0.71, obp: 0.507, doubles: 4, triples: 0 },
  { name: "Vicar", image: "assets/images/vicar.jpg", class: "Balanced", avg: 0.5, gp: 1, hr: 0, pa: 4, hits: 2, slg: 0.5, obp: 0.5, doubles: 0, triples: 0 },
  { name: "Waluigi", image: "assets/images/waluigi.png", class: "Technique", avg: 0.563, gp: 41, hr: 0, pa: 151, hits: 85, slg: 0.705, obp: 0.571, doubles: 20, triples: 0 },
  { name: "Wario", image: "assets/images/wario.png", class: "Technique", avg: 0.595, gp: 41, hr: 17, pa: 163, hits: 97, slg: 1.016, obp: 0.622, doubles: 5, triples: 0 },
  { name: "Wiggler", image: "assets/images/wiggler.png", class: "Speed", avg: 0.643, gp: 41, hr: 3, pa: 171, hits: 110, slg: 0.775, obp: 0.643, doubles: 10, triples: 1 },
  ...
  { name: "Yellow Magikoopa", image: "assets/images/yellow magikoopa.png", class: "Balanced", avg: 0.533, gp: 23, hr: 2, pa: 92, hits: 49, slg: 0.649, obp: 0.533, doubles: 2, triples: 1 },
  { name: "Yellow Pianta", image: "assets/images/yellow pianta.png", class: "Speed", avg: 0.585, gp: 41, hr: 12, pa: 164, hits: 96, slg: 0.831, obp: 0.589, doubles: 3, triples: 0 },
  { name: "Yellow Shy Guy", image: "assets/images/yellow shy guy.png", class: "Technique", avg: 0.379, gp: 26, hr: 1, pa: 87, hits: 33, slg: 0.456, obp: 0.379, doubles: 3, triples: 0 },
  { name: "Yellow Toad", image: "assets/images/yellow toad.png", class: "Speed", avg: 0.611, gp: 39, hr: 4, pa: 157, hits: 96, slg: 0.762, obp: 0.612, doubles: 8, triples: 1 },
  ...
  { name: "Yoshi", image: "assets/images/yoshi.png", class: "Speed", avg: 0.449, gp: 41, hr: 2, pa: 156, hits: 70, slg: 0.534, obp: 0.452, doubles: 6, triples: 0 },
  ...
  { name: "Doc Brown", image: "assets/images/doc brown.jpg", class: "Balanced", avg: 0.0, gp: 0, hr: 0, pa: 0, hits: 0, slg: 0.0, obp: 0.0, doubles: 0, triples: 0 },
...
if (characterGrid) {
  ...
  "Baby Peach": { ip: 12, era: 10.87, baa: 0.57, so: 0 },
  "Birdo": { ip: 98, era: 6.49, baa: 0.457, so: 16 },
  "Black Shy Guy": { ip: 1, era: 0.0, baa: 0.6, so: 0 },
  "Black Widow": { ip: 2, era: 10.5, baa: 0.6, so: 0 },
  "Blooper": { ip: 7, era: 10.2, baa: 0.498, so: 0 },
  ...
  "Bowser": { ip: 120, era: 6.08, baa: 0.466, so: 26 },
  "Bowser Jr": { ip: 71, era: 8.23, baa: 0.51, so: 5 },
  ...
  "King Boo": { ip: 43, era: 10.24, baa: 0.548, so: 0 },
  ...
  "Luigi": { ip: 141, era: 6.96, baa: 0.475, so: 12 },
  "MLK Jr": { ip: 3, era: 4.2, baa: 0.5, so: 0 },
  "Magikoopa": { ip: 51, era: 8.92, baa: 0.52, so: 1 },
  "Mario": { ip: 125, era: 7.37, baa: 0.488, so: 9 },
  ...
  "Peach": { ip: 120, era: 6.65, baa: 0.468, so: 4 },
  "Pianta": { ip: 33, era: 7.74, baa: 0.498, so: 1 },
  "Pink Yoshi": { ip: 1, era: 21.0, baa: 0.778, so: 0 },
  "Red Kritter": { ip: 7, era: 8.25, baa: 0.501, so: 0 },
  "Red Magikoopa": { ip: 48, era: 8.51, baa: 0.502, so: 0 },
  "Red Pianta": { ip: 7, era: 11.0, baa: 0.581, so: 0 },
  ...
  "Waluigi": { ip: 55, era: 6.43, baa: 0.445, so: 2 },
  "Wario": { ip: 69, era: 9.61, baa: 0.512, so: 3 },
  "Wiggler": { ip: 3, era: 1.75, baa: 0.333, so: 0 },
  "Yellow Magikoopa": { ip: 33, era: 8.94, baa: 0.428, so: 1 },
  "Yellow Pianta": { ip: 11, era: 11.18, baa: 0.563, so: 0 },
  ...
  "Yoshi": { ip: 95, era: 6.58, baa: 0.469, so: 1 },
};
