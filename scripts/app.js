...
const characters = [
  { name: "Baby DK", image: "assets/images/baby dk.png", class: "Speed", avg: 0.511, gp: 46, hr: 6, pa: 176, hits: 90, slg: 0.673, obp: 0.517, doubles: 7, triples: 1 },
  ...
  { name: "Baby Luigi", image: "assets/images/baby luigi.png", class: "Speed", avg: 0.466, gp: 16, hr: 0, pa: 58, hits: 27, slg: 0.586, obp: 0.465, doubles: 1, triples: 3 },
  ...
  { name: "Baby Peach", image: "assets/images/baby peach.png", class: "Balanced", avg: 0.309, gp: 24, hr: 0, pa: 81, hits: 25, slg: 0.395, obp: 0.309, doubles: 5, triples: 1 },
  { name: "Birdo", image: "assets/images/birdo.png", class: "Power", avg: 0.571, gp: 46, hr: 27, pa: 182, hits: 104, slg: 1.054, obp: 0.577, doubles: 6, triples: 0 },
  ...
  { name: "Blooper", image: "assets/images/blooper.png", class: "Balanced", avg: 0.57, gp: 34, hr: 0, pa: 128, hits: 73, slg: 0.655, obp: 0.574, doubles: 7, triples: 1 },
  { name: "Blue Dry Bones", image: "assets/images/blue dry bones.png", class: "Balanced", avg: 0.615, gp: 46, hr: 9, pa: 182, hits: 112, slg: 0.856, obp: 0.617, doubles: 9, triples: 2 },
  { name: "Blue Kritter", image: "assets/images/blue kritter.png", class: "Power", avg: 0.531, gp: 46, hr: 15, pa: 179, hits: 95, slg: 0.818, obp: 0.517, doubles: 7, triples: 1 },
  { name: "Blue Shy Guy", image: "assets/images/blue shy guy.png", class: "Technique", avg: 0.354, gp: 30, hr: 0, pa: 99, hits: 35, slg: 0.377, obp: 0.354, doubles: 2, triples: 0 },
  { name: "Blue Toad", image: "assets/images/blue toad.png", class: "Speed", avg: 0.587, gp: 40, hr: 4, pa: 155, hits: 91, slg: 0.71, obp: 0.587, doubles: 7, triples: 0 },
  { name: "Blue Yoshi", image: "assets/images/blue yoshi.png", class: "Speed", avg: 0.643, gp: 7, hr: 0, pa: 28, hits: 18, slg: 0.643, obp: 0.643, doubles: 0, triples: 0 },
  ...
  { name: "Boomerang Bro", image: "assets/images/boomerang bro.png", class: "Power", avg: 0.5, gp: 46, hr: 25, pa: 176, hits: 88, slg: 0.96, obp: 0.506, doubles: 3, triples: 1 },
  ...
  { name: "Bowler", image: "assets/images/bowler.jpg", class: "Balanced", avg: 0.4, gp: 6, hr: 1, pa: 20, hits: 8, slg: 0.6, obp: 0.4, doubles: 1, triples: 0 },
  { name: "Bowser Jr", image: "assets/images/bowser jr.png", class: "Technique", avg: 0.486, gp: 46, hr: 4, pa: 179, hits: 87, slg: 0.624, obp: 0.486, doubles: 11, triples: 0 },
  { name: "Bowser", image: "assets/images/bowser.png", class: "Power", avg: 0.617, gp: 46, hr: 53, pa: 196, hits: 121, slg: 1.565, obp: 0.617, doubles: 17, triples: 4 },
  { name: "Brown Kritter", image: "assets/images/brown kritter.png", class: "Power", avg: 0.5, gp: 46, hr: 32, pa: 172, hits: 86, slg: 1.148, obp: 0.506, doubles: 9, triples: 1 },
  ...
  { name: "Carby", image: "assets/images/carby.jpg", class: "Balanced", avg: 0.491, gp: 26, hr: 4, pa: 106, hits: 52, slg: 0.703, obp: 0.491, doubles: 5, triples: 2 },
  ...
  { name: "Count Dooku", image: "assets/images/count dooku.jpg", class: "Balanced", avg: 0.346, gp: 6, hr: 0, pa: 26, hits: 9, slg: 0.462, obp: 0.346, doubles: 1, triples: 1 },
  { name: "Daisy", image: "assets/images/daisy.png", class: "Power", avg: 0.457, gp: 44, hr: 7, pa: 173, hits: 79, slg: 0.683, obp: 0.457, doubles: 14, triples: 1 },
  { name: "Dark Bones", image: "assets/images/dark bones.png", class: "Balanced", avg: 0.675, gp: 46, hr: 15, pa: 191, hits: 129, slg: 1.005, obp: 0.68, doubles: 15, triples: 1 },
  { name: "Diddy Kong", image: "assets/images/diddy kong.png", class: "Technique", avg: 0.486, gp: 46, hr: 1, pa: 177, hits: 86, slg: 0.556, obp: 0.486, doubles: 9, triples: 0 },
  { name: "Diminutive", image: "assets/images/diminutive.jpg", class: "Balanced", avg: 0.397, gp: 16, hr: 1, pa: 63, hits: 25, slg: 0.524, obp: 0.397, doubles: 3, triples: 1 },
  ...
  { name: "Doc Brown", image: "assets/images/doc brown.jpg", class: "Balanced", avg: 0.524, gp: 5, hr: 0, pa: 21, hits: 11, slg: 0.85, obp: 0.524, doubles: 6, triples: 0 },
  { name: "Donkey Kong", image: "assets/images/donkey kong.png", class: "Power", avg: 0.579, gp: 46, hr: 43, pa: 178, hits: 103, slg: 1.339, obp: 0.579, doubles: 5, triples: 0 },
  { name: "Dry Bones", image: "assets/images/dry bones.png", class: "Balanced", avg: 0.64, gp: 46, hr: 13, pa: 178, hits: 114, slg: 0.985, obp: 0.641, doubles: 14, triples: 3 },
  { name: "Dwayne Wade", image: "assets/images/dwayne wade.jpg", class: "Balanced", avg: 0.469, gp: 46, hr: 3, pa: 162, hits: 76, slg: 0.531, obp: 0.469, doubles: 1, triples: 0 },
  ...
  { name: "Fire Bro", image: "assets/images/fire bro.png", class: "Power", avg: 0.59, gp: 46, hr: 48, pa: 188, hits: 111, slg: 1.413, obp: 0.59, doubles: 6, triples: 1 },
  ...
  { name: "Funky Kong", image: "assets/images/funky kong.png", class: "Power", avg: 0.433, gp: 46, hr: 26, pa: 178, hits: 77, slg: 0.941, obp: 0.443, doubles: 2, triples: 3 },
  { name: "Gandalf", image: "assets/images/gandalf.jpg", class: "Balanced", avg: 0.327, gp: 16, hr: 2, pa: 55, hits: 18, slg: 0.473, obp: 0.327, doubles: 0, triples: 1 },
  { name: "Ghandi", image: "assets/images/ghandi.jpg", class: "Balanced", avg: 0.293, gp: 16, hr: 0, pa: 58, hits: 17, slg: 0.31, obp: 0.293, doubles: 1, triples: 0 },
  { name: "Goomba", image: "assets/images/goomba.png", class: "Speed", avg: 0.5, gp: 1, hr: 2, pa: 4, hits: 2, slg: 2.0, obp: 0.5, doubles: 0, triples: 0 },
  { name: "Green Dry Bones", image: "assets/images/green dry bones.png", class: "Balanced", avg: 0.539, gp: 46, hr: 14, pa: 191, hits: 103, slg: 0.796, obp: 0.539, doubles: 5, triples: 1 },
  { name: "Green Magikoopa", image: "assets/images/green magikoopa.png", class: "Balanced", avg: 0.503, gp: 46, hr: 2, pa: 169, hits: 85, slg: 0.583, obp: 0.506, doubles: 7, triples: 0 },
  ...
  { name: "Green Toad", image: "assets/images/green toad.png", class: "Speed", avg: 0.638, gp: 46, hr: 2, pa: 185, hits: 118, slg: 0.787, obp: 0.642, doubles: 11, triples: 4 },
  { name: "Gus Fring", image: "assets/images/gus fring.jpg", class: "Balanced", avg: 0.2, gp: 6, hr: 0, pa: 25, hits: 5, slg: 0.25, obp: 0.208, doubles: 1, triples: 0 },
  { name: "Hammer Bro", image: "assets/images/hammer bro.png", class: "Power", avg: 0.542, gp: 46, hr: 40, pa: 177, hits: 96, slg: 1.252, obp: 0.534, doubles: 7, triples: 0 },
  ...
  { name: "Idi Amin", image: "assets/images/idi amin.jpg", class: "Balanced", avg: 0.25, gp: 6, hr: 0, pa: 20, hits: 5, slg: 0.25, obp: 0.25, doubles: 0, triples: 0 },
  ...
  { name: "KevinG", image: "assets/images/keving.jpg", class: "Balanced", avg: 0.402, gp: 26, hr: 3, pa: 102, hits: 41, slg: 0.545, obp: 0.402, doubles: 5, triples: 0 },
  { name: "Kim Jong Un", image: "assets/images/kim jong un.jpg", class: "Balanced", avg: 0.439, gp: 16, hr: 4, pa: 66, hits: 29, slg: 0.621, obp: 0.439, doubles: 0, triples: 0 },
  { name: "King Boo", image: "assets/images/king boo.png", class: "Power", avg: 0.557, gp: 46, hr: 29, pa: 183, hits: 102, slg: 1.067, obp: 0.548, doubles: 5, triples: 0 },
  { name: "King K Rool", image: "assets/images/king k rool.png", class: "Power", avg: 0.624, gp: 46, hr: 56, pa: 189, hits: 118, slg: 1.57, obp: 0.624, doubles: 8, triples: 0 },
  { name: "Koopa Paratroopa", image: "assets/images/koopa paratroopa.png", class: "Balanced", avg: 0.333, gp: 32, hr: 2, pa: 120, hits: 40, slg: 0.404, obp: 0.336, doubles: 2, triples: 0 },
  ...
  { name: "Kritter", image: "assets/images/kritter.png", class: "Power", avg: 0.552, gp: 46, hr: 29, pa: 194, hits: 107, slg: 1.118, obp: 0.551, doubles: 16, triples: 3 },
  ...
  { name: "Lebron James", image: "assets/images/lebron james.jpg", class: "Balanced", avg: 0.36, gp: 26, hr: 6, pa: 100, hits: 36, slg: 0.574, obp: 0.363, doubles: 3, triples: 0 },
  ...
  { name: "Luigi", image: "assets/images/luigi.png", class: "Speed", avg: 0.492, gp: 46, hr: 2, pa: 179, hits: 88, slg: 0.563, obp: 0.495, doubles: 4, triples: 1 },
  ...
  { name: "MLK Jr", image: "assets/images/mlk jr.jpg", class: "Balanced", avg: 0.385, gp: 16, hr: 1, pa: 65, hits: 25, slg: 0.462, obp: 0.385, doubles: 2, triples: 0 },
  { name: "Magikoopa", image: "assets/images/magikoopa.png", class: "Balanced", avg: 0.548, gp: 45, hr: 4, pa: 155, hits: 85, slg: 0.665, obp: 0.548, doubles: 4, triples: 1 },
  { name: "Mario", image: "assets/images/mario.png", class: "Balanced", avg: 0.506, gp: 46, hr: 5, pa: 174, hits: 88, slg: 0.625, obp: 0.507, doubles: 3, triples: 1 },
  ...
  { name: "Minion", image: "assets/images/minion.jpg", class: "Balanced", avg: 0.4, gp: 34, hr: 0, pa: 120, hits: 48, slg: 0.45, obp: 0.4, doubles: 4, triples: 1 },
  ...
  { name: "Miss Hot", image: "assets/images/miss hot.jpg", class: "Balanced", avg: 0.479, gp: 46, hr: 4, pa: 167, hits: 80, slg: 0.615, obp: 0.479, doubles: 8, triples: 1 },
  ...
  { name: "Peach", image: "assets/images/peach.png", class: "Balanced", avg: 0.428, gp: 46, hr: 1, pa: 180, hits: 77, slg: 0.489, obp: 0.417, doubles: 6, triples: 2 },
  { name: "Petey Piranha", image: "assets/images/petey piranha.png", class: "Power", avg: 0.584, gp: 46, hr: 58, pa: 185, hits: 108, slg: 1.556, obp: 0.589, doubles: 4, triples: 0 },
  { name: "Pianta", image: "assets/images/pianta.png", class: "Speed", avg: 0.608, gp: 46, hr: 29, pa: 176, hits: 107, slg: 1.102, obp: 0.596, doubles: 3, triples: 0 },
  { name: "Pink Yoshi", image: "assets/images/pink yoshi.png", class: "Speed", avg: 0.553, gp: 22, hr: 0, pa: 76, hits: 42, slg: 0.675, obp: 0.592, doubles: 6, triples: 0 },
  ...
  { name: "Purple Toad", image: "assets/images/purple toad.png", class: "Speed", avg: 0.648, gp: 28, hr: 0, pa: 105, hits: 68, slg: 0.73, obp: 0.648, doubles: 6, triples: 1 },
  { name: "Queen Elizabeth", image: "assets/images/queen elizabeth.jpg", class: "Balanced", avg: 0.367, gp: 16, hr: 1, pa: 60, hits: 22, slg: 0.433, obp: 0.367, doubles: 1, triples: 0 },
  ...
  { name: "Red Kritter", image: "assets/images/red kritter.png", class: "Power", avg: 0.5, gp: 46, hr: 25, pa: 178, hits: 89, slg: 0.984, obp: 0.499, doubles: 6, triples: 0 },
  { name: "Red Magikoopa", image: "assets/images/red magikoopa.png", class: "Balanced", avg: 0.456, gp: 45, hr: 2, pa: 169, hits: 77, slg: 0.534, obp: 0.461, doubles: 5, triples: 0 },
  ...
  { name: "Red Pianta", image: "assets/images/red pianta.png", class: "Speed", avg: 0.562, gp: 46, hr: 16, pa: 176, hits: 99, slg: 0.892, obp: 0.57, doubles: 7, triples: 0 },
  ...
  { name: "Rizzler", image: "assets/images/rizzler.jpg", class: "Balanced", avg: 0.459, gp: 25, hr: 1, pa: 98, hits: 45, slg: 0.541, obp: 0.459, doubles: 5, triples: 0 },
  { name: "Saddam Hussein", image: "assets/images/saddam hussein.jpg", class: "Balanced", avg: 0.43, gp: 26, hr: 7, pa: 100, hits: 43, slg: 0.73, obp: 0.43, doubles: 7, triples: 1 },
  { name: "Saka", image: "assets/images/saka.jpg", class: "Balanced", avg: 0.478, gp: 6, hr: 0, pa: 23, hits: 11, slg: 0.522, obp: 0.478, doubles: 1, triples: 0 },
  ...
  { name: "Tiny Kong", image: "assets/images/tiny kong.png", class: "Balanced", avg: 0.444, gp: 46, hr: 2, pa: 178, hits: 79, slg: 0.528, obp: 0.444, doubles: 7, triples: 1 },
  { name: "Toad", image: "assets/images/toad.jpg", class: "Balanced", avg: 0.651, gp: 38, hr: 2, pa: 152, hits: 99, slg: 0.736, obp: 0.656, doubles: 3, triples: 1 },
  { name: "Toadette", image: "assets/images/toadette.png", class: "Balanced", avg: 0.481, gp: 44, hr: 1, pa: 162, hits: 78, slg: 0.557, obp: 0.488, doubles: 4, triples: 2 },
  ...
  { name: "Unc", image: "assets/images/unc.jpg", class: "Balanced", avg: 0.506, gp: 46, hr: 11, pa: 172, hits: 87, slg: 0.729, obp: 0.512, doubles: 4, triples: 0 },
  { name: "Vicar", image: "assets/images/vicar.jpg", class: "Balanced", avg: 0.333, gp: 6, hr: 0, pa: 27, hits: 9, slg: 0.37, obp: 0.333, doubles: 1, triples: 0 },
  { name: "Waluigi", image: "assets/images/waluigi.png", class: "Technique", avg: 0.55, gp: 46, hr: 1, pa: 169, hits: 93, slg: 0.695, obp: 0.557, doubles: 20, triples: 0 },
  { name: "Wario", image: "assets/images/wario.png", class: "Technique", avg: 0.593, gp: 46, hr: 18, pa: 182, hits: 108, slg: 0.993, obp: 0.618, doubles: 6, triples: 0 },
  { name: "Wiggler", image: "assets/images/wiggler.png", class: "Speed", avg: 0.647, gp: 46, hr: 6, pa: 187, hits: 121, slg: 0.821, obp: 0.647, doubles: 11, triples: 1 },
  ...
  { name: "Yellow Magikoopa", image: "assets/images/yellow magikoopa.png", class: "Balanced", avg: 0.553, gp: 28, hr: 2, pa: 114, hits: 63, slg: 0.664, obp: 0.553, doubles: 2, triples: 2 },
  { name: "Yellow Pianta", image: "assets/images/yellow pianta.png", class: "Speed", avg: 0.592, gp: 46, hr: 12, pa: 184, hits: 109, slg: 0.816, obp: 0.596, doubles: 4, triples: 0 },
  { name: "Yellow Shy Guy", image: "assets/images/yellow shy guy.png", class: "Technique", avg: 0.356, gp: 31, hr: 2, pa: 104, hits: 37, slg: 0.452, obp: 0.356, doubles: 3, triples: 0 },
  { name: "Yellow Toad", image: "assets/images/yellow toad.png", class: "Speed", avg: 0.615, gp: 44, hr: 4, pa: 174, hits: 107, slg: 0.751, obp: 0.615, doubles: 8, triples: 1 },
  ...
  { name: "Yoshi", image: "assets/images/yoshi.png", class: "Speed", avg: 0.455, gp: 46, hr: 2, pa: 178, hits: 81, slg: 0.53, obp: 0.458, doubles: 6, triples: 0 },
...
if (characterGrid) {
  ...
  "Baby Luigi": { ip: 5, era: 4.2, baa: 0.459, so: 0 },
  "Baby Peach": { ip: 22, era: 9.68, baa: 0.548, so: 0 },
  "Birdo": { ip: 112, era: 6.78, baa: 0.467, so: 20 },
  "Black Shy Guy": { ip: 1, era: 0.0, baa: 0.6, so: 0 },
  "Black Widow": { ip: 2, era: 10.5, baa: 0.6, so: 0 },
  "Blooper": { ip: 19, era: 12.6, baa: 0.568, so: 0 },
  ...
  "Bowser": { ip: 125, era: 6.0, baa: 0.464, so: 28 },
  "Bowser Jr": { ip: 86, era: 8.2, baa: 0.502, so: 6 },
  ...
  "Idi Amin": { ip: 8, era: 8.4, baa: 0.486, so: 0 },
  "John K": { ip: 5, era: 9.8, baa: 0.542, so: 0 },
  "KevinG": { ip: 52, era: 6.79, baa: 0.467, so: 2 },
  "Kim Jong Un": { ip: 3, era: 0.0, baa: 0.357, so: 1 },
  "King Boo": { ip: 49, era: 10.91, baa: 0.545, so: 0 },
  ...
  "Peach": { ip: 127, era: 7.5, baa: 0.479, so: 4 },
  "Pianta": { ip: 42, era: 9.97, baa: 0.536, so: 1 },
  "Pink Yoshi": { ip: 1, era: 21.0, baa: 0.778, so: 0 },
  "Queen Elizabeth": { ip: 1, era: 21.0, baa: 0.75, so: 0 },
  "Red Kritter": { ip: 8, era: 9.84, baa: 0.532, so: 0 },
  "Red Magikoopa": { ip: 48, era: 8.51, baa: 0.502, so: 0 },
  "Red Pianta": { ip: 18, era: 11.64, baa: 0.579, so: 1 },
  ...
  "Tiny Kong": { ip: 20, era: 5.29, baa: 0.474, so: 1 },
  ...
  "Waluigi": { ip: 62, era: 7.39, baa: 0.459, so: 3 },
  "Wario": { ip: 88, era: 9.72, baa: 0.515, so: 5 },
  "Wiggler": { ip: 3, era: 1.75, baa: 0.333, so: 0 },
  "Yellow Magikoopa": { ip: 35, era: 8.43, baa: 0.413, so: 1 },
  "Yellow Pianta": { ip: 18, era: 11.11, baa: 0.543, so: 1 },
  ...
  "Yoshi": { ip: 104, era: 7.16, baa: 0.474, so: 3 },
};
