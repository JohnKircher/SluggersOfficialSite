...
const characters = [
  { name: "Baby DK", image: "assets/images/baby dk.png", class: "Speed", avg: 0.507, gp: 36, hr: 5, pa: 144, hits: 73, slg: 0.663, obp: 0.514, doubles: 4, triples: 1 },
  { name: "Baby Daisy", image: "assets/images/baby daisy.png", class: "Power", avg: 0.408, gp: 28, hr: 2, pa: 98, hits: 40, slg: 0.541, obp: 0.404, doubles: 5, triples: 1 },
  ...
  { name: "Birdo", image: "assets/images/birdo.png", class: "Power", avg: 0.567, gp: 36, hr: 17, pa: 141, hits: 80, slg: 0.971, obp: 0.574, doubles: 5, triples: 0 },
  { name: "Black Shy Guy", image: "assets/images/black shy guy.png", class: "Technique", avg: 0.354, gp: 24, hr: 0, pa: 79, hits: 28, slg: 0.364, obp: 0.352, doubles: 1, triples: 0 },
  ...
  { name: "Blooper", image: "assets/images/blooper.png", class: "Balanced", avg: 0.531, gp: 24, hr: 0, pa: 81, hits: 43, slg: 0.631, obp: 0.537, doubles: 5, triples: 1 },
  { name: "Blue Dry Bones", image: "assets/images/blue dry bones.png", class: "Balanced", avg: 0.626, gp: 36, hr: 8, pa: 139, hits: 87, slg: 0.905, obp: 0.629, doubles: 9, triples: 1 },
  { name: "Blue Kritter", image: "assets/images/blue kritter.png", class: "Power", avg: 0.514, gp: 36, hr: 12, pa: 140, hits: 72, slg: 0.774, obp: 0.497, doubles: 4, triples: 0 },
  { name: "Blue Shy Guy", image: "assets/images/blue shy guy.png", class: "Technique", avg: 0.323, gp: 20, hr: 0, pa: 65, hits: 21, slg: 0.328, obp: 0.323, doubles: 0, triples: 0 },
  { name: "Blue Toad", image: "assets/images/blue toad.png", class: "Speed", avg: 0.57, gp: 30, hr: 3, pa: 114, hits: 65, slg: 0.711, obp: 0.57, doubles: 7, triples: 0 },
  ...
  { name: "Boo", image: "assets/images/boo.png", class: "Speed", avg: 0.483, gp: 35, hr: 1, pa: 118, hits: 57, slg: 0.551, obp: 0.483, doubles: 5, triples: 0 },
  { name: "Boomerang Bro", image: "assets/images/boomerang bro.png", class: "Power", avg: 0.493, gp: 36, hr: 18, pa: 134, hits: 66, slg: 0.939, obp: 0.5, doubles: 3, triples: 1 },
  { name: "Borat", image: "assets/images/borat.jpg", class: "Balanced", avg: 0.384, gp: 36, hr: 0, pa: 146, hits: 56, slg: 0.419, obp: 0.384, doubles: 5, triples: 0 },
  { name: "Bowser Jr", image: "assets/images/bowser jr.png", class: "Technique", avg: 0.46, gp: 36, hr: 3, pa: 139, hits: 64, slg: 0.581, obp: 0.46, doubles: 7, triples: 0 },
  { name: "Bowser", image: "assets/images/bowser.png", class: "Power", avg: 0.582, gp: 36, hr: 36, pa: 153, hits: 89, slg: 1.423, obp: 0.582, doubles: 13, triples: 3 },
  { name: "Brown Kritter", image: "assets/images/brown kritter.png", class: "Power", avg: 0.463, gp: 36, hr: 20, pa: 134, hits: 62, slg: 1.003, obp: 0.47, doubles: 6, triples: 1 },
  ...
  { name: "Carby", image: "assets/images/carby.jpg", class: "Balanced", avg: 0.484, gp: 16, hr: 2, pa: 64, hits: 31, slg: 0.578, obp: 0.485, doubles: 0, triples: 0 },
  ...
  { name: "Daisy", image: "assets/images/daisy.png", class: "Power", avg: 0.47, gp: 34, hr: 6, pa: 132, hits: 62, slg: 0.714, obp: 0.47, doubles: 10, triples: 1 },
  { name: "Dark Bones", image: "assets/images/dark bones.png", class: "Balanced", avg: 0.669, gp: 36, hr: 12, pa: 145, hits: 97, slg: 1.001, obp: 0.675, doubles: 12, triples: 0 },
  { name: "Diddy Kong", image: "assets/images/diddy kong.png", class: "Technique", avg: 0.489, gp: 36, hr: 1, pa: 141, hits: 69, slg: 0.564, obp: 0.489, doubles: 7, triples: 0 },
  { name: "Diminutive", image: "assets/images/diminutive.jpg", class: "Balanced", avg: 0.3, gp: 6, hr: 1, pa: 20, hits: 6, slg: 0.45, obp: 0.3, doubles: 0, triples: 0 },
  { name: "Dixie Kong", image: "assets/images/dixie kong.png", class: "Balanced", avg: 0.506, gp: 23, hr: 2, pa: 85, hits: 43, slg: 0.6, obp: 0.506, doubles: 2, triples: 0 },
  { name: "Donkey Kong", image: "assets/images/donkey kong.png", class: "Power", avg: 0.603, gp: 36, hr: 37, pa: 141, hits: 85, slg: 1.435, obp: 0.603, doubles: 5, triples: 0 },
  { name: "Dry Bones", image: "assets/images/dry bones.png", class: "Balanced", avg: 0.628, gp: 36, hr: 13, pa: 137, hits: 86, slg: 1.075, obp: 0.628, doubles: 14, triples: 3 },
  { name: "Dwayne Wade", image: "assets/images/dwayne wade.jpg", class: "Balanced", avg: 0.476, gp: 36, hr: 2, pa: 124, hits: 59, slg: 0.524, obp: 0.475, doubles: 0, triples: 0 },
  ...
  { name: "Fire Bro", image: "assets/images/fire bro.png", class: "Power", avg: 0.568, gp: 36, hr: 37, pa: 146, hits: 83, slg: 1.384, obp: 0.568, doubles: 4, triples: 1 },
  { name: "Frozone", image: "assets/images/frozone.jpg", class: "Balanced", avg: 0.362, gp: 12, hr: 3, pa: 47, hits: 17, slg: 0.553, obp: 0.362, doubles: 0, triples: 0 },
  { name: "Funky Kong", image: "assets/images/funky kong.png", class: "Power", avg: 0.446, gp: 36, hr: 18, pa: 139, hits: 62, slg: 0.91, obp: 0.459, doubles: 2, triples: 2 },
  ...
  { name: "Ghandi", image: "assets/images/ghandi.jpg", class: "Balanced", avg: 0.238, gp: 6, hr: 0, pa: 21, hits: 5, slg: 0.238, obp: 0.238, doubles: 0, triples: 0 },
  { name: "Green Dry Bones", image: "assets/images/green dry bones.png", class: "Balanced", avg: 0.556, gp: 36, hr: 13, pa: 144, hits: 80, slg: 0.868, obp: 0.556, doubles: 4, triples: 1 },
  { name: "Green Magikoopa", image: "assets/images/green magikoopa.png", class: "Balanced", avg: 0.5, gp: 36, hr: 2, pa: 128, hits: 64, slg: 0.586, obp: 0.5, doubles: 5, triples: 0 },
  ...
  { name: "Green Shy Guy", image: "assets/images/green shy guy.png", class: "Technique", avg: 0.381, gp: 34, hr: 2, pa: 118, hits: 45, slg: 0.476, obp: 0.371, doubles: 4, triples: 1 },
  { name: "Green Toad", image: "assets/images/green toad.png", class: "Speed", avg: 0.638, gp: 36, hr: 2, pa: 138, hits: 88, slg: 0.837, obp: 0.643, doubles: 11, triples: 4 },
  { name: "Hammer Bro", image: "assets/images/hammer bro.png", class: "Power", avg: 0.533, gp: 36, hr: 32, pa: 137, hits: 73, slg: 1.238, obp: 0.522, doubles: 2, triples: 0 },
  ...
  { name: "KevinG", image: "assets/images/keving.jpg", class: "Balanced", avg: 0.343, gp: 17, hr: 3, pa: 67, hits: 23, slg: 0.516, obp: 0.343, doubles: 2, triples: 0 },
  { name: "Kim Jong Un", image: "assets/images/kim jong un.jpg", class: "Balanced", avg: 0.654, gp: 6, hr: 4, pa: 26, hits: 17, slg: 1.115, obp: 0.654, doubles: 0, triples: 0 },
  { name: "King Boo", image: "assets/images/king boo.png", class: "Power", avg: 0.551, gp: 36, hr: 25, pa: 138, hits: 76, slg: 1.118, obp: 0.539, doubles: 2, triples: 0 },
  { name: "King K Rool", image: "assets/images/king k rool.png", class: "Power", avg: 0.628, gp: 36, hr: 41, pa: 148, hits: 93, slg: 1.518, obp: 0.628, doubles: 6, triples: 0 },
  ...
  { name: "Kritter", image: "assets/images/kritter.png", class: "Power", avg: 0.592, gp: 36, hr: 25, pa: 152, hits: 90, slg: 1.21, obp: 0.592, doubles: 15, triples: 2 },
  ...
  { name: "Lebron James", image: "assets/images/lebron james.jpg", class: "Balanced", avg: 0.344, gp: 16, hr: 3, pa: 64, hits: 22, slg: 0.522, obp: 0.348, doubles: 2, triples: 0 },
  ...
  { name: "Luigi", image: "assets/images/luigi.png", class: "Speed", avg: 0.489, gp: 36, hr: 1, pa: 137, hits: 67, slg: 0.54, obp: 0.489, doubles: 2, triples: 1 },
  ...
  { name: "MLK Jr", image: "assets/images/mlk jr.jpg", class: "Balanced", avg: 0.32, gp: 6, hr: 0, pa: 25, hits: 8, slg: 0.36, obp: 0.32, doubles: 1, triples: 0 },
  { name: "Magikoopa", image: "assets/images/magikoopa.png", class: "Balanced", avg: 0.541, gp: 36, hr: 3, pa: 122, hits: 66, slg: 0.656, obp: 0.541, doubles: 3, triples: 1 },
  { name: "Mario", image: "assets/images/mario.png", class: "Balanced", avg: 0.522, gp: 36, hr: 3, pa: 134, hits: 70, slg: 0.625, obp: 0.523, doubles: 2, triples: 1 },
  ...
  { name: "Miss Hot", image: "assets/images/miss hot.jpg", class: "Balanced", avg: 0.508, gp: 36, hr: 3, pa: 130, hits: 66, slg: 0.637, obp: 0.508, doubles: 7, triples: 0 },
  ...
  { name: "Mrs.Claus", image: "assets/images/mrs claus.jpg", class: "Balanced", avg: 0.417, gp: 16, hr: 2, pa: 60, hits: 25, slg: 0.567, obp: 0.417, doubles: 3, triples: 0 },
  { name: "Paragoomba", image: "assets/images/paragoomba.png", class: "Balanced", avg: 0.343, gp: 19, hr: 0, pa: 70, hits: 24, slg: 0.357, obp: 0.343, doubles: 1, triples: 0 },
  { name: "Peach", image: "assets/images/peach.png", class: "Balanced", avg: 0.377, gp: 36, hr: 0, pa: 138, hits: 52, slg: 0.414, obp: 0.362, doubles: 5, triples: 1 },
  { name: "Petey Piranha", image: "assets/images/petey piranha.png", class: "Power", avg: 0.564, gp: 36, hr: 41, pa: 140, hits: 79, slg: 1.457, obp: 0.564, doubles: 2, triples: 0 },
  { name: "Pianta", image: "assets/images/pianta.png", class: "Speed", avg: 0.607, gp: 36, hr: 15, pa: 135, hits: 82, slg: 0.925, obp: 0.592, doubles: 1, triples: 0 },
  ...
  { name: "Pops", image: "assets/images/pops.jpg", class: "Balanced", avg: 0.667, gp: 6, hr: 5, pa: 27, hits: 18, slg: 1.269, obp: 0.692, doubles: 0, triples: 0 },
  { name: "Purple Toad", image: "assets/images/purple toad.png", class: "Speed", avg: 0.683, gp: 18, hr: 0, pa: 63, hits: 43, slg: 0.788, obp: 0.682, doubles: 4, triples: 1 },
  ...
  { name: "Red Kritter", image: "assets/images/red kritter.png", class: "Power", avg: 0.475, gp: 36, hr: 14, pa: 139, hits: 66, slg: 0.845, obp: 0.474, doubles: 6, triples: 0 },
  { name: "Red Magikoopa", image: "assets/images/red magikoopa.png", class: "Balanced", avg: 0.457, gp: 35, hr: 2, pa: 129, hits: 59, slg: 0.558, obp: 0.464, doubles: 5, triples: 0 },
  ...
  { name: "Red Pianta", image: "assets/images/red pianta.png", class: "Speed", avg: 0.555, gp: 36, hr: 12, pa: 137, hits: 76, slg: 0.867, obp: 0.564, doubles: 5, triples: 0 },
  { name: "Red Yoshi", image: "assets/images/red yoshi.png", class: "Speed", avg: 0.385, gp: 29, hr: 2, pa: 104, hits: 40, slg: 0.458, obp: 0.389, doubles: 1, triples: 0 },
  { name: "Rizzler", image: "assets/images/rizzler.jpg", class: "Balanced", avg: 0.452, gp: 16, hr: 1, pa: 62, hits: 28, slg: 0.533, obp: 0.451, doubles: 2, triples: 0 },
  { name: "Saddam Hussein", image: "assets/images/saddam hussein.jpg", class: "Balanced", avg: 0.385, gp: 16, hr: 3, pa: 65, hits: 25, slg: 0.6, obp: 0.384, doubles: 3, triples: 1 },
  ...
  { name: "Shy Guy", image: "assets/images/shy guy.png", class: "Technique", avg: 0.437, gp: 24, hr: 0, pa: 87, hits: 38, slg: 0.494, obp: 0.448, doubles: 4, triples: 0 },
  ...
  { name: "Tiny Kong", image: "assets/images/tiny kong.png", class: "Balanced", avg: 0.454, gp: 36, hr: 1, pa: 141, hits: 64, slg: 0.518, obp: 0.454, doubles: 4, triples: 1 },
  { name: "Toad", image: "assets/images/toad.jpg", class: "Balanced", avg: 0.636, gp: 28, hr: 0, pa: 110, hits: 70, slg: 0.654, obp: 0.636, doubles: 2, triples: 0 },
  { name: "Toadette", image: "assets/images/toadette.png", class: "Balanced", avg: 0.475, gp: 34, hr: 1, pa: 118, hits: 56, slg: 0.546, obp: 0.486, doubles: 2, triples: 1 },
  ...
  { name: "Tung Tung Tung Sahur", image: "assets/images/tung tung tung sahur.jpg", class: "Balanced", avg: 0.4, gp: 6, hr: 0, pa: 20, hits: 8, slg: 0.45, obp: 0.4, doubles: 1, triples: 0 },
  { name: "Unc", image: "assets/images/unc.jpg", class: "Balanced", avg: 0.507, gp: 36, hr: 7, pa: 136, hits: 69, slg: 0.694, obp: 0.515, doubles: 3, triples: 0 },
  { name: "Waluigi", image: "assets/images/waluigi.png", class: "Technique", avg: 0.546, gp: 36, hr: 0, pa: 130, hits: 71, slg: 0.671, obp: 0.554, doubles: 15, triples: 0 },
  { name: "Wario", image: "assets/images/wario.png", class: "Technique", avg: 0.594, gp: 36, hr: 15, pa: 143, hits: 85, slg: 1.033, obp: 0.626, doubles: 5, triples: 0 },
  { name: "Wiggler", image: "assets/images/wiggler.png", class: "Speed", avg: 0.647, gp: 36, hr: 3, pa: 150, hits: 97, slg: 0.792, obp: 0.647, doubles: 10, triples: 1 },
  { name: "Winnie The Pooh", image: "assets/images/winnie the pooh.jpg", class: "Balanced", avg: 0.364, gp: 6, hr: 1, pa: 22, hits: 8, slg: 0.591, obp: 0.364, doubles: 2, triples: 0 },
  { name: "Yellow Magikoopa", image: "assets/images/yellow magikoopa.png", class: "Balanced", avg: 0.567, gp: 18, hr: 1, pa: 67, hits: 38, slg: 0.683, obp: 0.568, doubles: 2, triples: 1 },
  { name: "Yellow Pianta", image: "assets/images/yellow pianta.png", class: "Speed", avg: 0.58, gp: 36, hr: 5, pa: 143, hits: 83, slg: 0.715, obp: 0.585, doubles: 3, triples: 0 },
  { name: "Yellow Shy Guy", image: "assets/images/yellow shy guy.png", class: "Technique", avg: 0.388, gp: 22, hr: 1, pa: 80, hits: 31, slg: 0.459, obp: 0.388, doubles: 2, triples: 0 },
  { name: "Yellow Toad", image: "assets/images/yellow toad.png", class: "Speed", avg: 0.644, gp: 34, hr: 4, pa: 135, hits: 87, slg: 0.814, obp: 0.644, doubles: 7, triples: 1 },
  ...
  { name: "Yoshi", image: "assets/images/yoshi.png", class: "Speed", avg: 0.436, gp: 36, hr: 2, pa: 140, hits: 61, slg: 0.519, obp: 0.439, doubles: 5, triples: 0 },
...
if (characterGrid) {
  ...
  "Birdo": { ip: 88, era: 6.47, baa: 0.45, so: 14 },
  ...
  "Green Shy Guy": { ip: 2, era: 38.5, baa: 0.706, so: 1 },
  "Hammer Bro": { ip: 4, era: 16.62, baa: 0.635, so: 0 },
  "John K": { ip: 5, era: 9.8, baa: 0.542, so: 0 },
  "KevinG": { ip: 35, era: 6.15, baa: 0.424, so: 2 },
  "King Boo": { ip: 35, era: 10.25, baa: 0.555, so: 0 },
  "King K Rool": { ip: 14, era: 9.74, baa: 0.442, so: 0 },
  ...
  "Luigi": { ip: 130, era: 6.57, baa: 0.47, so: 12 },
  "Magikoopa": { ip: 46, era: 9.26, baa: 0.526, so: 1 },
  "Mario": { ip: 113, era: 6.81, baa: 0.484, so: 8 },
  ...
  "Paragoomba": { ip: 47, era: 7.54, baa: 0.455, so: 0 },
  "Peach": { ip: 111, era: 6.81, baa: 0.468, so: 3 },
  "Pianta": { ip: 19, era: 7.53, baa: 0.515, so: 0 },
  ...
  "Waluigi": { ip: 50, era: 4.44, baa: 0.427, so: 2 },
  "Wario": { ip: 56, era: 9.82, baa: 0.523, so: 3 },
  ...
  "Yoshi": { ip: 75, era: 7.17, baa: 0.48, so: 1 },
};
