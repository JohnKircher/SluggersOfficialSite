...
const characters = [
  ...
  { name: "Birdo", image: "assets/images/birdo.png", class: "Power", avg: 0.558, gp: 54, hr: 30, pa: 215, hits: 120, slg: 1.024, obp: 0.563, doubles: 8, triples: 0 },
  { name: "Black Shy Guy", image: "assets/images/black shy guy.png", class: "Technique", avg: 0.371, gp: 29, hr: 0, pa: 97, hits: 36, slg: 0.389, obp: 0.369, doubles: 2, triples: 0 },
  ...
  { name: "Blooper", image: "assets/images/blooper.png", class: "Balanced", avg: 0.564, gp: 42, hr: 0, pa: 163, hits: 92, slg: 0.64, obp: 0.567, doubles: 8, triples: 1 },
  { name: "Blue Dry Bones", image: "assets/images/blue dry bones.png", class: "Balanced", avg: 0.628, gp: 54, hr: 10, pa: 215, hits: 135, slg: 0.855, obp: 0.63, doubles: 11, triples: 2 },
  { name: "Blue Kritter", image: "assets/images/blue kritter.png", class: "Power", avg: 0.545, gp: 54, hr: 21, pa: 209, hits: 114, slg: 0.906, obp: 0.534, doubles: 9, triples: 3 },
  ...
  { name: "Blue Toad", image: "assets/images/blue toad.png", class: "Speed", avg: 0.611, gp: 48, hr: 5, pa: 190, hits: 116, slg: 0.747, obp: 0.61, doubles: 9, triples: 1 },
  ...
  { name: "Boo", image: "assets/images/boo.png", class: "Speed", avg: 0.479, gp: 43, hr: 1, pa: 144, hits: 69, slg: 0.542, obp: 0.479, doubles: 6, triples: 0 },
  { name: "Boomerang Bro", image: "assets/images/boomerang bro.png", class: "Power", avg: 0.483, gp: 54, hr: 25, pa: 205, hits: 99, slg: 0.886, obp: 0.488, doubles: 4, triples: 1 },
  ...
  { name: "Bowser Jr", image: "assets/images/bowser jr.png", class: "Technique", avg: 0.471, gp: 54, hr: 4, pa: 206, hits: 97, slg: 0.598, obp: 0.471, doubles: 12, triples: 0 },
  { name: "Bowser", image: "assets/images/bowser.png", class: "Power", avg: 0.604, gp: 54, hr: 64, pa: 230, hits: 139, slg: 1.573, obp: 0.604, doubles: 19, triples: 5 },
  { name: "Brown Kritter", image: "assets/images/brown kritter.png", class: "Power", avg: 0.493, gp: 54, hr: 38, pa: 207, hits: 102, slg: 1.13, obp: 0.498, doubles: 10, triples: 1 },
  ...
  { name: "Carby", image: "assets/images/carby.jpg", class: "Balanced", avg: 0.475, gp: 34, hr: 4, pa: 139, hits: 66, slg: 0.661, obp: 0.477, doubles: 8, triples: 2 },
  { name: "Chicken", image: "assets/images/chicken.jpg", class: "Balanced", avg: 0.473, gp: 30, hr: 2, pa: 112, hits: 53, slg: 0.553, obp: 0.473, doubles: 3, triples: 0 },
  ...
  { name: "Daisy", image: "assets/images/daisy.png", class: "Power", avg: 0.433, gp: 52, hr: 8, pa: 201, hits: 87, slg: 0.647, obp: 0.433, doubles: 15, triples: 1 },
  { name: "Dark Bones", image: "assets/images/dark bones.png", class: "Balanced", avg: 0.654, gp: 54, hr: 18, pa: 228, hits: 149, slg: 0.974, obp: 0.657, doubles: 15, triples: 1 },
  { name: "Diddy Kong", image: "assets/images/diddy kong.png", class: "Technique", avg: 0.51, gp: 54, hr: 1, pa: 208, hits: 106, slg: 0.579, obp: 0.51, doubles: 11, triples: 0 },
  ...
  { name: "Doc Brown", image: "assets/images/doc brown.jpg", class: "Balanced", avg: 0.478, gp: 12, hr: 1, pa: 46, hits: 22, slg: 0.712, obp: 0.478, doubles: 7, triples: 0 },
  { name: "Donkey Kong", image: "assets/images/donkey kong.png", class: "Power", avg: 0.601, gp: 54, hr: 58, pa: 213, hits: 128, slg: 1.447, obp: 0.601, doubles: 5, triples: 0 },
  { name: "Dora", image: "assets/images/dora.jpg", class: "Balanced", avg: 0.5, gp: 4, hr: 0, pa: 16, hits: 8, slg: 0.563, obp: 0.5, doubles: 1, triples: 0 },
  { name: "Dry Bones", image: "assets/images/dry bones.png", class: "Balanced", avg: 0.624, gp: 54, hr: 13, pa: 210, hits: 131, slg: 0.923, obp: 0.627, doubles: 15, triples: 3 },
  { name: "Dwayne Wade", image: "assets/images/dwayne wade.jpg", class: "Balanced", avg: 0.474, gp: 54, hr: 3, pa: 192, hits: 91, slg: 0.526, obp: 0.474, doubles: 1, triples: 0 },
  ...
  { name: "Fire Bro", image: "assets/images/fire bro.png", class: "Power", avg: 0.594, gp: 54, hr: 55, pa: 217, hits: 129, slg: 1.404, obp: 0.594, doubles: 6, triples: 1 },
  ...
  { name: "Funky Kong", image: "assets/images/funky kong.png", class: "Power", avg: 0.442, gp: 54, hr: 32, pa: 208, hits: 92, slg: 0.974, obp: 0.451, doubles: 3, triples: 3 },
  ...
  { name: "Green Dry Bones", image: "assets/images/green dry bones.png", class: "Balanced", avg: 0.559, gp: 54, hr: 14, pa: 222, hits: 124, slg: 0.797, obp: 0.559, doubles: 9, triples: 1 },
  { name: "Green Magikoopa", image: "assets/images/green magikoopa.png", class: "Balanced", avg: 0.485, gp: 54, hr: 2, pa: 196, hits: 95, slg: 0.554, obp: 0.487, doubles: 7, triples: 0 },
  ...
  { name: "Green Shy Guy", image: "assets/images/green shy guy.png", class: "Technique", avg: 0.435, gp: 42, hr: 2, pa: 147, hits: 64, slg: 0.539, obp: 0.427, doubles: 8, triples: 1 },
  { name: "Green Toad", image: "assets/images/green toad.png", class: "Speed", avg: 0.598, gp: 54, hr: 2, pa: 219, hits: 131, slg: 0.726, obp: 0.604, doubles: 11, triples: 4 },
  { name: "Gus Fring", image: "assets/images/gus fring.jpg", class: "Balanced", avg: 0.259, gp: 14, hr: 0, pa: 54, hits: 14, slg: 0.302, obp: 0.264, doubles: 2, triples: 0 },
  { name: "Hammer Bro", image: "assets/images/hammer bro.png", class: "Power", avg: 0.562, gp: 54, hr: 50, pa: 203, hits: 114, slg: 1.333, obp: 0.554, doubles: 8, triples: 0 },
  ...
  { name: "John K", image: "assets/images/john k.jpg", class: "Balanced", avg: 0.394, gp: 19, hr: 1, pa: 66, hits: 26, slg: 0.467, obp: 0.402, doubles: 1, triples: 0 },
  ...
  { name: "KevinG", image: "assets/images/keving.jpg", class: "Balanced", avg: 0.379, gp: 34, hr: 4, pa: 132, hits: 50, slg: 0.519, obp: 0.379, doubles: 6, triples: 0 },
  { name: "Kim Jong Un", image: "assets/images/kim jong un.jpg", class: "Balanced", avg: 0.438, gp: 24, hr: 4, pa: 96, hits: 42, slg: 0.604, obp: 0.438, doubles: 4, triples: 0 },
  { name: "King Boo", image: "assets/images/king boo.png", class: "Power", avg: 0.562, gp: 54, hr: 35, pa: 219, hits: 123, slg: 1.07, obp: 0.554, doubles: 5, triples: 0 },
  { name: "King K Rool", image: "assets/images/king k rool.png", class: "Power", avg: 0.593, gp: 54, hr: 64, pa: 221, hits: 131, slg: 1.519, obp: 0.593, doubles: 9, triples: 0 },
  ...
  { name: "Koopa Troopa", image: "assets/images/koopa troopa.png", class: "Speed", avg: 0.369, gp: 19, hr: 1, pa: 65, hits: 24, slg: 0.498, obp: 0.375, doubles: 3, triples: 1 },
  { name: "Kritter", image: "assets/images/kritter.png", class: "Power", avg: 0.551, gp: 54, hr: 36, pa: 225, hits: 124, slg: 1.148, obp: 0.551, doubles: 17, triples: 3 },
  ...
  { name: "Lebron James", image: "assets/images/lebron james.jpg", class: "Balanced", avg: 0.408, gp: 34, hr: 6, pa: 130, hits: 53, slg: 0.583, obp: 0.41, doubles: 4, triples: 0 },
  ...
  { name: "Livvy Dunne", image: "assets/images/livvy dunne.jpg", class: "Balanced", avg: 0.466, gp: 14, hr: 0, pa: 58, hits: 27, slg: 0.466, obp: 0.466, doubles: 0, triples: 0 },
  ...
  { name: "Luigi", image: "assets/images/luigi.png", class: "Speed", avg: 0.505, gp: 54, hr: 4, pa: 208, hits: 105, slg: 0.595, obp: 0.507, doubles: 4, triples: 1 },
  ...
  { name: "Magikoopa", image: "assets/images/magikoopa.png", class: "Balanced", avg: 0.53, gp: 53, hr: 4, pa: 185, hits: 98, slg: 0.632, obp: 0.53, doubles: 5, triples: 1 },
  { name: "Mario", image: "assets/images/mario.png", class: "Balanced", avg: 0.524, gp: 54, hr: 5, pa: 206, hits: 108, slg: 0.634, obp: 0.525, doubles: 5, triples: 1 },
  { name: "Matt", image: "assets/images/matt.jpg", class: "Balanced", avg: 0.488, gp: 12, hr: 0, pa: 43, hits: 21, slg: 0.488, obp: 0.488, doubles: 0, triples: 0 },
  ...
  { name: "Miss Hot", image: "assets/images/miss hot.jpg", class: "Balanced", avg: 0.442, gp: 54, hr: 4, pa: 197, hits: 87, slg: 0.567, obp: 0.444, doubles: 9, triples: 1 },
  ...
  { name: "Paragoomba", image: "assets/images/paragoomba.png", class: "Balanced", avg: 0.292, gp: 28, hr: 0, pa: 96, hits: 28, slg: 0.305, obp: 0.294, doubles: 1, triples: 0 },
  { name: "Peach", image: "assets/images/peach.png", class: "Balanced", avg: 0.44, gp: 54, hr: 1, pa: 207, hits: 91, slg: 0.508, obp: 0.43, doubles: 9, triples: 2 },
  { name: "Petey Piranha", image: "assets/images/petey piranha.png", class: "Power", avg: 0.606, gp: 54, hr: 76, pa: 218, hits: 132, slg: 1.679, obp: 0.61, doubles: 4, triples: 0 },
  { name: "Pianta", image: "assets/images/pianta.png", class: "Speed", avg: 0.603, gp: 54, hr: 38, pa: 209, hits: 126, slg: 1.153, obp: 0.593, doubles: 4, triples: 0 },
  { name: "Pink Yoshi", image: "assets/images/pink yoshi.png", class: "Speed", avg: 0.543, gp: 27, hr: 0, pa: 94, hits: 51, slg: 0.647, obp: 0.581, doubles: 6, triples: 0 },
  ...
  { name: "Purple Toad", image: "assets/images/purple toad.png", class: "Speed", avg: 0.632, gp: 36, hr: 0, pa: 133, hits: 84, slg: 0.704, obp: 0.632, doubles: 7, triples: 1 },
  ...
  { name: "Red Kritter", image: "assets/images/red kritter.png", class: "Power", avg: 0.478, gp: 54, hr: 27, pa: 209, hits: 100, slg: 0.927, obp: 0.478, doubles: 8, triples: 0 },
  { name: "Red Magikoopa", image: "assets/images/red magikoopa.png", class: "Balanced", avg: 0.465, gp: 53, hr: 2, pa: 200, hits: 93, slg: 0.541, obp: 0.469, doubles: 7, triples: 0 },
  ...
  { name: "Red Pianta", image: "assets/images/red pianta.png", class: "Speed", avg: 0.551, gp: 54, hr: 18, pa: 207, hits: 114, slg: 0.859, obp: 0.557, doubles: 7, triples: 0 },
  { name: "Red Yoshi", image: "assets/images/red yoshi.png", class: "Speed", avg: 0.459, gp: 37, hr: 2, pa: 133, hits: 61, slg: 0.53, obp: 0.469, doubles: 2, triples: 0 },
  { name: "Rizzler", image: "assets/images/rizzler.jpg", class: "Balanced", avg: 0.473, gp: 33, hr: 2, pa: 129, hits: 61, slg: 0.558, obp: 0.473, doubles: 5, triples: 0 },
  { name: "Saddam Hussein", image: "assets/images/saddam hussein.jpg", class: "Balanced", avg: 0.405, gp: 34, hr: 10, pa: 126, hits: 51, slg: 0.714, obp: 0.405, doubles: 7, triples: 1 },
  { name: "Saka", image: "assets/images/saka.jpg", class: "Balanced", avg: 0.458, gp: 14, hr: 0, pa: 48, hits: 22, slg: 0.5, obp: 0.459, doubles: 2, triples: 0 },
  ...
  { name: "Shy Guy", image: "assets/images/shy guy.png", class: "Technique", avg: 0.475, gp: 32, hr: 0, pa: 118, hits: 56, slg: 0.527, obp: 0.483, doubles: 5, triples: 0 },
  ...
  { name: "Tiny Kong", image: "assets/images/tiny kong.png", class: "Balanced", avg: 0.445, gp: 54, hr: 2, pa: 209, hits: 93, slg: 0.528, obp: 0.45, doubles: 8, triples: 1 },
  { name: "Toad", image: "assets/images/toad.jpg", class: "Balanced", avg: 0.661, gp: 46, hr: 2, pa: 180, hits: 119, slg: 0.777, obp: 0.665, doubles: 5, triples: 4 },
  { name: "Toadette", image: "assets/images/toadette.png", class: "Balanced", avg: 0.497, gp: 52, hr: 1, pa: 195, hits: 97, slg: 0.566, obp: 0.503, doubles: 5, triples: 2 },
  ...
  { name: "Tung Tung Tung Sahur", image: "assets/images/tung tung tung sahur.jpg", class: "Balanced", avg: 0.373, gp: 14, hr: 1, pa: 51, hits: 19, slg: 0.47, obp: 0.373, doubles: 2, triples: 0 },
  { name: "Unc", image: "assets/images/unc.jpg", class: "Balanced", avg: 0.495, gp: 54, hr: 14, pa: 202, hits: 100, slg: 0.73, obp: 0.5, doubles: 4, triples: 0 },
  ...
  { name: "Waluigi", image: "assets/images/waluigi.png", class: "Technique", avg: 0.533, gp: 54, hr: 2, pa: 199, hits: 106, slg: 0.694, obp: 0.541, doubles: 24, triples: 0 },
  { name: "Wario", image: "assets/images/wario.png", class: "Technique", avg: 0.588, gp: 54, hr: 19, pa: 211, hits: 124, slg: 0.951, obp: 0.609, doubles: 7, triples: 0 },
  { name: "Wiggler", image: "assets/images/wiggler.png", class: "Speed", avg: 0.638, gp: 54, hr: 7, pa: 218, hits: 139, slg: 0.814, obp: 0.638, doubles: 12, triples: 2 },
  ...
  { name: "Yellow Magikoopa", image: "assets/images/yellow magikoopa.png", class: "Balanced", avg: 0.521, gp: 36, hr: 3, pa: 146, hits: 76, slg: 0.628, obp: 0.521, doubles: 2, triples: 2 },
  { name: "Yellow Pianta", image: "assets/images/yellow pianta.png", class: "Speed", avg: 0.603, gp: 54, hr: 13, pa: 219, hits: 132, slg: 0.814, obp: 0.606, doubles: 6, triples: 0 },
  { name: "Yellow Shy Guy", image: "assets/images/yellow shy guy.png", class: "Technique", avg: 0.403, gp: 39, hr: 3, pa: 134, hits: 54, slg: 0.501, obp: 0.403, doubles: 3, triples: 0 },
  { name: "Yellow Toad", image: "assets/images/yellow toad.png", class: "Speed", avg: 0.612, gp: 52, hr: 4, pa: 209, hits: 128, slg: 0.749, obp: 0.612, doubles: 9, triples: 3 },
  { name: "Yellow Yoshi", image: "assets/images/yellow yoshi.png", class: "Speed", avg: 0.509, gp: 14, hr: 0, pa: 55, hits: 28, slg: 0.618, obp: 0.509, doubles: 4, triples: 1 },
  ...
  { name: "Yoshi", image: "assets/images/yoshi.png", class: "Speed", avg: 0.45, gp: 54, hr: 3, pa: 211, hits: 95, slg: 0.527, obp: 0.453, doubles: 6, triples: 0 },
...
if (characterGrid) {
  ...
  "Boo": { ip: 116, era: 7.89, baa: 0.513, so: 4 },
  "Boomerang Bro": { ip: 4, era: 1.5, baa: 0.375, so: 0 },
  "Borat": { ip: 9, era: 21.0, baa: 0.643, so: 0 },
  "Bowser": { ip: 132, era: 6.18, baa: 0.47, so: 29 },
  "Bowser Jr": { ip: 105, era: 8.41, baa: 0.513, so: 6 },
  ...
  "Daisy": { ip: 154, era: 7.07, baa: 0.453, so: 2 },
  "Dark Bones": { ip: 51, era: 5.05, baa: 0.388, so: 0 },
  "Diddy Kong": { ip: 79, era: 9.6, baa: 0.519, so: 9 },
  "Diminutive": { ip: 4, era: 6.0, baa: 0.353, so: 0 },
  "Dixie Kong": { ip: 6, era: 7.0, baa: 0.424, so: 1 },
  "Donkey Kong": { ip: 184, era: 8.02, baa: 0.494, so: 4 },
  ...
  "Green Magikoopa": { ip: 32, era: 9.92, baa: 0.529, so: 0 },
  ...
  "King Boo": { ip: 55, era: 12.3, baa: 0.558, so: 0 },
  "King K Rool": { ip: 27, era: 7.0, baa: 0.426, so: 0 },
  ...
  "Luigi": { ip: 181, era: 7.38, baa: 0.49, so: 15 },
  "MLK Jr": { ip: 5, era: 2.47, baa: 0.435, so: 0 },
  "Magikoopa": { ip: 51, era: 8.92, baa: 0.52, so: 1 },
  "Mario": { ip: 151, era: 7.43, baa: 0.494, so: 10 },
  ...
  "Paragoomba": { ip: 56, era: 9.56, baa: 0.495, so: 1 },
  "Peach": { ip: 148, era: 7.74, baa: 0.493, so: 6 },
  "Pianta": { ip: 61, era: 10.18, baa: 0.535, so: 3 },
  ...
  "Red Pianta": { ip: 40, era: 7.35, baa: 0.526, so: 2 },
  "Red Yoshi": { ip: 1, era: 21.0, baa: 0.6, so: 0 },
  "Rizzler": { ip: 10, era: 11.42, baa: 0.554, so: 0 },
  "Saddam Hussein": { ip: 10, era: 7.59, baa: 0.401, so: 0 },
  "Shy Guy": { ip: 2, era: 5.6, baa: 0.45, so: 0 },
  ...
  "Waluigi": { ip: 80, era: 7.33, baa: 0.452, so: 4 },
  "Wario": { ip: 116, era: 9.01, baa: 0.497, so: 6 },
  "Wiggler": { ip: 3, era: 1.75, baa: 0.333, so: 0 },
  "Yellow Magikoopa": { ip: 35, era: 8.43, baa: 0.413, so: 1 },
  "Yellow Pianta": { ip: 27, era: 12.77, baa: 0.548, so: 3 },
