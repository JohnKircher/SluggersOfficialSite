...
const characters = [
  { name: "Baby DK", image: "assets/images/baby dk.png", class: "Speed", avg: 0.435, gp: 22, hr: 3, pa: 85, hits: 37, slg: 0.691, obp: 0.518, doubles: 3, triples: 1 },
  { name: "Baby Daisy", image: "assets/images/baby daisy.png", class: "Power", avg: 0.394, gp: 14, hr: 0, pa: 49, hits: 19, slg: 0.51, obp: 0.421, doubles: 2, triples: 1 },
  ...
  { name: "Birdo", image: "assets/images/birdo.png", class: "Power", avg: 0.501, gp: 22, hr: 6, pa: 81, hits: 40, slg: 0.813, obp: 0.556, doubles: 3, triples: 0 },
  ...
  { name: "Blue Dry Bones", image: "assets/images/blue dry bones.png", class: "Balanced", avg: 0.541, gp: 22, hr: 5, pa: 83, hits: 44, slg: 0.878, obp: 0.611, doubles: 5, triples: 0 },
  { name: "Blue Kritter", image: "assets/images/blue kritter.png", class: "Power", avg: 0.408, gp: 22, hr: 6, pa: 80, hits: 32, slg: 0.655, obp: 0.433, doubles: 1, triples: 0 },
  { name: "Blue Shy Guy", image: "assets/images/blue shy guy.png", class: "Technique", avg: 0.12, gp: 6, hr: 0, pa: 18, hits: 2, slg: 0.167, obp: 0.167, doubles: 0, triples: 0 },
  { name: "Blue Toad", image: "assets/images/blue toad.png", class: "Speed", avg: 0.525, gp: 16, hr: 2, pa: 58, hits: 30, slg: 0.793, obp: 0.586, doubles: 6, triples: 0 },
  ...
  { name: "Boo", image: "assets/images/boo.png", class: "Speed", avg: 0.56, gp: 21, hr: 0, pa: 71, hits: 39, slg: 0.69, obp: 0.634, doubles: 4, triples: 0 },
  { name: "Boomerang Bro", image: "assets/images/boomerang bro.png", class: "Power", avg: 0.483, gp: 22, hr: 14, pa: 80, hits: 38, slg: 1.087, obp: 0.538, doubles: 2, triples: 0 },
  { name: "Borat", image: "assets/images/borat.jpg", class: "Balanced", avg: 0.407, gp: 22, hr: 0, pa: 87, hits: 35, slg: 0.483, obp: 0.437, doubles: 4, triples: 0 },
  { name: "Bowser Jr", image: "assets/images/bowser jr.png", class: "Technique", avg: 0.417, gp: 22, hr: 3, pa: 82, hits: 34, slg: 0.57, obp: 0.439, doubles: 1, triples: 0 },
  { name: "Bowser", image: "assets/images/bowser.png", class: "Power", avg: 0.51, gp: 22, hr: 24, pa: 91, hits: 46, slg: 1.404, obp: 0.55, doubles: 2, triples: 1 },
  { name: "Brown Kritter", image: "assets/images/brown kritter.png", class: "Power", avg: 0.446, gp: 22, hr: 11, pa: 79, hits: 35, slg: 0.95, obp: 0.468, doubles: 3, triples: 1 },
  ...
  { name: "Captain Jack", image: "assets/images/captain jack sparrow.jpg", class: "Balanced", avg: 0.407, gp: 8, hr: 1, pa: 27, hits: 11, slg: 0.538, obp: 0.407, doubles: 0, triples: 0 },
  { name: "Carby", image: "assets/images/carby.jpg", class: "Balanced", avg: 0.074, gp: 2, hr: 0, pa: 9, hits: 0, slg: 0.667, obp: 0.667, doubles: 0, triples: 0 },
  { name: "Chicken", image: "assets/images/chicken.jpg", class: "Balanced", avg: 0.365, gp: 18, hr: 0, pa: 64, hits: 23, slg: 0.422, obp: 0.406, doubles: 1, triples: 0 },
  ...
  { name: "Daisy", image: "assets/images/daisy.png", class: "Power", avg: 0.438, gp: 20, hr: 3, pa: 76, hits: 33, slg: 0.666, obp: 0.46, doubles: 6, triples: 0 },
  { name: "Dark Bones", image: "assets/images/dark bones.png", class: "Balanced", avg: 0.601, gp: 22, hr: 7, pa: 88, hits: 52, slg: 0.99, obp: 0.691, doubles: 6, triples: 0 },
  { name: "Diddy Kong", image: "assets/images/diddy kong.png", class: "Technique", avg: 0.469, gp: 22, hr: 1, pa: 86, hits: 40, slg: 0.598, obp: 0.488, doubles: 6, triples: 0 },
  ...
  { name: "Donkey Kong", image: "assets/images/donkey kong.png", class: "Power", avg: 0.614, gp: 22, hr: 19, pa: 85, hits: 52, slg: 1.337, obp: 0.624, doubles: 3, triples: 0 },
  { name: "Dry Bones", image: "assets/images/dry bones.png", class: "Balanced", avg: 0.562, gp: 22, hr: 6, pa: 81, hits: 45, slg: 0.937, obp: 0.618, doubles: 7, triples: 0 },
  { name: "Dwayne Wade", image: "assets/images/dwayne wade.jpg", class: "Balanced", avg: 0.393, gp: 22, hr: 1, pa: 68, hits: 26, slg: 0.5, obp: 0.456, doubles: 0, triples: 0 },
  ...
  { name: "Fire Bro", image: "assets/images/fire bro.png", class: "Power", avg: 0.526, gp: 22, hr: 25, pa: 87, hits: 45, slg: 1.469, obp: 0.585, doubles: 3, triples: 0 },
  { name: "Frozone", image: "assets/images/frozone.jpg", class: "Balanced", avg: 0.0, gp: 2, hr: 0, pa: 7, hits: 0, slg: 0.0, obp: 0.0, doubles: 0, triples: 0 },
  { name: "Funky Kong", image: "assets/images/funky kong.png", class: "Power", avg: 0.439, gp: 22, hr: 13, pa: 81, hits: 35, slg: 1.068, obp: 0.504, doubles: 0, triples: 2 },
  ...
  { name: "Green Dry Bones", image: "assets/images/green dry bones.png", class: "Balanced", avg: 0.486, gp: 22, hr: 7, pa: 81, hits: 39, slg: 0.827, obp: 0.531, doubles: 1, triples: 1 },
  { name: "Green Magikoopa", image: "assets/images/green magikoopa.png", class: "Balanced", avg: 0.503, gp: 22, hr: 2, pa: 73, hits: 36, slg: 0.685, obp: 0.575, doubles: 2, triples: 0 },
  ...
  { name: "Green Shy Guy", image: "assets/images/green shy guy.png", class: "Technique", avg: 0.28, gp: 20, hr: 0, pa: 66, hits: 18, slg: 0.352, obp: 0.315, doubles: 1, triples: 1 },
  { name: "Green Toad", image: "assets/images/green toad.png", class: "Speed", avg: 0.594, gp: 22, hr: 2, pa: 80, hits: 47, slg: 0.907, obp: 0.659, doubles: 8, triples: 2 },
  { name: "Hammer Bro", image: "assets/images/hammer bro.png", class: "Power", avg: 0.481, gp: 22, hr: 18, pa: 78, hits: 37, slg: 1.199, obp: 0.507, doubles: 1, triples: 0 },
  ...
  { name: "Kevin G", image: "assets/images/keving.jpg", class: "Balanced", avg: 0.0, gp: 3, hr: 0, pa: 10, hits: 0, slg: 0.0, obp: 0.0, doubles: 0, triples: 0 },
  { name: "King Boo", image: "assets/images/king boo.png", class: "Power", avg: 0.473, gp: 22, hr: 14, pa: 79, hits: 37, slg: 1.066, obp: 0.473, doubles: 2, triples: 0 },
  { name: "King K Rool", image: "assets/images/king k rool.png", class: "Power", avg: 0.529, gp: 22, hr: 22, pa: 90, hits: 47, slg: 1.375, obp: 0.578, doubles: 3, triples: 0 },
  { name: "Koopa Paratroopa", image: "assets/images/koopa paratroopa.png", class: "Balanced", avg: 0.269, gp: 18, hr: 1, pa: 68, hits: 18, slg: 0.367, obp: 0.309, doubles: 1, triples: 0 },
  ...
  { name: "Kritter", image: "assets/images/kritter.png", class: "Power", avg: 0.536, gp: 22, hr: 14, pa: 91, hits: 48, slg: 1.198, obp: 0.593, doubles: 11, triples: 1 },
  { name: "Lara Croft", image: "assets/images/lara croft.jpg", class: "Balanced", avg: 0.241, gp: 12, hr: 0, pa: 40, hits: 9, slg: 0.35, obp: 0.35, doubles: 0, triples: 0 },
  { name: "Lebron James", image: "assets/images/lebron james.jpg", class: "Balanced", avg: 0.0, gp: 2, hr: 0, pa: 8, hits: 0, slg: 0.0, obp: 0.0, doubles: 0, triples: 0 },
  ...
  { name: "Lilo", image: "assets/images/lilo.jpg", class: "Balanced", avg: 0.383, gp: 12, hr: 1, pa: 40, hits: 15, slg: 0.575, obp: 0.425, doubles: 1, triples: 1 },
  { name: "Livvy Dunne", image: "assets/images/livvy dunne.jpg", class: "Balanced", avg: 0.082, gp: 2, hr: 0, pa: 7, hits: 0, slg: 0.571, obp: 0.571, doubles: 0, triples: 0 },
  { name: "Lizzy", image: "assets/images/lizzy.jpg", class: "Balanced", avg: 0.222, gp: 1, hr: 0, pa: 3, hits: 0, slg: 0.667, obp: 0.667, doubles: 0, triples: 0 },
  { name: "Luigi", image: "assets/images/luigi.png", class: "Speed", avg: 0.452, gp: 22, hr: 0, pa: 81, hits: 36, slg: 0.544, obp: 0.507, doubles: 1, triples: 1 },
  ...
  { name: "Magikoopa", image: "assets/images/magikoopa.png", class: "Balanced", avg: 0.466, gp: 22, hr: 2, pa: 74, hits: 34, slg: 0.608, obp: 0.5, doubles: 2, triples: 0 },
  { name: "Mario", image: "assets/images/mario.png", class: "Balanced", avg: 0.534, gp: 22, hr: 3, pa: 80, hits: 42, slg: 0.771, obp: 0.602, doubles: 2, triples: 1 },
  ...
  { name: "Mikasa", image: "assets/images/mikasa.jpg", class: "Balanced", avg: 0.348, gp: 12, hr: 0, pa: 47, hits: 16, slg: 0.424, obp: 0.41, doubles: 1, triples: 0 },
  { name: "Minion", image: "assets/images/minion.jpg", class: "Balanced", avg: 0.37, gp: 20, hr: 0, pa: 71, hits: 26, slg: 0.409, obp: 0.394, doubles: 1, triples: 0 },
  ...
  { name: "Miss Hot", image: "assets/images/miss hot.jpg", class: "Balanced", avg: 0.479, gp: 22, hr: 2, pa: 74, hits: 35, slg: 0.672, obp: 0.514, doubles: 5, triples: 0 },
  { name: "Monty Mole", image: "assets/images/monty mole.png", class: "Speed", avg: 0.062, gp: 2, hr: 0, pa: 8, hits: 0, slg: 0.5, obp: 0.5, doubles: 0, triples: 0 },
  { name: "Mr. Incredible", image: "assets/images/mr incredible.jpg", class: "Balanced", avg: 0.343, gp: 22, hr: 0, pa: 77, hits: 26, slg: 0.414, obp: 0.388, doubles: 2, triples: 0 },
  ...
  { name: "Peach", image: "assets/images/peach.png", class: "Balanced", avg: 0.306, gp: 22, hr: 0, pa: 77, hits: 23, slg: 0.417, obp: 0.35, doubles: 5, triples: 0 },
  { name: "Petey Piranha", image: "assets/images/petey piranha.png", class: "Power", avg: 0.401, gp: 22, hr: 17, pa: 84, hits: 33, slg: 1.072, obp: 0.452, doubles: 1, triples: 0 },
  { name: "Pianta", image: "assets/images/pianta.png", class: "Speed", avg: 0.565, gp: 22, hr: 3, pa: 79, hits: 44, slg: 0.694, obp: 0.594, doubles: 0, triples: 0 },
  { name: "Pink Yoshi", image: "assets/images/pink yoshi.png", class: "Speed", avg: 0.561, gp: 13, hr: 0, pa: 44, hits: 24, slg: 0.697, obp: 0.66, doubles: 2, triples: 0 },
  { name: "Purple Toad", image: "assets/images/purple toad.png", class: "Speed", avg: 0.462, gp: 4, hr: 0, pa: 13, hits: 6, slg: 1.013, obp: 0.846, doubles: 1, triples: 0 },
  ...
  { name: "Red Koopa Troopa", image: "assets/images/red koopa troopa.png", class: "Speed", avg: 0.262, gp: 8, hr: 1, pa: 28, hits: 7, slg: 0.5, obp: 0.357, doubles: 1, triples: 0 },
  { name: "Red Kritter", image: "assets/images/red kritter.png", class: "Power", avg: 0.417, gp: 22, hr: 8, pa: 83, hits: 34, slg: 0.823, obp: 0.468, doubles: 3, triples: 0 },
  { name: "Red Magikoopa", image: "assets/images/red magikoopa.png", class: "Balanced", avg: 0.391, gp: 21, hr: 0, pa: 75, hits: 29, slg: 0.447, obp: 0.432, doubles: 1, triples: 0 },
  ...
  { name: "Red Pianta", image: "assets/images/red pianta.png", class: "Speed", avg: 0.543, gp: 22, hr: 4, pa: 82, hits: 44, slg: 0.814, obp: 0.613, doubles: 4, triples: 0 },
  { name: "Red Yoshi", image: "assets/images/red yoshi.png", class: "Speed", avg: 0.328, gp: 15, hr: 1, pa: 53, hits: 17, slg: 0.434, obp: 0.378, doubles: 0, triples: 0 },
  { name: "Rizzler", image: "assets/images/rizzler.jpg", class: "Balanced", avg: 0.062, gp: 2, hr: 0, pa: 8, hits: 0, slg: 0.5, obp: 0.5, doubles: 0, triples: 0 },
  { name: "Saddam Hussein", image: "assets/images/saddam hussein.jpg", class: "Balanced", avg: 0.03, gp: 2, hr: 0, pa: 10, hits: 0, slg: 0.3, obp: 0.3, doubles: 0, triples: 0 },
  ...
  { name: "Tiny Kong", image: "assets/images/tiny kong.png", class: "Balanced", avg: 0.444, gp: 22, hr: 1, pa: 86, hits: 38, slg: 0.535, obp: 0.454, doubles: 2, triples: 1 },
  { name: "Toad", image: "assets/images/toad.jpg", class: "Balanced", avg: 0.607, gp: 14, hr: 0, pa: 52, hits: 31, slg: 0.711, obp: 0.692, doubles: 1, triples: 0 },
  { name: "Toadette", image: "assets/images/toadette.png", class: "Balanced", avg: 0.298, gp: 20, hr: 0, pa: 69, hits: 20, slg: 0.406, obp: 0.347, doubles: 2, triples: 1 },
  ...
  { name: "Trinity", image: "assets/images/trinity.jpg", class: "Balanced", avg: 0.351, gp: 12, hr: 1, pa: 41, hits: 14, slg: 0.512, obp: 0.414, doubles: 1, triples: 0 },
  { name: "Tsitsipas", image: "assets/images/tsitsipas.jpg", class: "Balanced", avg: 0.111, gp: 1, hr: 0, pa: 3, hits: 0, slg: 0.667, obp: 0.333, doubles: 1, triples: 0 },
  { name: "Unc", image: "assets/images/unc.jpg", class: "Balanced", avg: 0.487, gp: 22, hr: 4, pa: 83, hits: 40, slg: 0.703, obp: 0.543, doubles: 1, triples: 0 },
  { name: "Waluigi", image: "assets/images/waluigi.png", class: "Technique", avg: 0.502, gp: 22, hr: 0, pa: 79, hits: 39, slg: 0.665, obp: 0.563, doubles: 8, triples: 0 },
  { name: "Wario", image: "assets/images/wario.png", class: "Technique", avg: 0.585, gp: 22, hr: 5, pa: 88, hits: 51, slg: 0.943, obp: 0.676, doubles: 1, triples: 0 },
  { name: "Wiggler", image: "assets/images/wiggler.png", class: "Speed", avg: 0.662, gp: 22, hr: 1, pa: 90, hits: 59, slg: 0.854, obp: 0.711, doubles: 7, triples: 1 },
  ...
  { name: "Yellow Pianta", image: "assets/images/yellow pianta.png", class: "Speed", avg: 0.514, gp: 22, hr: 1, pa: 87, hits: 44, slg: 0.635, obp: 0.582, doubles: 1, triples: 0 },
  { name: "Yellow Shy Guy", image: "assets/images/yellow shy guy.png", class: "Technique", avg: 0.185, gp: 8, hr: 0, pa: 29, hits: 5, slg: 0.276, obp: 0.276, doubles: 0, triples: 0 },
  { name: "Yellow Toad", image: "assets/images/yellow toad.png", class: "Speed", avg: 0.534, gp: 20, hr: 2, pa: 80, hits: 42, slg: 0.75, obp: 0.6, doubles: 4, triples: 1 },
  { name: "Yellow Yoshi", image: "assets/images/yellow yoshi.png", class: "Speed", avg: 0.078, gp: 2, hr: 0, pa: 8, hits: 0, slg: 0.625, obp: 0.625, doubles: 0, triples: 0 },
  ...
  { name: "Yoshi", image: "assets/images/yoshi.png", class: "Speed", avg: 0.331, gp: 22, hr: 2, pa: 86, hits: 28, slg: 0.461, obp: 0.366, doubles: 2, triples: 0 },
...
if (characterGrid) {
  ...
  const pitchingStats = {
    ...
    "Birdo": { ip: 55, era: 2.62, baa: 0.416, so: 15 },
    ...
    "Boo": { ip: 72, era: 5.43, baa: 0.503, so: 7 },
    "Boomerang Bro": { ip: 2, era: 3.0, baa: 0.583, so: 0 },
    "Bowser": { ip: 59, era: 4.76, baa: 0.473, so: 21 },
    "Bowser Jr": { ip: 45, era: 8.19, baa: 0.511, so: 18 },
    "Caillou": { ip: 2, era: 5.25, baa: 0.385, so: 0 },
    "Carby": { ip: 3, era: 0.0, baa: 0.588, so: 3 },
    "Chicken": { ip: 2, era: 9.0, baa: 0.462, so: 0 },
    "Chickenrice": { ip: 1, era: 5.25, baa: 0.625, so: 0 },
    "Daisy": { ip: 65, era: 6.03, baa: 0.463, so: 17 },
    "Dark Bones": { ip: 6, era: 0.0, baa: 0.417, so: 8 },
    "Diddy Kong": { ip: 48, era: 7.19, baa: 0.498, so: 14 },
    "Dixie Kong": { ip: 3, era: 0.0, baa: 0.286, so: 1 },
    "Donkey Kong": { ip: 73, era: 6.2, baa: 0.492, so: 9 },
    ...
    "Green Magikoopa": { ip: 12, era: 11.25, baa: 0.545, so: 1 },
    "Hammer Bro": { ip: 2, era: 17.5, baa: 0.639, so: 84 },
    "John K": { ip: 5, era: 9.8, baa: 0.542, so: 0 },
    "King Boo": { ip: 19, era: 6.78, baa: 0.53, so: 0 },
    ...
    "Lebron James": { ip: 1, era: 0.0, baa: 0.286, so: 8 },
    "Luigi": { ip: 94, era: 6.11, baa: 0.467, so: 7 },
    "Magikoopa": { ip: 23, era: 7.91, baa: 0.477, so: 3 },
    "Mario": { ip: 87, era: 5.84, baa: 0.469, so: 18 },
    ...
    "Monty Mole": { ip: 4, era: 0.0, baa: 0.526, so: 4 },
    "Mr. Incredible": { ip: 12, era: 0.58, baa: 0.463, so: 4 },
    "Mrs.Claus": { ip: 4, era: 3.23, baa: 0.313, so: 0 },
    "Paragoomba": { ip: 27, era: 5.84, baa: 0.422, so: 0 },
    "Peach": { ip: 75, era: 5.52, baa: 0.452, so: 18 },
    "Red Kritter": { ip: 5, era: 11.55, baa: 0.585, so: 0 },
    "Red Magikoopa": { ip: 38, era: 7.5, baa: 0.5, so: 17 },
    ...
    "Trinity": { ip: 48, era: 2.0, baa: 0.429, so: 8 },
    "Unc": { ip: 6, era: 1.75, baa: 0.568, so: 5 },
    "Waluigi": { ip: 37, era: 5.3, baa: 0.444, so: 1 },
    "Wario": { ip: 36, era: 7.94, baa: 0.5, so: 10 },
    ...
    "Yellow Yoshi": { ip: 1, era: 0.0, baa: 0.7, so: 26 },
