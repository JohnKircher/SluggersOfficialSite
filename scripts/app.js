...
const characters = [
  { name: "Baby DK", image: "assets/images/baby dk.png", class: "Speed", avg: 0.494, gp: 23, hr: 3, pa: 89, hits: 44, slg: 0.668, obp: 0.506, doubles: 3, triples: 1 },
  { name: "Baby Daisy", image: "assets/images/baby daisy.png", class: "Power", avg: 0.426, gp: 15, hr: 0, pa: 54, hits: 23, slg: 0.5, obp: 0.419, doubles: 2, triples: 1 },
  ...
  { name: "Birdo", image: "assets/images/birdo.png", class: "Power", avg: 0.547, gp: 23, hr: 8, pa: 86, hits: 47, slg: 0.871, obp: 0.558, doubles: 3, triples: 0 },
  ...
  { name: "Blue Dry Bones", image: "assets/images/blue dry bones.png", class: "Balanced", avg: 0.625, gp: 23, hr: 5, pa: 88, hits: 55, slg: 0.873, obp: 0.622, doubles: 5, triples: 0 },
  { name: "Blue Kritter", image: "assets/images/blue kritter.png", class: "Power", avg: 0.452, gp: 23, hr: 6, pa: 84, hits: 38, slg: 0.636, obp: 0.424, doubles: 1, triples: 0 },
  { name: "Blue Shy Guy", image: "assets/images/blue shy guy.png", class: "Technique", avg: 0.143, gp: 7, hr: 0, pa: 21, hits: 3, slg: 0.143, obp: 0.143, doubles: 0, triples: 0 },
  { name: "Blue Toad", image: "assets/images/blue toad.png", class: "Speed", avg: 0.581, gp: 17, hr: 2, pa: 62, hits: 36, slg: 0.774, obp: 0.581, doubles: 6, triples: 0 },
  ...
  { name: "Boo", image: "assets/images/boo.png", class: "Speed", avg: 0.613, gp: 22, hr: 0, pa: 75, hits: 46, slg: 0.667, obp: 0.613, doubles: 4, triples: 0 },
  { name: "Boomerang Bro", image: "assets/images/boomerang bro.png", class: "Power", avg: 0.524, gp: 23, hr: 14, pa: 84, hits: 44, slg: 1.048, obp: 0.524, doubles: 2, triples: 0 },
  { name: "Borat", image: "assets/images/borat.jpg", class: "Balanced", avg: 0.44, gp: 23, hr: 0, pa: 91, hits: 40, slg: 0.483, obp: 0.439, doubles: 4, triples: 0 },
  { name: "Bowser Jr", image: "assets/images/bowser jr.png", class: "Technique", avg: 0.437, gp: 23, hr: 3, pa: 87, hits: 38, slg: 0.56, obp: 0.437, doubles: 1, triples: 0 },
  { name: "Bowser", image: "assets/images/bowser.png", class: "Power", avg: 0.567, gp: 23, hr: 25, pa: 97, hits: 55, slg: 1.42, obp: 0.567, doubles: 4, triples: 1 },
  { name: "Brown Kritter", image: "assets/images/brown kritter.png", class: "Power", avg: 0.451, gp: 23, hr: 11, pa: 82, hits: 37, slg: 0.942, obp: 0.463, doubles: 4, triples: 1 },
  ...
  { name: "Carby", image: "assets/images/carby.jpg", class: "Balanced", avg: 0.6, gp: 3, hr: 1, pa: 15, hits: 9, slg: 0.8, obp: 0.6, doubles: 0, triples: 0 },
  { name: "Chicken", image: "assets/images/chicken.jpg", class: "Balanced", avg: 0.42, gp: 19, hr: 0, pa: 69, hits: 29, slg: 0.435, obp: 0.42, doubles: 1, triples: 0 },
  ...
  { name: "Daisy", image: "assets/images/daisy.png", class: "Power", avg: 0.457, gp: 21, hr: 4, pa: 81, hits: 37, slg: 0.687, obp: 0.457, doubles: 6, triples: 0 },
  { name: "Dark Bones", image: "assets/images/dark bones.png", class: "Balanced", avg: 0.667, gp: 23, hr: 7, pa: 93, hits: 62, slg: 0.969, obp: 0.676, doubles: 7, triples: 0 },
  { name: "Diddy Kong", image: "assets/images/diddy kong.png", class: "Technique", avg: 0.489, gp: 23, hr: 1, pa: 90, hits: 44, slg: 0.605, obp: 0.489, doubles: 7, triples: 0 },
  { name: "Dixie Kong", image: "assets/images/dixie kong.png", class: "Balanced", avg: 0.575, gp: 11, hr: 1, pa: 40, hits: 23, slg: 0.7, obp: 0.575, doubles: 2, triples: 0 },
  { name: "Donkey Kong", image: "assets/images/donkey kong.png", class: "Power", avg: 0.629, gp: 23, hr: 19, pa: 89, hits: 56, slg: 1.311, obp: 0.629, doubles: 3, triples: 0 },
  { name: "Dry Bones", image: "assets/images/dry bones.png", class: "Balanced", avg: 0.64, gp: 23, hr: 9, pa: 86, hits: 55, slg: 1.046, obp: 0.64, doubles: 7, triples: 0 },
  { name: "Dwayne Wade", image: "assets/images/dwayne wade.jpg", class: "Balanced", avg: 0.452, gp: 23, hr: 1, pa: 73, hits: 33, slg: 0.493, obp: 0.452, doubles: 0, triples: 0 },
  ...
  { name: "Fire Bro", image: "assets/images/fire bro.png", class: "Power", avg: 0.582, gp: 23, hr: 26, pa: 91, hits: 53, slg: 1.457, obp: 0.582, doubles: 3, triples: 0 },
  { name: "Frozone", image: "assets/images/frozone.jpg", class: "Balanced", avg: 0.182, gp: 3, hr: 0, pa: 11, hits: 2, slg: 0.182, obp: 0.182, doubles: 0, triples: 0 },
  { name: "Funky Kong", image: "assets/images/funky kong.png", class: "Power", avg: 0.482, gp: 23, hr: 14, pa: 85, hits: 41, slg: 1.076, obp: 0.504, doubles: 0, triples: 2 },
  ...
  { name: "Green Dry Bones", image: "assets/images/green dry bones.png", class: "Balanced", avg: 0.523, gp: 23, hr: 8, pa: 86, hits: 45, slg: 0.837, obp: 0.523, doubles: 1, triples: 1 },
  { name: "Green Magikoopa", image: "assets/images/green magikoopa.png", class: "Balanced", avg: 0.566, gp: 23, hr: 2, pa: 76, hits: 43, slg: 0.671, obp: 0.566, doubles: 2, triples: 0 },
  ...
  { name: "Green Shy Guy", image: "assets/images/green shy guy.png", class: "Technique", avg: 0.319, gp: 21, hr: 0, pa: 69, hits: 22, slg: 0.337, obp: 0.301, doubles: 1, triples: 1 },
  { name: "Green Toad", image: "assets/images/green toad.png", class: "Speed", avg: 0.651, gp: 23, hr: 2, pa: 83, hits: 54, slg: 0.899, obp: 0.659, doubles: 8, triples: 2 },
  { name: "Hammer Bro", image: "assets/images/hammer bro.png", class: "Power", avg: 0.53, gp: 23, hr: 19, pa: 83, hits: 44, slg: 1.199, obp: 0.512, doubles: 1, triples: 0 },
  ...
  { name: "KevinG", image: "assets/images/keving.jpg", class: "Balanced", avg: 0.133, gp: 4, hr: 2, pa: 15, hits: 2, slg: 0.534, obp: 0.134, doubles: 0, triples: 0 },
  { name: "King Boo", image: "assets/images/king boo.png", class: "Power", avg: 0.506, gp: 23, hr: 15, pa: 83, hits: 42, slg: 1.087, obp: 0.486, doubles: 2, triples: 0 },
  { name: "King K Rool", image: "assets/images/king k rool.png", class: "Power", avg: 0.585, gp: 23, hr: 23, pa: 94, hits: 55, slg: 1.39, obp: 0.585, doubles: 4, triples: 0 },
  { name: "Koopa Paratroopa", image: "assets/images/koopa paratroopa.png", class: "Balanced", avg: 0.324, gp: 19, hr: 1, pa: 71, hits: 23, slg: 0.38, obp: 0.324, doubles: 1, triples: 0 },
  ...
  { name: "Kritter", image: "assets/images/kritter.png", class: "Power", avg: 0.589, gp: 23, hr: 16, pa: 95, hits: 56, slg: 1.231, obp: 0.589, doubles: 11, triples: 1 },
  { name: "Lara Croft", image: "assets/images/lara croft.jpg", class: "Balanced", avg: 0.349, gp: 13, hr: 0, pa: 43, hits: 15, slg: 0.349, obp: 0.349, doubles: 0, triples: 0 },
  { name: "Lebron James", image: "assets/images/lebron james.jpg", class: "Balanced", avg: 0.167, gp: 3, hr: 0, pa: 12, hits: 2, slg: 0.182, obp: 0.182, doubles: 0, triples: 0 },
  ...
  { name: "Lilo", image: "assets/images/lilo.jpg", class: "Balanced", avg: 0.442, gp: 13, hr: 1, pa: 43, hits: 19, slg: 0.582, obp: 0.442, doubles: 1, triples: 1 },
  { name: "Livvy Dunne", image: "assets/images/livvy dunne.jpg", class: "Balanced", avg: 0.583, gp: 3, hr: 0, pa: 12, hits: 7, slg: 0.583, obp: 0.583, doubles: 0, triples: 0 },
  ...
  { name: "Luigi", image: "assets/images/luigi.png", class: "Speed", avg: 0.494, gp: 23, hr: 0, pa: 85, hits: 42, slg: 0.53, obp: 0.494, doubles: 1, triples: 1 },
  ...
  { name: "Magikoopa", image: "assets/images/magikoopa.png", class: "Balanced", avg: 0.494, gp: 23, hr: 2, pa: 77, hits: 38, slg: 0.598, obp: 0.493, doubles: 2, triples: 0 },
  { name: "Mario", image: "assets/images/mario.png", class: "Balanced", avg: 0.595, gp: 23, hr: 3, pa: 84, hits: 50, slg: 0.758, obp: 0.597, doubles: 2, triples: 1 },
  ...
  { name: "Mikasa", image: "assets/images/mikasa.jpg", class: "Balanced", avg: 0.373, gp: 13, hr: 0, pa: 51, hits: 19, slg: 0.39, obp: 0.378, doubles: 1, triples: 0 },
  { name: "Minion", image: "assets/images/minion.jpg", class: "Balanced", avg: 0.392, gp: 21, hr: 0, pa: 74, hits: 29, slg: 0.419, obp: 0.392, doubles: 2, triples: 0 },
  ...
  { name: "Miss Hot", image: "assets/images/miss hot.jpg", class: "Balanced", avg: 0.494, gp: 23, hr: 2, pa: 79, hits: 39, slg: 0.642, obp: 0.494, doubles: 5, triples: 0 },
  { name: "Monty Mole", image: "assets/images/monty mole.png", class: "Speed", avg: 0.5, gp: 3, hr: 0, pa: 10, hits: 5, slg: 0.5, obp: 0.5, doubles: 0, triples: 0 },
  { name: "Mr. Incredible", image: "assets/images/mr incredible.jpg", class: "Balanced", avg: 0.395, gp: 23, hr: 0, pa: 81, hits: 32, slg: 0.446, obp: 0.407, doubles: 3, triples: 0 },
  ...
  { name: "Peach", image: "assets/images/peach.png", class: "Balanced", avg: 0.375, gp: 23, hr: 0, pa: 80, hits: 30, slg: 0.414, obp: 0.35, doubles: 5, triples: 0 },
  { name: "Petey Piranha", image: "assets/images/petey piranha.png", class: "Power", avg: 0.455, gp: 23, hr: 19, pa: 88, hits: 40, slg: 1.114, obp: 0.454, doubles: 1, triples: 0 },
  { name: "Pianta", image: "assets/images/pianta.png", class: "Speed", avg: 0.639, gp: 23, hr: 4, pa: 83, hits: 53, slg: 0.745, obp: 0.614, doubles: 0, triples: 0 },
  { name: "Pink Yoshi", image: "assets/images/pink yoshi.png", class: "Speed", avg: 0.583, gp: 14, hr: 0, pa: 48, hits: 28, slg: 0.701, obp: 0.646, doubles: 3, triples: 0 },
  { name: "Purple Toad", image: "assets/images/purple toad.png", class: "Speed", avg: 0.75, gp: 5, hr: 0, pa: 16, hits: 12, slg: 0.937, obp: 0.75, doubles: 2, triples: 0 },
  ...
  { name: "Red Koopa Troopa", image: "assets/images/red koopa troopa.png", class: "Speed", avg: 0.424, gp: 9, hr: 1, pa: 33, hits: 14, slg: 0.545, obp: 0.424, doubles: 1, triples: 0 },
  { name: "Red Kritter", image: "assets/images/red kritter.png", class: "Power", avg: 0.46, gp: 23, hr: 8, pa: 87, hits: 40, slg: 0.797, obp: 0.458, doubles: 3, triples: 0 },
  { name: "Red Magikoopa", image: "assets/images/red magikoopa.png", class: "Balanced", avg: 0.438, gp: 22, hr: 0, pa: 80, hits: 35, slg: 0.457, obp: 0.443, doubles: 1, triples: 0 },
  ...
  { name: "Red Pianta", image: "assets/images/red pianta.png", class: "Speed", avg: 0.593, gp: 23, hr: 4, pa: 86, hits: 51, slg: 0.8, obp: 0.608, doubles: 4, triples: 0 },
  { name: "Red Yoshi", image: "assets/images/red yoshi.png", class: "Speed", avg: 0.379, gp: 16, hr: 1, pa: 58, hits: 22, slg: 0.431, obp: 0.38, doubles: 0, triples: 0 },
  { name: "Rizzler", image: "assets/images/rizzler.jpg", class: "Balanced", avg: 0.417, gp: 3, hr: 0, pa: 12, hits: 5, slg: 0.417, obp: 0.417, doubles: 0, triples: 0 },
  { name: "Saddam Hussein", image: "assets/images/saddam hussein.jpg", class: "Balanced", avg: 0.385, gp: 3, hr: 0, pa: 13, hits: 5, slg: 0.385, obp: 0.385, doubles: 0, triples: 0 },
  ...
  { name: "Tiny Kong", image: "assets/images/tiny kong.png", class: "Balanced", avg: 0.456, gp: 23, hr: 1, pa: 90, hits: 41, slg: 0.533, obp: 0.456, doubles: 2, triples: 1 },
  { name: "Toad", image: "assets/images/toad.jpg", class: "Balanced", avg: 0.696, gp: 15, hr: 0, pa: 56, hits: 39, slg: 0.714, obp: 0.696, doubles: 1, triples: 0 },
  { name: "Toadette", image: "assets/images/toadette.png", class: "Balanced", avg: 0.361, gp: 21, hr: 0, pa: 72, hits: 26, slg: 0.417, obp: 0.361, doubles: 2, triples: 1 },
  ...
  { name: "Trinity", image: "assets/images/trinity.jpg", class: "Balanced", avg: 0.409, gp: 13, hr: 1, pa: 44, hits: 18, slg: 0.5, obp: 0.409, doubles: 1, triples: 0 },
  ...
  { name: "Unc", image: "assets/images/unc.jpg", class: "Balanced", avg: 0.512, gp: 23, hr: 4, pa: 86, hits: 44, slg: 0.679, obp: 0.524, doubles: 1, triples: 0 },
  { name: "Waluigi", image: "assets/images/waluigi.png", class: "Technique", avg: 0.549, gp: 23, hr: 0, pa: 82, hits: 45, slg: 0.665, obp: 0.555, doubles: 9, triples: 0 },
  { name: "Wario", image: "assets/images/wario.png", class: "Technique", avg: 0.609, gp: 23, hr: 5, pa: 92, hits: 56, slg: 0.913, obp: 0.657, doubles: 1, triples: 0 },
  { name: "Wiggler", image: "assets/images/wiggler.png", class: "Speed", avg: 0.713, gp: 23, hr: 1, pa: 94, hits: 67, slg: 0.849, obp: 0.713, doubles: 7, triples: 1 },
  ...
  { name: "Yellow Pianta", image: "assets/images/yellow pianta.png", class: "Speed", avg: 0.582, gp: 23, hr: 1, pa: 91, hits: 53, slg: 0.651, obp: 0.589, doubles: 2, triples: 0 },
  { name: "Yellow Shy Guy", image: "assets/images/yellow shy guy.png", class: "Technique", avg: 0.312, gp: 9, hr: 0, pa: 32, hits: 10, slg: 0.312, obp: 0.312, doubles: 0, triples: 0 },
  { name: "Yellow Toad", image: "assets/images/yellow toad.png", class: "Speed", avg: 0.583, gp: 21, hr: 2, pa: 84, hits: 49, slg: 0.736, obp: 0.583, doubles: 4, triples: 1 },
  { name: "Yellow Yoshi", image: "assets/images/yellow yoshi.png", class: "Speed", avg: 0.5, gp: 3, hr: 0, pa: 12, hits: 6, slg: 0.5, obp: 0.5, doubles: 0, triples: 0 },
  ...
  { name: "Yoshi", image: "assets/images/yoshi.png", class: "Speed", avg: 0.348, gp: 23, hr: 2, pa: 89, hits: 31, slg: 0.445, obp: 0.354, doubles: 2, triples: 0 },
...
if (characterGrid) {
  ...
  const pitchingStats = {
    ...
    "Birdo": { ip: 58, era: 2.59, baa: 0.417, so: 15 },
    ...
    "Blue Shy Guy": { ip: 2, era: 0.0, baa: 0.625, so: 18 },
    "Blue Toad": { ip: 2, era: 6.0, baa: 0.667, so: 0 },
    "Boo": { ip: 75, era: 5.21, baa: 0.501, so: 9 },
    "Boomerang Bro": { ip: 2, era: 3.0, baa: 0.583, so: 0 },
    "Bowser": { ip: 60, era: 4.73, baa: 0.472, so: 22 },
    "Bowser Jr": { ip: 48, era: 7.68, baa: 0.506, so: 11 },
    ...
    "Daisy": { ip: 69, era: 5.68, baa: 0.464, so: 12 },
    "Dark Bones": { ip: 11, era: 0.0, baa: 0.392, so: 5 },
    "Diddy Kong": { ip: 50, era: 6.9, baa: 0.492, so: 7 },
    "Dixie Kong": { ip: 3, era: 0.0, baa: 0.286, so: 1 },
    "Donkey Kong": { ip: 78, era: 5.8, baa: 0.487, so: 7 },
    ...
    "King Boo": { ip: 22, era: 5.85, baa: 0.5, so: 1 },
    ...
    "Lebron James": { ip: 2, era: 0.0, baa: 0.222, so: 6 },
    "Lilo": { ip: 2, era: 0.0, baa: 0.429, so: 3 },
    "Luigi": { ip: 94, era: 6.11, baa: 0.475, so: 13 },
    "Magikoopa": { ip: 24, era: 7.58, baa: 0.495, so: 4 },
    "Mario": { ip: 87, era: 5.84, baa: 0.469, so: 18 },
    "Mikasa": { ip: 1, era: 21.0, baa: 0.727, so: 0 },
    "Minion": { ip: 10, era: 11.9, baa: 0.528, so: 32 },
    "Miss Casey": { ip: 5, era: 13.59, baa: 0.529, so: 0 },
    "Miss Hot": { ip: 1, era: 0.0, baa: 0.0, so: 0 },
    "Monty Mole": { ip: 9, era: 0.0, baa: 0.465, so: 5 },
    "Mr. Incredible": { ip: 19, era: 0.37, baa: 0.477, so: 3 },
    "Mrs.Claus": { ip: 4, era: 3.23, baa: 0.313, so: 0 },
    "Paragoomba": { ip: 27, era: 5.84, baa: 0.422, so: 0 },
    "Peach": { ip: 77, era: 5.38, baa: 0.455, so: 15 },
    ...
    "Trinity": { ip: 52, era: 1.85, baa: 0.439, so: 9 },
    "Unc": { ip: 6, era: 1.75, baa: 0.568, so: 5 },
    "Waluigi": { ip: 39, era: 5.08, baa: 0.451, so: 1 },
    ...
    "Yellow Yoshi": { ip: 4, era: 0.0, baa: 0.591, so: 12 },
