...
const characters = [
  { name: "Baby DK", image: "assets/images/baby dk.png", class: "Speed", avg: 0.485, gp: 52, hr: 6, pa: 200, hits: 97, slg: 0.628, obp: 0.49, doubles: 7, triples: 1 },
  ...
  { name: "Birdo", image: "assets/images/birdo.png", class: "Power", avg: 0.553, gp: 52, hr: 29, pa: 206, hits: 114, slg: 1.02, obp: 0.558, doubles: 7, triples: 0 },
  { name: "Black Shy Guy", image: "assets/images/black shy guy.png", class: "Technique", avg: 0.374, gp: 27, hr: 0, pa: 91, hits: 34, slg: 0.393, obp: 0.371, doubles: 2, triples: 0 },
  ...
  { name: "Blooper", image: "assets/images/blooper.png", class: "Balanced", avg: 0.571, gp: 40, hr: 0, pa: 156, hits: 89, slg: 0.65, obp: 0.574, doubles: 8, triples: 1 },
  { name: "Blue Dry Bones", image: "assets/images/blue dry bones.png", class: "Balanced", avg: 0.623, gp: 52, hr: 9, pa: 207, hits: 129, slg: 0.844, obp: 0.625, doubles: 11, triples: 2 },
  { name: "Blue Kritter", image: "assets/images/blue kritter.png", class: "Power", avg: 0.552, gp: 52, hr: 21, pa: 201, hits: 111, slg: 0.927, obp: 0.54, doubles: 9, triples: 3 },
  ...
  { name: "Blue Toad", image: "assets/images/blue toad.png", class: "Speed", avg: 0.604, gp: 46, hr: 4, pa: 182, hits: 110, slg: 0.731, obp: 0.604, doubles: 9, triples: 1 },
  ...
  { name: "Boo", image: "assets/images/boo.png", class: "Speed", avg: 0.496, gp: 41, hr: 1, pa: 137, hits: 68, slg: 0.562, obp: 0.496, doubles: 6, triples: 0 },
  { name: "Boomerang Bro", image: "assets/images/boomerang bro.png", class: "Power", avg: 0.48, gp: 52, hr: 25, pa: 198, hits: 95, slg: 0.89, obp: 0.485, doubles: 3, triples: 1 },
  ...
  { name: "Bowser Jr", image: "assets/images/bowser jr.png", class: "Technique", avg: 0.472, gp: 52, hr: 4, pa: 199, hits: 94, slg: 0.604, obp: 0.472, doubles: 12, triples: 0 },
  { name: "Bowser", image: "assets/images/bowser.png", class: "Power", avg: 0.608, gp: 52, hr: 62, pa: 222, hits: 135, slg: 1.584, obp: 0.608, doubles: 19, triples: 5 },
  { name: "Brown Kritter", image: "assets/images/brown kritter.png", class: "Power", avg: 0.487, gp: 52, hr: 36, pa: 199, hits: 97, slg: 1.115, obp: 0.492, doubles: 9, triples: 1 },
  ...
  { name: "Carby", image: "assets/images/carby.jpg", class: "Balanced", avg: 0.488, gp: 32, hr: 4, pa: 129, hits: 63, slg: 0.69, obp: 0.492, doubles: 8, triples: 2 },
  { name: "Chicken", image: "assets/images/chicken.jpg", class: "Balanced", avg: 0.462, gp: 28, hr: 2, pa: 104, hits: 48, slg: 0.538, obp: 0.462, doubles: 2, triples: 0 },
  ...
  { name: "Daisy", image: "assets/images/daisy.png", class: "Power", avg: 0.435, gp: 50, hr: 8, pa: 193, hits: 84, slg: 0.654, obp: 0.435, doubles: 14, triples: 1 },
  { name: "Dark Bones", image: "assets/images/dark bones.png", class: "Balanced", avg: 0.668, gp: 52, hr: 18, pa: 220, hits: 147, slg: 1.0, obp: 0.672, doubles: 15, triples: 1 },
  { name: "Diddy Kong", image: "assets/images/diddy kong.png", class: "Technique", avg: 0.505, gp: 52, hr: 1, pa: 200, hits: 101, slg: 0.577, obp: 0.505, doubles: 11, triples: 0 },
  ...
  { name: "Doc Brown", image: "assets/images/doc brown.jpg", class: "Balanced", avg: 0.512, gp: 10, hr: 1, pa: 41, hits: 21, slg: 0.775, obp: 0.512, doubles: 7, triples: 0 },
  { name: "Donkey Kong", image: "assets/images/donkey kong.png", class: "Power", avg: 0.599, gp: 52, hr: 54, pa: 202, hits: 121, slg: 1.432, obp: 0.599, doubles: 5, triples: 0 },
  { name: "Dora", image: "assets/images/dora.jpg", class: "Balanced", avg: 0.429, gp: 2, hr: 0, pa: 7, hits: 3, slg: 0.429, obp: 0.429, doubles: 0, triples: 0 },
  { name: "Dry Bones", image: "assets/images/dry bones.png", class: "Balanced", avg: 0.622, gp: 52, hr: 13, pa: 201, hits: 125, slg: 0.935, obp: 0.625, doubles: 15, triples: 3 },
  { name: "Dwayne Wade", image: "assets/images/dwayne wade.jpg", class: "Balanced", avg: 0.475, gp: 52, hr: 3, pa: 183, hits: 87, slg: 0.53, obp: 0.475, doubles: 1, triples: 0 },
  ...
  { name: "Fire Bro", image: "assets/images/fire bro.png", class: "Power", avg: 0.587, gp: 52, hr: 52, pa: 208, hits: 122, slg: 1.387, obp: 0.586, doubles: 6, triples: 1 },
  ...
  { name: "Funky Kong", image: "assets/images/funky kong.png", class: "Power", avg: 0.44, gp: 52, hr: 30, pa: 200, hits: 88, slg: 0.963, obp: 0.449, doubles: 3, triples: 3 },
  ...
  { name: "Green Dry Bones", image: "assets/images/green dry bones.png", class: "Balanced", avg: 0.551, gp: 52, hr: 14, pa: 214, hits: 118, slg: 0.794, obp: 0.552, doubles: 8, triples: 1 },
  { name: "Green Magikoopa", image: "assets/images/green magikoopa.png", class: "Balanced", avg: 0.495, gp: 52, hr: 2, pa: 190, hits: 94, slg: 0.566, obp: 0.497, doubles: 7, triples: 0 },
  ...
  { name: "Green Shy Guy", image: "assets/images/green shy guy.png", class: "Technique", avg: 0.447, gp: 40, hr: 2, pa: 141, hits: 63, slg: 0.554, obp: 0.438, doubles: 8, triples: 1 },
  { name: "Green Toad", image: "assets/images/green toad.png", class: "Speed", avg: 0.602, gp: 52, hr: 2, pa: 211, hits: 127, slg: 0.735, obp: 0.608, doubles: 11, triples: 4 },
  { name: "Gus Fring", image: "assets/images/gus fring.jpg", class: "Balanced", avg: 0.255, gp: 12, hr: 0, pa: 47, hits: 12, slg: 0.304, obp: 0.261, doubles: 2, triples: 0 },
  { name: "Hammer Bro", image: "assets/images/hammer bro.png", class: "Power", avg: 0.551, gp: 52, hr: 46, pa: 196, hits: 108, slg: 1.289, obp: 0.544, doubles: 8, triples: 0 },
  ...
  { name: "John K", image: "assets/images/john k.jpg", class: "Balanced", avg: 0.351, gp: 17, hr: 0, pa: 57, hits: 20, slg: 0.351, obp: 0.351, doubles: 0, triples: 0 },
  ...
  { name: "KevinG", image: "assets/images/keving.jpg", class: "Balanced", avg: 0.384, gp: 32, hr: 4, pa: 125, hits: 48, slg: 0.532, obp: 0.384, doubles: 6, triples: 0 },
  { name: "Kim Jong Un", image: "assets/images/kim jong un.jpg", class: "Balanced", avg: 0.427, gp: 22, hr: 4, pa: 89, hits: 38, slg: 0.607, obp: 0.427, doubles: 4, triples: 0 },
  { name: "King Boo", image: "assets/images/king boo.png", class: "Power", avg: 0.553, gp: 52, hr: 32, pa: 208, hits: 115, slg: 1.044, obp: 0.545, doubles: 5, triples: 0 },
  { name: "King K Rool", image: "assets/images/king k rool.png", class: "Power", avg: 0.601, gp: 52, hr: 61, pa: 213, hits: 128, slg: 1.517, obp: 0.601, doubles: 9, triples: 0 },
  ...
  { name: "Koopa Troopa", image: "assets/images/koopa troopa.png", class: "Speed", avg: 0.386, gp: 17, hr: 0, pa: 57, hits: 22, slg: 0.445, obp: 0.392, doubles: 3, triples: 0 },
  { name: "Kritter", image: "assets/images/kritter.png", class: "Power", avg: 0.535, gp: 52, hr: 32, pa: 217, hits: 116, slg: 1.094, obp: 0.535, doubles: 17, triples: 3 },
  ...
  { name: "Lebron James", image: "assets/images/lebron james.jpg", class: "Balanced", avg: 0.39, gp: 32, hr: 6, pa: 123, hits: 48, slg: 0.567, obp: 0.392, doubles: 3, triples: 0 },
  ...
  { name: "Livvy Dunne", image: "assets/images/livvy dunne.jpg", class: "Balanced", avg: 0.51, gp: 12, hr: 0, pa: 51, hits: 26, slg: 0.51, obp: 0.51, doubles: 0, triples: 0 },
  ...
  { name: "Luigi", image: "assets/images/luigi.png", class: "Speed", avg: 0.5, gp: 52, hr: 3, pa: 200, hits: 100, slg: 0.579, obp: 0.503, doubles: 4, triples: 1 },
  ...
  { name: "Magikoopa", image: "assets/images/magikoopa.png", class: "Balanced", avg: 0.542, gp: 51, hr: 4, pa: 177, hits: 96, slg: 0.65, obp: 0.542, doubles: 5, triples: 1 },
  { name: "Mario", image: "assets/images/mario.png", class: "Balanced", avg: 0.523, gp: 52, hr: 5, pa: 197, hits: 103, slg: 0.633, obp: 0.524, doubles: 4, triples: 1 },
  { name: "Matt", image: "assets/images/matt.jpg", class: "Balanced", avg: 0.5, gp: 10, hr: 0, pa: 36, hits: 18, slg: 0.5, obp: 0.5, doubles: 0, triples: 0 },
  ...
  { name: "Miss Hot", image: "assets/images/miss hot.jpg", class: "Balanced", avg: 0.441, gp: 52, hr: 4, pa: 188, hits: 83, slg: 0.573, obp: 0.443, doubles: 9, triples: 1 },
  ...
  { name: "Paragoomba", image: "assets/images/paragoomba.png", class: "Balanced", avg: 0.311, gp: 26, hr: 0, pa: 90, hits: 28, slg: 0.325, obp: 0.314, doubles: 1, triples: 0 },
  { name: "Peach", image: "assets/images/peach.png", class: "Balanced", avg: 0.448, gp: 52, hr: 1, pa: 201, hits: 90, slg: 0.518, obp: 0.438, doubles: 9, triples: 2 },
  { name: "Petey Piranha", image: "assets/images/petey piranha.png", class: "Power", avg: 0.602, gp: 52, hr: 72, pa: 211, hits: 127, slg: 1.654, obp: 0.606, doubles: 4, triples: 0 },
  { name: "Pianta", image: "assets/images/pianta.png", class: "Speed", avg: 0.59, gp: 52, hr: 33, pa: 200, hits: 118, slg: 1.089, obp: 0.58, doubles: 4, triples: 0 },
  { name: "Pink Yoshi", image: "assets/images/pink yoshi.png", class: "Speed", avg: 0.541, gp: 25, hr: 0, pa: 85, hits: 46, slg: 0.657, obp: 0.584, doubles: 6, triples: 0 },
  ...
  { name: "Purple Toad", image: "assets/images/purple toad.png", class: "Speed", avg: 0.63, gp: 34, hr: 0, pa: 127, hits: 80, slg: 0.705, obp: 0.63, doubles: 7, triples: 1 },
  ...
  { name: "Red Kritter", image: "assets/images/red kritter.png", class: "Power", avg: 0.483, gp: 52, hr: 27, pa: 201, hits: 97, slg: 0.944, obp: 0.482, doubles: 7, triples: 0 },
  { name: "Red Magikoopa", image: "assets/images/red magikoopa.png", class: "Balanced", avg: 0.466, gp: 51, hr: 2, pa: 191, hits: 89, slg: 0.546, obp: 0.47, doubles: 7, triples: 0 },
  ...
  { name: "Red Pianta", image: "assets/images/red pianta.png", class: "Speed", avg: 0.565, gp: 52, hr: 18, pa: 200, hits: 113, slg: 0.884, obp: 0.571, doubles: 7, triples: 0 },
  { name: "Red Yoshi", image: "assets/images/red yoshi.png", class: "Speed", avg: 0.432, gp: 35, hr: 2, pa: 125, hits: 54, slg: 0.507, obp: 0.442, doubles: 2, triples: 0 },
  { name: "Rizzler", image: "assets/images/rizzler.jpg", class: "Balanced", avg: 0.479, gp: 31, hr: 2, pa: 121, hits: 58, slg: 0.57, obp: 0.479, doubles: 5, triples: 0 },
  { name: "Saddam Hussein", image: "assets/images/saddam hussein.jpg", class: "Balanced", avg: 0.417, gp: 32, hr: 10, pa: 120, hits: 50, slg: 0.742, obp: 0.417, doubles: 7, triples: 1 },
  { name: "Saka", image: "assets/images/saka.jpg", class: "Balanced", avg: 0.475, gp: 12, hr: 0, pa: 40, hits: 19, slg: 0.525, obp: 0.475, doubles: 2, triples: 0 },
  ...
  { name: "Shy Guy", image: "assets/images/shy guy.png", class: "Technique", avg: 0.491, gp: 30, hr: 0, pa: 110, hits: 54, slg: 0.538, obp: 0.5, doubles: 4, triples: 0 },
  ...
  { name: "Tiny Kong", image: "assets/images/tiny kong.png", class: "Balanced", avg: 0.443, gp: 52, hr: 2, pa: 203, hits: 90, slg: 0.529, obp: 0.448, doubles: 8, triples: 1 },
  { name: "Toad", image: "assets/images/toad.jpg", class: "Balanced", avg: 0.655, gp: 44, hr: 2, pa: 174, hits: 114, slg: 0.764, obp: 0.659, doubles: 5, triples: 3 },
  { name: "Toadette", image: "assets/images/toadette.png", class: "Balanced", avg: 0.489, gp: 50, hr: 1, pa: 186, hits: 91, slg: 0.561, obp: 0.495, doubles: 5, triples: 2 },
  ...
  { name: "Tung Tung Tung Sahur", image: "assets/images/tung tung tung sahur.jpg", class: "Balanced", avg: 0.381, gp: 12, hr: 1, pa: 42, hits: 16, slg: 0.5, obp: 0.381, doubles: 2, triples: 0 },
  { name: "Unc", image: "assets/images/unc.jpg", class: "Balanced", avg: 0.495, gp: 52, hr: 14, pa: 194, hits: 96, slg: 0.739, obp: 0.5, doubles: 4, triples: 0 },
  ...
  { name: "Waluigi", image: "assets/images/waluigi.png", class: "Technique", avg: 0.539, gp: 52, hr: 2, pa: 193, hits: 104, slg: 0.705, obp: 0.547, doubles: 24, triples: 0 },
  { name: "Wario", image: "assets/images/wario.png", class: "Technique", avg: 0.595, gp: 52, hr: 19, pa: 205, hits: 122, slg: 0.969, obp: 0.617, doubles: 7, triples: 0 },
  { name: "Wiggler", image: "assets/images/wiggler.png", class: "Speed", avg: 0.635, gp: 52, hr: 7, pa: 211, hits: 134, slg: 0.817, obp: 0.635, doubles: 12, triples: 2 },
  ...
  { name: "Yellow Magikoopa", image: "assets/images/yellow magikoopa.png", class: "Balanced", avg: 0.54, gp: 34, hr: 3, pa: 139, hits: 75, slg: 0.652, obp: 0.54, doubles: 2, triples: 2 },
  { name: "Yellow Pianta", image: "assets/images/yellow pianta.png", class: "Speed", avg: 0.596, gp: 52, hr: 13, pa: 208, hits: 124, slg: 0.818, obp: 0.599, doubles: 6, triples: 0 },
  { name: "Yellow Shy Guy", image: "assets/images/yellow shy guy.png", class: "Technique", avg: 0.384, gp: 37, hr: 2, pa: 125, hits: 48, slg: 0.465, obp: 0.384, doubles: 3, triples: 0 },
  { name: "Yellow Toad", image: "assets/images/yellow toad.png", class: "Speed", avg: 0.616, gp: 50, hr: 4, pa: 198, hits: 122, slg: 0.761, obp: 0.616, doubles: 9, triples: 3 },
  { name: "Yellow Yoshi", image: "assets/images/yellow yoshi.png", class: "Speed", avg: 0.444, gp: 12, hr: 0, pa: 45, hits: 20, slg: 0.555, obp: 0.444, doubles: 3, triples: 1 },
  ...
  { name: "Yoshi", image: "assets/images/yoshi.png", class: "Speed", avg: 0.455, gp: 52, hr: 3, pa: 202, hits: 92, slg: 0.536, obp: 0.458, doubles: 6, triples: 0 },
...
if (characterGrid) {
  ...
  "Boo": { ip: 108, era: 7.93, baa: 0.518, so: 4 },
  "Boomerang Bro": { ip: 4, era: 1.5, baa: 0.375, so: 0 },
  "Borat": { ip: 9, era: 21.0, baa: 0.643, so: 0 },
  "Bowser": { ip: 131, era: 6.0, baa: 0.467, so: 28 },
  "Bowser Jr": { ip: 101, era: 8.39, baa: 0.511, so: 6 },
  "Brown Kritter": { ip: 5, era: 7.09, baa: 0.465, so: 0 },
  ...
  "Daisy": { ip: 149, era: 7.29, baa: 0.461, so: 2 },
  "Dark Bones": { ip: 43, era: 5.14, baa: 0.384, so: 0 },
  "Diddy Kong": { ip: 79, era: 9.52, baa: 0.517, so: 9 },
  "Diminutive": { ip: 4, era: 6.0, baa: 0.353, so: 0 },
  "Dixie Kong": { ip: 6, era: 7.0, baa: 0.424, so: 1 },
  "Donkey Kong": { ip: 175, era: 8.25, baa: 0.499, so: 4 },
  ...
  "Green Magikoopa": { ip: 27, era: 10.02, baa: 0.55, so: 0 },
  ...
  "King Boo": { ip: 51, era: 11.56, baa: 0.554, so: 0 },
  "King K Rool": { ip: 24, era: 7.88, baa: 0.437, so: 0 },
  ...
  "Luigi": { ip: 172, era: 7.28, baa: 0.489, so: 15 },
  "MLK Jr": { ip: 5, era: 2.47, baa: 0.435, so: 0 },
  "Magikoopa": { ip: 51, era: 8.92, baa: 0.52, so: 1 },
  "Mario": { ip: 142, era: 7.19, baa: 0.492, so: 10 },
  ...
  "Paragoomba": { ip: 54, era: 8.7, baa: 0.482, so: 1 },
  "Peach": { ip: 144, era: 7.6, baa: 0.489, so: 6 },
  "Pianta": { ip: 58, era: 9.62, baa: 0.533, so: 3 },
  ...
  "Red Pianta": { ip: 37, era: 7.59, baa: 0.526, so: 2 },
  "Red Yoshi": { ip: 1, era: 21.0, baa: 0.6, so: 0 },
  "Rizzler": { ip: 5, era: 14.02, baa: 0.597, so: 0 },
  "Saddam Hussein": { ip: 4, era: 14.0, baa: 0.565, so: 0 },
  "Shy Guy": { ip: 1, era: 4.2, baa: 0.5, so: 0 },
  "Tiny Kong": { ip: 28, era: 8.05, baa: 0.502, so: 2 },
  ...
  "Waluigi": { ip: 74, era: 7.53, baa: 0.455, so: 4 },
  "Wario": { ip: 112, era: 8.93, baa: 0.492, so: 6 },
  "Wiggler": { ip: 3, era: 1.75, baa: 0.333, so: 0 },
  "Yellow Magikoopa": { ip: 35, era: 8.43, baa: 0.413, so: 1 },
  "Yellow Pianta": { ip: 25, era: 11.08, baa: 0.536, so: 3 },
