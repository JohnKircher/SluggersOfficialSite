...
const characters = [
  { name: "Baby DK", image: "assets/images/baby dk.png", class: "Speed", avg: 0.481, gp: 62, hr: 7, pa: 239, hits: 115, slg: 0.619, obp: 0.487, doubles: 8, triples: 1 },
  ...
  { name: "Baby Mario", image: "assets/images/baby mario.png", class: "Speed", avg: 0.348, gp: 6, hr: 0, pa: 23, hits: 8, slg: 0.348, obp: 0.348, doubles: 0, triples: 0 },
  { name: "Baby Peach", image: "assets/images/baby peach.png", class: "Balanced", avg: 0.306, gp: 29, hr: 0, pa: 98, hits: 30, slg: 0.388, obp: 0.306, doubles: 6, triples: 1 },
  { name: "Birdo", image: "assets/images/birdo.png", class: "Power", avg: 0.559, gp: 62, hr: 33, pa: 245, hits: 137, slg: 1.008, obp: 0.563, doubles: 9, triples: 0 },
  ...
  { name: "Blooper", image: "assets/images/blooper.png", class: "Balanced", avg: 0.574, gp: 50, hr: 2, pa: 197, hits: 113, slg: 0.677, obp: 0.579, doubles: 9, triples: 1 },
  { name: "Blue Dry Bones", image: "assets/images/blue dry bones.png", class: "Balanced", avg: 0.61, gp: 62, hr: 13, pa: 246, hits: 150, slg: 0.849, obp: 0.611, doubles: 12, triples: 2 },
  { name: "Blue Kritter", image: "assets/images/blue kritter.png", class: "Power", avg: 0.551, gp: 62, hr: 24, pa: 243, hits: 134, slg: 0.912, obp: 0.542, doubles: 11, triples: 3 },
  ...
  { name: "Blue Toad", image: "assets/images/blue toad.png", class: "Speed", avg: 0.61, gp: 56, hr: 5, pa: 223, hits: 136, slg: 0.731, obp: 0.61, doubles: 10, triples: 1 },
  { name: "Blue Yoshi", image: "assets/images/blue yoshi.png", class: "Speed", avg: 0.66, gp: 13, hr: 0, pa: 53, hits: 35, slg: 0.784, obp: 0.673, doubles: 1, triples: 2 },
  { name: "Boo", image: "assets/images/boo.png", class: "Speed", avg: 0.474, gp: 51, hr: 1, pa: 171, hits: 81, slg: 0.526, obp: 0.473, doubles: 6, triples: 0 },
  { name: "Boomerang Bro", image: "assets/images/boomerang bro.png", class: "Power", avg: 0.489, gp: 62, hr: 31, pa: 235, hits: 115, slg: 0.918, obp: 0.494, doubles: 4, triples: 1 },
  ...
  { name: "Bowser Jr", image: "assets/images/bowser jr.png", class: "Technique", avg: 0.476, gp: 62, hr: 6, pa: 233, hits: 111, slg: 0.628, obp: 0.476, doubles: 15, triples: 0 },
  { name: "Bowser", image: "assets/images/bowser.png", class: "Power", avg: 0.615, gp: 62, hr: 75, pa: 260, hits: 160, slg: 1.603, obp: 0.615, doubles: 20, triples: 5 },
  { name: "Brown Kritter", image: "assets/images/brown kritter.png", class: "Power", avg: 0.46, gp: 61, hr: 41, pa: 235, hits: 108, slg: 1.065, obp: 0.468, doubles: 10, triples: 1 },
  ...
  { name: "Charlie Kirk", image: "assets/images/charlie kirk.jpg", class: "Balanced", avg: 0.167, gp: 2, hr: 0, pa: 6, hits: 1, slg: 0.167, obp: 0.167, doubles: 0, triples: 0 },
  ...
  { name: "Daisy", image: "assets/images/daisy.png", class: "Power", avg: 0.437, gp: 60, hr: 8, pa: 231, hits: 101, slg: 0.646, obp: 0.437, doubles: 18, triples: 2 },
  { name: "Dark Bones", image: "assets/images/dark bones.png", class: "Balanced", avg: 0.645, gp: 62, hr: 20, pa: 262, hits: 169, slg: 0.969, obp: 0.648, doubles: 21, triples: 1 },
  ...
  { name: "Doc Brown", image: "assets/images/doc brown.jpg", class: "Balanced", avg: 0.453, gp: 20, hr: 2, pa: 75, hits: 34, slg: 0.65, obp: 0.453, doubles: 8, triples: 0 },
  { name: "Donkey Kong", image: "assets/images/donkey kong.png", class: "Power", avg: 0.576, gp: 62, hr: 65, pa: 245, hits: 141, slg: 1.402, obp: 0.575, doubles: 6, triples: 0 },
  ...
  { name: "Dry Bones", image: "assets/images/dry bones.png", class: "Balanced", avg: 0.601, gp: 62, hr: 15, pa: 243, hits: 146, slg: 0.884, obp: 0.603, doubles: 15, triples: 3 },
  { name: "Dwayne Wade", image: "assets/images/dwayne wade.jpg", class: "Balanced", avg: 0.486, gp: 61, hr: 3, pa: 216, hits: 105, slg: 0.551, obp: 0.486, doubles: 3, triples: 1 },
  ...
  { name: "Fire Bro", image: "assets/images/fire bro.png", class: "Power", avg: 0.594, gp: 62, hr: 62, pa: 249, hits: 148, slg: 1.388, obp: 0.594, doubles: 7, triples: 1 },
  { name: "Frozone", image: "assets/images/frozone.jpg", class: "Balanced", avg: 0.366, gp: 18, hr: 4, pa: 71, hits: 26, slg: 0.545, obp: 0.366, doubles: 0, triples: 0 },
  { name: "Funky Kong", image: "assets/images/funky kong.png", class: "Power", avg: 0.445, gp: 62, hr: 36, pa: 238, hits: 106, slg: 0.969, obp: 0.453, doubles: 4, triples: 3 },
  ...
  { name: "Genghis Khan", image: "assets/images/genghis khan.jpg", class: "Balanced", avg: 0.714, gp: 2, hr: 0, pa: 7, hits: 5, slg: 0.857, obp: 0.714, doubles: 1, triples: 0 },
  ...
  { name: "Goomba", image: "assets/images/goomba.png", class: "Speed", avg: 0.25, gp: 3, hr: 2, pa: 12, hits: 3, slg: 0.75, obp: 0.25, doubles: 0, triples: 0 },
  { name: "Green Dry Bones", image: "assets/images/green dry bones.png", class: "Balanced", avg: 0.565, gp: 62, hr: 15, pa: 253, hits: 143, slg: 0.802, obp: 0.565, doubles: 12, triples: 1 },
  { name: "Green Magikoopa", image: "assets/images/green magikoopa.png", class: "Balanced", avg: 0.471, gp: 62, hr: 4, pa: 223, hits: 105, slg: 0.558, obp: 0.473, doubles: 7, triples: 0 },
  ...
  { name: "Green Shy Guy", image: "assets/images/green shy guy.png", class: "Technique", avg: 0.436, gp: 50, hr: 2, pa: 172, hits: 75, slg: 0.524, obp: 0.429, doubles: 8, triples: 1 },
  { name: "Green Toad", image: "assets/images/green toad.png", class: "Speed", avg: 0.569, gp: 62, hr: 2, pa: 248, hits: 141, slg: 0.684, obp: 0.574, doubles: 11, triples: 4 },
  ...
  { name: "Hammer Bro", image: "assets/images/hammer bro.png", class: "Power", avg: 0.556, gp: 62, hr: 57, pa: 232, hits: 129, slg: 1.322, obp: 0.55, doubles: 8, triples: 0 },
  ...
  { name: "KevinG", image: "assets/images/keving.jpg", class: "Balanced", avg: 0.365, gp: 42, hr: 4, pa: 159, hits: 58, slg: 0.481, obp: 0.365, doubles: 6, triples: 0 },
  ...
  { name: "King Boo", image: "assets/images/king boo.png", class: "Power", avg: 0.564, gp: 62, hr: 39, pa: 250, hits: 141, slg: 1.057, obp: 0.557, doubles: 5, triples: 0 },
  { name: "King K Rool", image: "assets/images/king k rool.png", class: "Power", avg: 0.592, gp: 62, hr: 76, pa: 255, hits: 151, slg: 1.546, obp: 0.592, doubles: 11, triples: 0 },
  ...
  { name: "Kritter", image: "assets/images/kritter.png", class: "Power", avg: 0.56, gp: 62, hr: 43, pa: 252, hits: 141, slg: 1.182, obp: 0.56, doubles: 17, triples: 3 },
  ...
  { name: "Light Blue Yoshi", image: "assets/images/light blue yoshi.png", class: "Speed", avg: 0.778, gp: 5, hr: 0, pa: 18, hits: 14, slg: 0.944, obp: 0.778, doubles: 3, triples: 0 },
  ...
  { name: "Luigi", image: "assets/images/luigi.png", class: "Speed", avg: 0.529, gp: 62, hr: 4, pa: 240, hits: 127, slg: 0.616, obp: 0.531, doubles: 5, triples: 1 },
  ...
  { name: "Magikoopa", image: "assets/images/magikoopa.png", class: "Balanced", avg: 0.502, gp: 61, hr: 4, pa: 213, hits: 107, slg: 0.592, obp: 0.502, doubles: 5, triples: 1 },
  { name: "Mario", image: "assets/images/mario.png", class: "Balanced", avg: 0.527, gp: 62, hr: 5, pa: 237, hits: 125, slg: 0.623, obp: 0.528, doubles: 5, triples: 1 },
  { name: "Matt", image: "assets/images/matt.jpg", class: "Balanced", avg: 0.42, gp: 19, hr: 0, pa: 69, hits: 29, slg: 0.435, obp: 0.42, doubles: 1, triples: 0 },
  ...
  { name: "Miss Hot", image: "assets/images/miss hot.jpg", class: "Balanced", avg: 0.434, gp: 62, hr: 5, pa: 226, hits: 98, slg: 0.561, obp: 0.435, doubles: 10, triples: 1 },
  ...
  { name: "Mr. Incredible", image: "assets/images/mr incredible.jpg", class: "Balanced", avg: 0.431, gp: 32, hr: 0, pa: 116, hits: 50, slg: 0.466, obp: 0.439, doubles: 3, triples: 0 },
  ...
  { name: "Noki", image: "assets/images/noki.png", class: "Balanced", avg: 0.571, gp: 2, hr: 0, pa: 7, hits: 4, slg: 0.571, obp: 0.571, doubles: 0, triples: 0 },
  { name: "Paragoomba", image: "assets/images/paragoomba.png", class: "Balanced", avg: 0.355, gp: 36, hr: 1, pa: 124, hits: 44, slg: 0.389, obp: 0.357, doubles: 1, triples: 0 },
  { name: "Peach", image: "assets/images/peach.png", class: "Balanced", avg: 0.408, gp: 62, hr: 1, pa: 238, hits: 97, slg: 0.467, obp: 0.399, doubles: 9, triples: 2 },
  { name: "Petey Piranha", image: "assets/images/petey piranha.png", class: "Power", avg: 0.607, gp: 62, hr: 86, pa: 252, hits: 153, slg: 1.666, obp: 0.611, doubles: 5, triples: 0 },
  { name: "Pianta", image: "assets/images/pianta.png", class: "Speed", avg: 0.605, gp: 62, hr: 47, pa: 238, hits: 144, slg: 1.21, obp: 0.596, doubles: 4, triples: 1 },
  ...
  { name: "Purple Toad", image: "assets/images/purple toad.png", class: "Speed", avg: 0.636, gp: 44, hr: 0, pa: 162, hits: 103, slg: 0.695, obp: 0.636, doubles: 7, triples: 1 },
  ...
  { name: "Red Koopa Paratroopa", image: "assets/images/red koopa paratroopa.jpg", class: "Balanced", avg: 0.375, gp: 12, hr: 0, pa: 40, hits: 15, slg: 0.425, obp: 0.375, doubles: 2, triples: 0 },
  { name: "Red Koopa Troopa", image: "assets/images/red koopa troopa.png", class: "Speed", avg: 0.412, gp: 18, hr: 1, pa: 68, hits: 28, slg: 0.514, obp: 0.412, doubles: 4, triples: 0 },
  { name: "Red Kritter", image: "assets/images/red kritter.png", class: "Power", avg: 0.485, gp: 62, hr: 34, pa: 241, hits: 117, slg: 0.974, obp: 0.485, doubles: 9, triples: 1 },
  { name: "Red Magikoopa", image: "assets/images/red magikoopa.png", class: "Balanced", avg: 0.442, gp: 61, hr: 2, pa: 233, hits: 103, slg: 0.509, obp: 0.446, doubles: 7, triples: 0 },
  ...
  { name: "Red Pianta", image: "assets/images/red pianta.png", class: "Speed", avg: 0.545, gp: 62, hr: 22, pa: 235, hits: 128, slg: 0.867, obp: 0.55, doubles: 7, triples: 0 },
  { name: "Red Yoshi", image: "assets/images/red yoshi.png", class: "Speed", avg: 0.457, gp: 45, hr: 2, pa: 162, hits: 74, slg: 0.518, obp: 0.464, doubles: 2, triples: 0 },
  { name: "Rizzler", image: "assets/images/rizzler.jpg", class: "Balanced", avg: 0.453, gp: 41, hr: 4, pa: 159, hits: 72, slg: 0.56, obp: 0.453, doubles: 5, triples: 0 },
  ...
  { name: "Shy Guy", image: "assets/images/shy guy.png", class: "Technique", avg: 0.47, gp: 40, hr: 0, pa: 149, hits: 70, slg: 0.518, obp: 0.477, doubles: 6, triples: 0 },
  ...
  { name: "Toad", image: "assets/images/toad.jpg", class: "Balanced", avg: 0.659, gp: 54, hr: 2, pa: 211, hits: 139, slg: 0.767, obp: 0.662, doubles: 7, triples: 4 },
  { name: "Toadette", image: "assets/images/toadette.png", class: "Balanced", avg: 0.498, gp: 60, hr: 1, pa: 223, hits: 111, slg: 0.562, obp: 0.503, doubles: 6, triples: 2 },
  { name: "Toadsworth", image: "assets/images/toadsworth.png", class: "Balanced", avg: 0.264, gp: 15, hr: 0, pa: 53, hits: 14, slg: 0.291, obp: 0.271, doubles: 1, triples: 0 },
  { name: "Tobey Maguire", image: "assets/images/tobey maguire.jpg", class: "Balanced", avg: 0.375, gp: 2, hr: 0, pa: 8, hits: 3, slg: 0.375, obp: 0.375, doubles: 0, triples: 0 },
  ...
  { name: "Tung Tung Tung Sahur", image: "assets/images/tung tung tung sahur.jpg", class: "Balanced", avg: 0.42, gp: 22, hr: 3, pa: 81, hits: 34, slg: 0.592, obp: 0.42, doubles: 5, triples: 0 },
  { name: "Unc", image: "assets/images/unc.jpg", class: "Balanced", avg: 0.498, gp: 62, hr: 19, pa: 233, hits: 116, slg: 0.766, obp: 0.503, doubles: 4, triples: 0 },
  ...
  { name: "Waluigi", image: "assets/images/waluigi.png", class: "Technique", avg: 0.554, gp: 62, hr: 2, pa: 231, hits: 128, slg: 0.706, obp: 0.561, doubles: 27, triples: 0 },
  { name: "Wario", image: "assets/images/wario.png", class: "Technique", avg: 0.573, gp: 62, hr: 21, pa: 241, hits: 138, slg: 0.916, obp: 0.591, doubles: 7, triples: 0 },
  { name: "Wiggler", image: "assets/images/wiggler.png", class: "Speed", avg: 0.629, gp: 62, hr: 10, pa: 251, hits: 158, slg: 0.823, obp: 0.629, doubles: 13, triples: 2 },
  ...
  { name: "Yellow Magikoopa", image: "assets/images/yellow magikoopa.png", class: "Balanced", avg: 0.509, gp: 44, hr: 3, pa: 175, hits: 89, slg: 0.604, obp: 0.509, doubles: 3, triples: 2 },
  { name: "Yellow Pianta", image: "assets/images/yellow pianta.png", class: "Speed", avg: 0.588, gp: 62, hr: 18, pa: 250, hits: 147, slg: 0.839, obp: 0.591, doubles: 6, triples: 0 },
  { name: "Yellow Shy Guy", image: "assets/images/yellow shy guy.png", class: "Technique", avg: 0.39, gp: 47, hr: 3, pa: 159, hits: 62, slg: 0.479, obp: 0.39, doubles: 4, triples: 0 },
  { name: "Yellow Toad", image: "assets/images/yellow toad.png", class: "Speed", avg: 0.621, gp: 60, hr: 5, pa: 240, hits: 149, slg: 0.761, obp: 0.621, doubles: 11, triples: 3 },
  { name: "Yellow Yoshi", image: "assets/images/yellow yoshi.png", class: "Speed", avg: 0.55, gp: 21, hr: 0, pa: 80, hits: 44, slg: 0.65, obp: 0.55, doubles: 6, triples: 1 },
  ...
  { name: "Yoshi", image: "assets/images/yoshi.png", class: "Speed", avg: 0.447, gp: 62, hr: 3, pa: 244, hits: 109, slg: 0.526, obp: 0.449, doubles: 7, triples: 1 },
...
if (characterGrid) {
  ...
  "Blooper": { ip: 42, era: 9.46, baa: 0.526, so: 2 },
  "Blue Dry Bones": { ip: 51, era: 6.74, baa: 0.485, so: 1 },
  ...
  "Boo": { ip: 137, era: 8.2, baa: 0.52, so: 5 },
  "Boomerang Bro": { ip: 4, era: 1.5, baa: 0.375, so: 0 },
  "Borat": { ip: 9, era: 21.0, baa: 0.643, so: 0 },
  "Bowser": { ip: 150, era: 6.34, baa: 0.47, so: 34 },
  "Bowser Jr": { ip: 130, era: 8.21, baa: 0.51, so: 10 },
  "Brown Kritter": { ip: 13, era: 12.79, baa: 0.533, so: 0 },
  ...
  "Daisy": { ip: 171, era: 6.56, baa: 0.441, so: 2 },
  ...
  "King Boo": { ip: 69, era: 11.94, baa: 0.556, so: 0 },
  "King K Rool": { ip: 37, era: 6.94, baa: 0.445, so: 0 },
  ...
  "Luigi": { ip: 211, era: 7.73, baa: 0.494, so: 17 },
  "MLK Jr": { ip: 5, era: 2.47, baa: 0.435, so: 0 },
  "Magikoopa": { ip: 51, era: 8.92, baa: 0.52, so: 1 },
  "Mario": { ip: 188, era: 7.82, baa: 0.487, so: 12 },
  ...
  "Paragoomba": { ip: 70, era: 9.63, baa: 0.502, so: 1 },
  "Peach": { ip: 175, era: 7.62, baa: 0.496, so: 6 },
  ...
  "Red Pianta": { ip: 46, era: 7.2, baa: 0.52, so: 2 },
  ...
  "Unc": { ip: 10, era: 3.15, baa: 0.441, so: 0 },
  "Waluigi": { ip: 106, era: 7.09, baa: 0.442, so: 5 },
  "Wario": { ip: 132, era: 9.0, baa: 0.495, so: 6 },
  "Wiggler": { ip: 4, era: 1.31, baa: 0.35, so: 0 },
  "Yellow Magikoopa": { ip: 37, era: 8.16, baa: 0.415, so: 1 },
  "Yellow Pianta": { ip: 33, era: 11.89, baa: 0.54, so: 3 },
  ...
  "Yoshi": { ip: 109, era: 6.97, baa: 0.47, so: 3 },
};
